...
export default function DocsVersionDropdownNavbarItemWrapper(props: Props) {
  ...
  // https://github.com/facebook/react-native-website/blob/2a880c5bb7ce29455b66a2f9510ad4e314430f42/website/src/theme/NavbarItem/DocsVersionDropdownNavbarItem.js
