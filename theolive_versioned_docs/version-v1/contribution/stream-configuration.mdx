...
The goal is to pass a `streamConfig` object during the [creation](../api/channels/create-channel.api.mdx) of a channel, or when [updating](../api/channels/update-channel.api.mdx) it. This object consists of:
