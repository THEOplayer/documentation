...
You'll need to create two THEOlive channels via the [API](../api/channels/create-channel.api.mdx) or [management console](https://console.theo.live/). Let's say for example that we have the following channels with fictive IDs:
...
For more information, please visit our [API Reference](../api/channels/update-channel.api.mdx).
