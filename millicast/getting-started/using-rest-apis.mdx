...
Let us go over the code above with a little more detail to understand what is happening. Again, we’re assuming you have a basic understanding of Node.js so this will focus more on the API calls than on the server.
...
import BasicApiIndex1 from '../assets/img/basic-api-index1-snap.png';

<div class="center-container">
  <img src={BasicApiIndex1} width="600" />
</div>
