...
After completing Part 1, you can now progress onto Part 2, building a custom web application using the [Streaming Web SDK](/millicast/client-sdks/web/sdk/index.mdx) to playback and view a stream or start a new broadcast.
