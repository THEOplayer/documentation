...
The Dashboard has a 4 hour limit before you are automatically logged out. If you plan on publishing longer than 4 hours it is recommended to use a Software Encoder, Hardware Encoder or Dolby.io SDKs.
:::
