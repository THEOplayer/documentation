...
:::caution[Dashboard Limitations]
The Dashboard has a 4 hour limit before you are automatically logged out. If you plan on publishing longer then 4 hours it is recommended to use a Software Encoder, Hardware Encoder or Dolby.io SDKs.
:::
...
Visit the [How to Broadcast in Dashboard](/millicast/streaming-dashboard/how-to-broadcast-in-dashboard.mdx) guide to learn more details about the options available for configuring the publish token and working with this dashboard broadcast application.
:::
