...
:::tip Geo-Cascading
If you want to learn how to customize how traffic flows across regions, review the [Geo-cascading](/millicast/distribution/multi-region-support/geo-cascading.mdx) streaming guide.
:::
...
<div class="center-container">
  <img src={ClusterRegion} width="500" />
</div>
...
<div class="center-container">
  <img src={MediaStatsDialog} width="500" />
</div>
...
import MediaStatsModal from '../../assets/img/viewer-media-stats-modal-cluster.png';

<div class="center-container">
  <img src={MediaStatsModal} width="500" />
</div>
...
:::caution Enable Multisource on your Stream Token
