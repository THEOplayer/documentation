...
Log into your account [Streaming Dashboard](/millicast/about-dash.md), click on _Settings_ in the left-side menu. 
...
Open the Streaming section of the [Dolby.io Dashboard](/millicast/about-dash.md) and select an existing token or `+ Create` a new one.
...
> 
> You can also deny access to content if you know the [domain name](/millicast/token-security.md) or [ip address](/millicast/token-security.md) that will be used to broadcast or view a stream.
