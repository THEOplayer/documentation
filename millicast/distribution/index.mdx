...
[Simulcast](/millicast/distribution/using-webrtc-simulcast)<br/>
...
[Stream syndication](/millicast/distribution/syndication)<br/>
...
<DocCardList
  items={[
    ...
    {
      type: 'link',
      href: 'https://optiview.dolby.com/resources/blog/tag/distribution/',
