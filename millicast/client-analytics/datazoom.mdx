...
This page guides you on some of the metrics that are collected and steps to integrate the [Millicast SDK](/millicast/client-sdks/web/sdk/index.mdx) as a collector and connect to observability tools such as Splunk, Datadog, New Relic, Amazon Kinesis Firehose, etc.
...
This section outlines the steps required to initialize client-side data collection with the Millicast [Web SDK](/millicast/client-sdks/web/sdk/index.mdx). There are also [collectors](https://help.datazoom.io/hc/en-us/sections/360000455512-Collectors) available that will work similarly with Android and iOS.
