...
**OBS** is a free open-source application for broadcasting and recording streams from your desktop computer. It supports broadcasting with [WebRTC](/millicast/broadcast/webrtc-whip.mdx), [SRT](/millicast/broadcast/using-srt.md), and [RTMP](/millicast/broadcast/using-rtmp-and-rtmps.md) to support many different use cases.
