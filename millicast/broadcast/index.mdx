...
<IconGrid>
  ...
  <IconGridButton to="/millicast/client-sdks/web.md">![](/img/web.svg) Web SDK</IconGridButton>
  <IconGridButton to="/millicast/client-sdks/ios">![](/img/apple.svg) iOS SDK</IconGridButton>
  <IconGridButton to="/millicast/client-sdks/android">![](/img/android.svg) Android SDK</IconGridButton>
  <IconGridButton to="/millicast/client-sdks/rn.md">![](/img/react.svg) React Native</IconGridButton>
  <IconGridButton to="/millicast/client-sdks/desktop">![](/img/apple.svg) Mac SDK</IconGridButton>
  <IconGridButton to="/millicast/client-sdks/desktop">![](/img/electron.svg) Linux SDK</IconGridButton>
  <IconGridButton to="/millicast/client-sdks/flutter.md">![](/img/flutter.svg) Flutter SDK</IconGridButton>
  <IconGridButton to="/millicast/client-sdks/desktop">![](/img/dotnet.svg) .NET SDK</IconGridButton>
</IconGrid>
...
Web and mobile browsers are widely available and have wide encoding support, whether broadcasting from Chrome, Safari, Firefox, or Edge. To start broadcasting, see the [Getting Started with Broadcasting](/millicast/getting-started.mdx) guide.
