...
<IconGrid>
  <IconGridButton to="/docs/millicast/getting-started/">![](/img/play-circle.svg) Dashboard</IconGridButton>
  <IconGridButton to="/docs/millicast/web">![](/img/web.svg) Web SDK</IconGridButton>
  <IconGridButton to="/docs/millicast/ios/">![](/img/apple.svg) iOS SDK</IconGridButton>
  <IconGridButton to="/docs/millicast/android/">![](/img/android.svg) Android SDK</IconGridButton>
  <IconGridButton to="/docs/millicast/rn/">![](/img/react.svg) React Native</IconGridButton>
  <IconGridButton to="/docs/millicast/desktop">![](/img/apple.svg) Mac SDK</IconGridButton>
  <IconGridButton to="/docs/millicast/desktop">![](/img/electron.svg) Linux SDK</IconGridButton>
  <IconGridButton to="/docs/millicast/flutter/">![](/img/flutter.svg) Flutter SDK</IconGridButton>
  <IconGridButton to="/docs/millicast/desktop">![](/img/dotnet.svg) .NET SDK</IconGridButton>
</IconGrid>
