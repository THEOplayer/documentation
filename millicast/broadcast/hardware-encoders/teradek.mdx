...
import Vidiu1 from '../../assets/img/hardware-encoders/teradek-vidiu1.png';
...
import Vidiu2 from '../../assets/img/hardware-encoders/teradek-vidiu2.png';
...
import Vidiu3 from '../../assets/img/hardware-encoders/teradek-vidiu3.png';
...
import TeradekWave from '../../assets/img/hardware-encoders/teradek_wave.jpg';

<div class="center-container">
  <img src={TeradekWave} width="600" />
</div>

You can also adjust the additional settings on the Teradek Wave, such as:
...
Teradek products that use [RTMP, RTMPS](/millicast/broadcast/rtmp-and-rtmps.mdx), [SRT](/millicast/broadcast/srt.mdx), and [NDI](/millicast/broadcast/ndi.md) can all be used with OptiView Real-time Streaming for low-latency streams with global delivery.
