...
import AudioProfiles from '../../assets/img/hardware-encoders/videon_audio_profiles.png';

<div class="center-container">
  <img src={AudioProfiles} width="600" />
</div>
...
import VideonRtmp from '../../assets/img/hardware-encoders/videon-rtmp.png';

<div class="center-container">
  <img src={VideonRtmp} width="600" />
</div>
...
import VideonSrt from '../../assets/img/hardware-encoders/videon-srt.png';

<div class="center-container">
  <img src={VideonSrt} width="600" />
</div>

### How-to apply a multi-viewer with Videon EdgeCaster

You can also use the [Multi-Source builder](/millicast/streaming-dashboard/multi-source-builder.mdx) to generate the URLs. For information on Simulcast, refer to [the documentation](/millicast/distribution/using-webrtc-simulcast) to understand its usage.
