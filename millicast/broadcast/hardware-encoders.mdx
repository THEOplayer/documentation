...
<IconGrid>
  <IconGridButton large>
    [![Elgato](https://images.ctfassets.net/h50kqpe25yx1/3iIxXlFKpglC4wZISzo2XK/ed9542d4bcb717751c143c56518867cf/Elgato_Logo_Black.png)](/millicast/hardware-encoders/using-elgato-stream-deck-with-obs-studio-webrtc-version.md)
  </IconGridButton>
  <IconGridButton large>
    [![Haivision](../assets/img/haivision_logo_blue.svg)](/millicast/hardware-encoders/using-haivision-kb-encoder.md)
  </IconGridButton>
  <IconGridButton large>
    [![Osprey](https://static.wixstatic.com/media/2c643c_93683bf3749b47f5957df20f77047228~mv2.png)](/millicast/hardware-encoders/using-osprey-talon-whip-hardware-encoder.md)
  </IconGridButton>
  <IconGridButton large>
    [![Teradek](https://teradek.com/cdn/shop/files/teradek-logo-social.png?v=2615974949159750763)](/millicast/hardware-encoders/broadcasting-teradek-vidiu.md)
  </IconGridButton>
  <IconGridButton large>
    [![Videon](https://www.nomad-cms.com/wp-content/uploads/2020/10/videon-logo-dark-orange-3x2-1.png)](/millicast/hardware-encoders/videon.md)
  </IconGridButton>
</IconGrid>
