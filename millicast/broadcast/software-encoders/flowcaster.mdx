...
slug: /software-encoders/flowcaster
---
...
<div class="center-container">
  <img src={FlowcasterWhipToken} width="600" />
</div>

Open FlowCaster and click on the Config tab. Update the following settings as shown.

import FlowcasterWhip from '../../assets/img/FlowCaster_Whip.png';

<div class="center-container">
  <img src={FlowcasterWhip} width="600" />
</div>
...
import FlowcasterWhip2 from '../../assets/img/FlowCaster_Whip_2.png';

<div class="center-container">
  <img src={FlowcasterWhip2} width="600" />
</div>
...
import FlowcasterWhip3 from '../../assets/img/FlowCaster_Whip_3.png';

<div class="center-container">
  <img src={FlowcasterWhip3} width="600" />
</div>
...
<div className="youtube-container">
  <iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/LHwiQPJo0QI"
