...
Here is an example calling the [Encoder Profiles](/millicast/api/encoders/profiles) API to discover the available profiles to your account, you can see the profile `name` and the configuration including the resolution and bitrate.
