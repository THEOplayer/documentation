...
To use this feature, _you will need OBS version `31.1` at a minimum_. Then, after choosing "Dolby Millicast" from the `Stream > Service`, enable _Enhanced Broadcasting_ e.

import ObsMultiTrackVideo from '../../../assets/img/obs-millicast-ertmp.jpg';
...
import ObsMultiTrackVideoManualLayers from '../../../assets/img/obs-millicast-ertmp-manual-layers.jpg';
