...
<IconGrid>
    ...
    <!--
    <IconGridButton large>[![Zoom](https://logos-world.net/wp-content/uploads/2021/03/Zoom-Logo.png)](/millicast/software-encoders/broadcasting-jitsi-or-zoom-meetings.md)</IconGridButton>
    -->
