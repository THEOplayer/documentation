...
<IconGrid>
    ...
    <IconGridButton large>[![NDI](https://seeklogo.com/images/N/network-device-interface-logo-88C1BBB203-seeklogo.com.png)](using-ndi.md)</IconGridButton>
...
Afterward, start up the stream, and you should see live streaming the Hosted Player Path URL. For more information on how to stream from OBS to the Dolby.io CDNs, follow the dedicated [OBS guide](/millicast/software-encoders/obs/index.mdx).
