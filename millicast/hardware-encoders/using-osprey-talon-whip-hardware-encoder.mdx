...
You can originate a broadcast from Osprey over a [WHIP](/millicast/broadcast/webrtc-whip.mdx), [SRT](/millicast/broadcast/using-srt.mdx) or [RTMP](/millicast/broadcast/using-rtmp-and-rtmps.mdx) source.

- [Configure WHIP](#how-to-use-osprey-talon-with-whip)
- [Configure SRT](/#how-to-use-osprey-talon-with-srt)
- [Configure RTMP](#how-to-use-osprey-talon-with-rtmp)
...
import OspreyRtmp from '../assets/img/osprey-rtmp-millicast.png';
