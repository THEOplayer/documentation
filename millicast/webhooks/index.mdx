...
- [Thumbnail Hooks](/millicast/webhooks/thumbnail-webhooks.mdx) send a notification when static thumbnail images are captured during a live video stream.
...
The [Thumbnail](/millicast/webhooks/thumbnail-webhooks.mdx) hook does not use this schema and instead only sends the captured image.
