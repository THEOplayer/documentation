...
- [Feed Hooks](/millicast/webhooks/feeds.md) send a notification for an activity feed of when a stream has started or stopped publishing.
- [Media Hooks](/millicast/webhooks/media.md) send a notification for the start, completion, and deletion of server-side recordings.
- [Thumbnail Hooks](/millicast/webhooks/thumbnail.mdx) send a notification when static thumbnail images are captured during a live video stream.
- [Transcoder Hooks](/millicast/webhooks/transcoder.md) send a notification when a transcoder changes status such as starts or stops.
- [ViewerConnection Hooks](/millicast/webhooks/viewerconnection.md) send a notification when a viewer attempts to connect to an inactive stream or when a stream doesn't have any active viewers remaining. This hook is helpful for automating an encoder to start only when a viewer connects.
...
import DashAddNewWebhook from '../assets/img/dashboard-add-new-webhook.png';

<div class="center-container">
  <img src={DashAddNewWebhook} width="400" />
</div>
...
import WebhookManagementMain from '../assets/img/webhooks-management-main.png';

<div class="center-container">
  <img src={WebhookManagementMain} width="600" />
</div>

Change the URL that will be called by the webhook by pressing the pen icon at the end of the row:

import WebhookUrlEdit from '../assets/img/webhooks-url-edit.png';

<div class="center-container">
  <img src={WebhookUrlEdit} width="600" />
</div>

Update the URL and **confirm** your decision by clicking the green checkmark. To **cancel**, select the gray button.

import WebhookEditConfirm from '../assets/img/webhooks-url-edit.confirm.png';

<div class="center-container">
  <img src={WebhookEditConfirm} width="600" />
</div>
...
import WebhookSecretEdit from '../assets/img/webhooks-secret-edit.png';

<div class="center-container">
  <img src={WebhookSecretEdit} width="600" />
</div>
...
See the [Feed Hooks](/millicast/webhooks/feeds.md) and [Media Hooks](/millicast/webhooks/media.md) guides for additional details on what **data** to expect and how to interpret the **event**.

The [Thumbnail](/millicast/webhooks/thumbnail.mdx) hook does not use this schema and instead only sends the captured image.
