...
[Getting Started with Web Capture](/millicast/introduction-to-streaming-apis.mdx)<br/>
...
[How-to Stream from DJI Drones](/millicast/capture/live-streaming-from-drones-rtmp.mdx)<br/>
...
[How-to Stream from a GoPro](/millicast/capture/action-cameras.mdx)<br/>
...
[How-to use NDI® Tools](/millicast/broadcast/using-ndi.md)<br/>
...
[How-to Stream Your Screenshare](/millicast/capture/screensharing.mdx)<br/>
Screen capture allows sharing the contents of a window, application, or entire computer display.

[How-to use OBS with WebRTC](/millicast/software-encoders/obs/index.mdx)<br/>
