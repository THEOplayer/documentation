...
- [Thumbnail previews:](/millicast/webhooks/thumbnail-webhooks.mdx) Enables previewing a thumbnail image of your video stream. Thumbnails are delivered via a webhook.
