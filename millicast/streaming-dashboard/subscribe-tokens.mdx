...
2. Create a JWT with the following data inside a `streaming` object:
   ...
   - `originCluster` (optional): Specify cluster to route subscriber to, provided it is a subset of the `originCluster` set on the (primary) subscribe token.
...
Here is the JWT that is used to generate this token, you can paste it into [jwt.io](https://jwt.io/#token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..btau2liawfvZeYdgV2RwV5F3CrV_Vl0a2ePSV1anDII).

```text
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..btau2liawfvZeYdgV2RwV5F3CrV_Vl0a2ePSV1anDII
```
