...
Dolby.io Streaming APIs support using the [Web SDK](/millicast/client-sdks/web/sdk/index.mdx) with React Native WebRTC to support creating iOS, Android, AndroidTV, and tvOS applications.
...
<ThreeCardList
  items={[
    {
      type: 'link',
      href: 'https://github.com/millicast/millicast-sdk/releases',
      customProps: {
        icon: 'github',
      },
      label: 'GitHub',
      description: 'Access the Web SDK releases',
    },
    {
      type: 'link',
    ...
    {
      type: 'link',
      href: 'https://github.com/millicast/streaming-sdk-react-native-getting-started',
      customProps: {
        icon: '📱',
      },
      label: 'Sample app',
...
:::tip Getting started with React Native
Before we start, you can find more information in the [Web SDK Documentation](/millicast/client-sdks/web/sdk/index.mdx), which contains more examples and descriptions of the available modules.
:::
