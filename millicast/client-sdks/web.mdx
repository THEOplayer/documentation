...
See the [Stream Recordings](/millicast/distribution/stream-recordings/index.mdx) guide for more details about this platform capability. You must use a [Publish Token](/millicast/streaming-dashboard/managing-your-tokens.md) that has recording enabled for the client to be able to activate recordings.
