...
If you run into problems, the full Dolby.io Real-time Streaming SDK for Android documentation can be found [here](/millicast/client-sdks/android/sdk/index.mdx).
