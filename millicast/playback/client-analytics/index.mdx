...
slug: /playback/client-analytics
sidebar_position: 8
---
...
To help facilitate investigating out why a client is experiencing a degraded experience, there is a utility function available from the [Client SDKs](/millicast/playback/players-sdks/index.mdx) called `diagnose()`. This method gathers up pertinent details such as:
...
### How-to Diagnose with THEOplayer

We have a more complete guide on this topic, refer to our [THEOplayer specific guide](/millicast/web-player-diagnostics/).
...
It is common practice to proactively monitor all clients for indicators of streaming issues. The [Client SDKs](/millicast/playback/players-sdks/index.mdx) provide access to a `stats` event that emits a snapshot of WebRTC indicators at a frequent interval. This data can be used in combination with an **Application Performance Monitoring (APM)** solution or Observability tool to alert and integrate with other third-party analytics services for a complete picture of the end-viewer experience.
...
- [Datazoom](/millicast/playback/client-analytics/datazoom.mdx)
- [Datadog](/millicast/playback/client-analytics/datadog.mdx)
