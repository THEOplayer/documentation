---
title: Datazoom
slug: /playback/client-analytics/datazoom
---
...
This page guides you on some of the metrics that are collected and steps to integrate the [Millicast SDK](/millicast/playback/players-sdks/web/sdk/index.mdx) as a collector and connect to observability tools such as Splunk, Datadog, New Relic, Amazon Kinesis Firehose, etc.

## Client Analytics

To monitor the health of your application, [client analytics](/millicast/playback/client-analytics/index.mdx) for monitoring and troubleshooting are critical. You can choose among many observability tools for creating a dashboard with collected data such as:
...
When combined with our [Live Monitoring](/millicast/streaming-dashboard/live-monitoring.mdx) and [Stream Syndication](/millicast/distribution/syndication) capabilities you can effectively monitor playback issues and track viewer characteristics.

## Setting Up Datazoom with the Web SDK

This section outlines the steps required to initialize client-side data collection with the Millicast [Web SDK](/millicast/playback/players-sdks/web/sdk/index.mdx). There are also [collectors](https://help.datazoom.io/hc/en-us/sections/360000455512-Collectors) available that will work similarly with Android and iOS.
...
See the [Client Analytics](/millicast/playback/client-analytics/index.mdx) guide to learn more about what media statistics and metrics are captured for the WebRTC connection.
...
import DatazoomSplunkDash from '../../assets/img/datazoom-splunk-dashboard.png';

<div class="center-container">
  <img src={DatazoomSplunkDash} width="600" />
</div>
...
import DatazoomAndDatadog from '../../assets/img/datazoom-and-datadog.png';

<div class="center-container">
  <img src={DatazoomAndDatadog} width="600" />
</div>
