---
title: Datadog
slug: /playback/client-analytics/datadog
---

**Datadog** is a tool for monitoring application performance measurements and user engagement.

This page guides you on some of the metrics that are collected and setps to integrate the [Millicast SDK](/millicast/playback/players-sdks/web/sdk/index.mdx) to the browser agent.

## Client Analytics

To monitor the health of your application, [client analytics](/millicast/playback/client-analytics/index.mdx) for monitoring and troubleshooting are critical. You can customize Datadog with dashboards to display collected data such as:
...
You may also want to capture [Broadcast Events](/millicast/playback/players-sdks/viewer-events.md) for a fuller picture.
