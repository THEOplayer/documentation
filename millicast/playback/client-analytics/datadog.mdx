...
This page guides you on some of the metrics that are collected and steps to integrate the [Millicast SDK](/millicast/playback/players-sdks/web/sdk/index.mdx) to the browser agent.
