...
<ul className="checkBoxList">
  ...
  <li>
    Support with [Client SDKs](/millicast/playback/players-sdks/index.mdx) for building custom playback viewers for
    [Web](/millicast/playback/players-sdks/web/sdk/index.mdx), [iOS](/millicast/playback/players-sdks/ios/sdk/index.mdx),
    [Android](/millicast/playback/players-sdks/android/sdk/index.mdx), [React-Native](/millicast/playback/players-sdks/react-native/index.mdx),
    [Flutter](/millicast/playback/players-sdks/flutter/index.mdx), or desktop environments.
  </li>
...
[How-to Add a Poster Image](/millicast/playback/hosted-player/customization.md)<br/>
A **poster image** is a graphic that lets the audience know that a session exists but that a broadcast has not yet begun.

[How-to Provide Thumbnail Image Previews](/millicast/webhooks/thumbnail.mdx)<br/>
...
[How-to Create a Multi-view Web Application](multi-view.md)<br/>
...
[Source and Layer Selection](source-and-layer-selection.md)<br/>
...
[Syndication](/millicast/distribution/syndication)<br/>
...
<DocCardList
  items={[
    ...
    {
      type: 'link',
      href: 'https://optiview.dolby.com/resources/blog/tag/playback/',
