...
1. Follow our [Getting Started guide](/theoplayer/getting-started/sdks/android/getting-started) to set up THEOplayer in your Android app.
...
:::tip
If you're using [automatic integrations](/theoplayer/getting-started/sdks/android/features/#adding-integrations-automatically), you can skip this step.
:::
