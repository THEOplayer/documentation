...
import PublisherImg from '../../../../assets/img/01.00.00_Publisher_Documentation_1200x600.jpg';

<div class="center-container">
  <img src={PublisherImg} width="800" />
</div>

import ViewerImg from '../../../../assets/img/01.00.00_Viewer_Documentation_1200x600.jpg';
...
<DocCard
  item={{
    type: 'link',
    href: 'https://github.com/dolbyio-samples/rts-app-react-publisher-viewer',
    customProps: {
      icon: '📱',
    },
    label: 'Publisher and Viewer React Sample App',
...
- Ability to stream from up to four sources. See [Create a Multi-view Web Application](/millicast/playback/multi-view.md) for bandwidth limitations.
