...
### How-to Control ABR Strategies

This is an example of using `abrConfiguration` in the SDK to control the ABR behavior. For more details on how this works, please refer to the description in the [OptiView Player Page](/millicast/playback/players-sdks/web/player/#controlling-abr-strategies).
