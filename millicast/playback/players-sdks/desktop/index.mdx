---
title: Desktop
slug: /playback/players-sdks/desktop
sidebar_position: 6
---
...
<ThreeCardList
  items={[
    ...
    {
      type: 'link',
      href: '/millicast/playback/players-sdks/desktop/getting-started-with-publishing',
      docId: 'playback/players-sdks/desktop/getting-started-with-publishing',
      customProps: {
        icon: '🚀',
      },
