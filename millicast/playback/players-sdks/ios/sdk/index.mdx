...
<DocCardList
  items={[
    ...
    {
      type: 'link',
      href: '/millicast/playback/players-sdks/ios/sdk/getting-started-with-publishing',
      docId: 'playback/players-sdks/ios/sdk/getting-started-with-publishing',
      customProps: {
        icon: '🚀',
      },
...
- [Getting Started with Subscribing](getting-started-with-subscribing.md)
- [How-to Add Picture in Picture](how-to-add-picture-in-picture.mdx)
- [Migration Guide for iOS SDK](sdk-migration-guide.mdx)
