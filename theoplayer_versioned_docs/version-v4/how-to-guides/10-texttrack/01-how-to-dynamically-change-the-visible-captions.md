...
This method assumes that you are using text-tracks that are loaded with the manifest. If you add the text-track separately, you can just use this API: [TextTrackDescription](pathname:///theoplayer/v4/api-reference/web/interfaces/TextTrackDescription.html)
...
- [Android Legacy (4.12.x) SDK](../../getting-started/01-sdks/02-android/00-getting-started.md)
