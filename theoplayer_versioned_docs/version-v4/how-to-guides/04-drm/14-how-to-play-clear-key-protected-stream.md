...
Please check also our related [API documentation](pathname:///theoplayer/v4/api-reference/web/interfaces/SourceDescription.html) on how to set these.
...
- [API Reference - ClearkeyDecryptionKey](pathname:///theoplayer/v4/api-reference/web/interfaces/ClearkeyDecryptionKey.html)
