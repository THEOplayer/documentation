...
The UI of this button changes when the [Chromecast state](pathname:///theoplayer/v4/api-reference/web/types/CastState.html) changes.
...
- Web: [Chromecast API](pathname:///theoplayer/v4/api-reference/web/interfaces/Chromecast.html), [Cast API](pathname:///theoplayer/v4/api-reference/web/interfaces/VendorCast.html), [Cast Events API](pathname:///theoplayer/v4/api-reference/web/interfaces/VendorCastEventMap.html)
- iOS: [Chromecast API](pathname:///theoplayer/v4/api-reference/ios/Protocols/Chromecast.html), [Chromecast Events API](pathname:///theoplayer/v4/api-reference/ios/ChromeCast%20Events.html#/s:13THEOplayerSDK16StateChangeEventC)
- Android: [Chromecast API](pathname:///theoplayer/v4/api-reference/android/com/theoplayer/android/api/cast/chromecast/Chromecast.html), [Chromecast Events API](pathname:///theoplayer/v4/api-reference/android/com/theoplayer/android/api/event/chromecast/CastStateChangeEvent.html)
...
You can provide Chromecast metadata in all three set-ups. Providing [Chromecast metadata](pathname:///theoplayer/v4/api-reference/web/interfaces/SourceDescription.html#metadata) will make your Receiver application show relevant info (e.g. a title, a thumbnail, ...) when
