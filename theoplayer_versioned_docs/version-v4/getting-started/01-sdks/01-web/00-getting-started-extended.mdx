...
You register with your Github or Google account through the [sign-in page](https://portal.theoplayer.com/login), or complete the [sign-up form](https://portal.theoplayer.com/register).
...
<iframe
  ...
  width="100%"
  height="300"
  src="//jsfiddle.net/thijsl/zs39fgj5/1/embedded/result"
  allowFullScreen
  frameBorder="0"
></iframe>
...
<iframe
  ...
  width="100%"
  height="600"
  src="//jsfiddle.net/georgechoustoulakis/uymLn9vj/50/embedded/result/"
  allowFullScreen
  frameBorder="0"
></iframe>
...
<iframe
  ...
  width="100%"
  height="600"
  src="//jsfiddle.net/georgechoustoulakis/23yuvcjp/3/embedded/result/"
  allowFullScreen
  frameBorder="0"
></iframe>
...
<iframe
  ...
  width="100%"
  height="600"
  src="//jsfiddle.net/georgechoustoulakis/21fphaqL/5/embedded/result,html/"
  allowFullScreen
  frameBorder="0"
></iframe>
...
- [https://optiview.dolby.com/](https://optiview.dolby.com/): homepage — use this to find demos and product information
  - [https://www.theoplayer.com/theoplayer-demo-overview ](https://www.theoplayer.com/theoplayer-demo-overview): demos
  - [https://optiview.dolby.com/resources/demos/test-stream/](https://optiview.dolby.com/resources/demos/test-stream/): stream tester
- [https://optiview.dolby.com/resources/blog/](https://optiview.dolby.com/resources/blog/): blog
- [https://portal.theoplayer.com](https://portal.theoplayer.com): developer portal — use this to manage your SDKs and monitor usage

### API

The API reference of the THEOplayer Web SDK is available at [https://optiview.dolby.com/docs/theoplayer/v4/api-reference/web/](pathname:///theoplayer/v4/api-reference/web/).
The API is also widely referred to in our guides at [https://optiview.dolby.com/docs/](https://optiview.dolby.com/docs/).
...
<iframe
  ...
  src="https://cdn.theoplayer.com/demos/getting-started/web-sdk/portal.html"
...
<em>
  We hope that you enjoyed this Getting Started Guide! [Let us know through Github](https://github.com/THEOplayer/documentation/issues) if you know
  how we could improve this introduction.
</em>
