...
Create a THEOplayer `"Player"` instance by using the [THEOplayer constructor API](pathname:///theoplayer/v4/api-reference/web/classes/Player.html#constructor).
...
You use the [`source`](pathname:///theoplayer/v4/api-reference/web/classes/ChromelessPlayer.html#source) property of your `player` instance to configure a video.
...
- [https://docs.theoplayer.com](https://docs.theoplayer.com): documentation portal — use this to find documentation
  - [http://www.theoplayer.com/docs/theoplayer/v4/api-reference/web/](pathname:///theoplayer/v4/api-reference/web/): API Reference
...
The API reference of the THEOplayer Web SDK is available at [http://www.theoplayer.com/docs/theoplayer/v4/api-reference/web/](pathname:///theoplayer/v4/api-reference/web/).
...
The top-level interface is the [Player API](pathname:///theoplayer/v4/api-reference/web/classes/ChromelessPlayer.html).
A [map of events](pathname:///theoplayer/v4/api-reference/web/interfaces/PlayerEventMap.html) is available in the Player API,
...
You add support for autoplay by setting [`player.autoplay = true`](pathname:///theoplayer/v4/api-reference/web/types/MutedAutoplayConfiguration.html).
Additionally, we set [`mutedAutoplay: "all"`](pathname:///theoplayer/v4/api-reference/web/types/MutedAutoplayConfiguration.html) in the player configuration, to [combat autoplay policies](../../../faq/02-how-to-combat-autoplay-policies.md).
...
[Other valid preload values](pathname:///theoplayer/v4/api-reference/web/types/PreloadType.html) are:
...
Other valid values for type are [`performance` and `bandwidth`](pathname:///theoplayer/v4/api-reference/web/types/ABRStrategyType.html#abrstrategytype-type).
...
You add an `ads` key to the `player.source` object. This key holds a list of [ad descriptions](pathname:///theoplayer/v4/api-reference/web/interfaces/AdDescription.html). Each ad description is an advertisement.
