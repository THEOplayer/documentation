...
Please note that it is not possible to inject JavaScript/CSS to [Android SDK 5.0+](../../version-v9/getting-started/01-sdks/02-android/00-getting-started.mdx) with this method.
