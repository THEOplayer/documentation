...
- The central THEO documentation at https://docs.theoplayer.com contains
  - Getting started guides that help you set up a THEOplayer SDK or framework (e.g. [Web SDK](../getting-started/01-sdks/01-web/00-getting-started.mdx), [React Native](../external/react-native/doc/getting-started.md), ...)
  ...
  - API references that document APIs per SDK (e.g. [Web](pathname:///theoplayer/v4/api-reference/web/), [iOS](pathname:///theoplayer/v4/api-reference/ios/), [Android](pathname:///theoplayer/v4/api-reference/android/))
