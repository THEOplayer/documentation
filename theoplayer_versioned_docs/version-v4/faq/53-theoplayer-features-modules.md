...
You can call [`THEOplayer.features`](pathname:///theoplayer/v4/api-reference/web/variables/features.html) to identify which features are enabled.
...
As a developer, you could consider [async library loading](https://demo.theoplayer.com/async-library-loading), you could change your [ABR strategy](pathname:///theoplayer/v4/api-reference/web/types/ABRStrategyType.html) (as [demonstrated](https://demo.theoplayer.com/increase-viewer-experience-optimizing-video-abr)),
