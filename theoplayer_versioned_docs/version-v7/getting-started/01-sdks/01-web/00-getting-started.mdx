...
You tell THEOplayer where you put those files by setting the `libraryLocation` in your [player configuration](pathname:///theoplayer/v7/api-reference/web/interfaces/PlayerConfiguration.html).
