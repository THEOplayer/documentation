...
- The central THEO documentation at https://docs.theoplayer.com contains
  ...
  - API references that document APIs per SDK (e.g. [Web](pathname:///theoplayer/v7/api-reference/web/), [iOS](pathname:///theoplayer/v7/api-reference/ios/), [Android](pathname:///theoplayer/v7/api-reference/android/))
