...
When you set the `blockContentIfAdError` to `true` in your stream configuration (i.e. [SourceConfiguration](pathname:///theoplayer/v7/api-reference/web/interfaces/SourceConfiguration.html#blockContentIfAdError)),
...
- API reference: [Ads API](pathname:///theoplayer/v7/api-reference/web/interfaces/Ads.html)
