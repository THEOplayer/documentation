...
The Web SDK leverages the [TextTrack API](pathname:///theoplayer/v9/api-reference/web/interfaces/TextTrack.html).
...
The Android SDK leverages the [TextTrack API](pathname:///theoplayer/v9/api-reference/android/com/theoplayer/android/api/player/track/texttrack/TextTrackList.html).
...
The iOS SDK leverages the [MediaTrack API](pathname:///theoplayer/v9/api-reference/ios/Protocols/MediaTrackList.html).
