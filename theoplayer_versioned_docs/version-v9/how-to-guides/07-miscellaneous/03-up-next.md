...
- Reference API: [Up Next API](pathname:///theoplayer/v9/api-reference/web/classes/Player.html#upnext)
...
The Up Next API is currently unavailable on all SDKs except the Web SDK, because the underlying THEOplayer CSS and JavaScript modules aren't activated. This means that you also can't enable it using the guide located at [How to add CSS or JavaScript files to an Android/iOS project](https://optiview.dolby.com/docs/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios).

## Resources

The following resources provide more information:

- [Up Next API](pathname:///theoplayer/v9/api-reference/web/classes/Player.html#upnext)
