...
It takes you through the required steps to achieve a basic manual implementation of the Player SDK on Web.
...
![THEOplayer Developer Portal's dashboard](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-dashboard.png)
...
![THEOplayer Developer Portal SDK Page](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-sdk.png)
...
![Choose platform](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-choose-platform.png)
...
![License generated](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-license.png)
...
You register with your GitHub or Google account through the sign-in page, or complete the sign-up form. You sign in with your GitHub or Google account, or with your credentials, through the sign-in page.
...
![THEOplayer Developer Portal's dashboard custom](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-custom-sdk.png)
...
![Custom SDK redirect](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-sdk-redirect.png)
...
![Build SDK](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-build-sdk.png)
...
![SDK ready](../../../../../theoplayer/assets/img/getting-started-web-sdk/portal-sdk-ready.png)
...
The snippet below creates a THEOplayer instance for a container with a specific [Player Configuration](pathname:///theoplayer/v9/api-reference/web/interfaces/PlayerConfiguration.html).
...
You tell THEOplayer where you put those files by setting the `libraryLocation` in your [player configuration](pathname:///theoplayer/v9/api-reference/web/interfaces/PlayerConfiguration.html).
