...
1. [iOS SDK Customization](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/ios/ios-sdk-customization) for the iOS SDK
2. [Android Legacy (4.12.x) SDK Customization](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/android/android-sdk-customization) for the Android SDK
...
This flow is described at [iOS SDK Customization](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/ios/ios-sdk-customization).
...
The communication between native Android and JavaScript is documented at [Android Legacy (4.12.x) SDK Customization](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/android/android-sdk-customization).
