...
Each language should be described as a [UIConfiguration](pathname:///theoplayer/v10/api-reference/web/interfaces/UIConfiguration.html)
...
1. An Additional separate JavaScript file needs to be added to your Android project. You can follow the instructions presented in this article: [How to add/customize the Android THEOplayer SDK](https://optiview.dolby.com/docs/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios)
...
1. An Additional separate JavaScript file needs to be added to your Android project. You can follow the instructions presented in this article: [How to add/customize the iOS THEOplayer SDK](https://optiview.dolby.com/docs/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios)
