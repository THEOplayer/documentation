...
The question above is commonly asked to assist with the use-cases where the first [`play`](pathname:///theoplayer/v10/api-reference/web/interfaces/PlayerEventMap.html#play) event thrown by THEOplayer for a specific stream needs to be detected. Similar questions are:
...
- [Reference API - play event](pathname:///theoplayer/v10/api-reference/web/interfaces/PlayerEventMap.html#play):
