...
The player configuration should include the [AgamaPlayerConfiguration](pathname:///theoplayer/v10/api-reference/web/interfaces/AgamaPlayerConfiguration.html) object.
...
The player's source configuration should include the [AgamaSourceConfiguration](pathname:///theoplayer/v10/api-reference/web/interfaces/AgamaSourceConfiguration.html) object.
...
Once the player is configured, an Agama EMP client is created.
The player source configuration should include the [AgamaSourceConfiguration](pathname:///theoplayer/v10/api-reference/web/interfaces/AgamaSourceConfiguration.html) object in the analytics tag:
