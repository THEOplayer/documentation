...
![iframe YouTube example](../../../../../theoplayer/assets/img/iframe-youtube-example.png 'iframe YouTube example')
...
You can easily allow embedding by setting the `isEmbeddable`-flag in the THEOplayer's [`PlayerConfiguration`](pathname:///theoplayer/v10/api-reference/web/interfaces/PlayerConfiguration.html) to `true`, as demonstrated by the code snippet below.
...
- [Player API - PlayerConfiguration](pathname:///theoplayer/v10/api-reference/web/interfaces/PlayerConfiguration.html)
