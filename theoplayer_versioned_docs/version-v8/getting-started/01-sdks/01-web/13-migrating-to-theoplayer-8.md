...
This article will guide your through updating to THEOplayer Web SDK version 8 (from version 7),
...
If you're using the [Open Video UI for Web](/theoplayer/how-to-guides/web/ui/open-video-ui/) or one of [our connectors](/theoplayer/connectors/web/),
