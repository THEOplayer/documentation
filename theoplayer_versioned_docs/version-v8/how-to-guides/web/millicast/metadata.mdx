...
First, follow [our Getting Started with Millicast on Web guide](./getting-started.mdx)
to set up Millicast with THEOplayer in your web app or website.

Then, enable the `metadata` option in your [Millicast source's `connectOptions`](./getting-started.mdx#add-configuration)
...
See [our guide on how to detect active text track cues](../../10-texttrack/08-how-to-detect-active-text-track-cues.md)
for more information.

## More information

- [API references](pathname:///theoplayer/v8/api-reference/web/interfaces/MillicastMetadataCue.html)
- [Millicast documentation](https://docs.dolby.io/streaming-apis/docs/frame-metadata)
