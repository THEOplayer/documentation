...
- `layout`: Default experience layout, see [ad experience layout](/ads/v1/how-to-guides/override-layout/).
...
Please refer to the [API reference](/ads/v1/api/signaling/theoads-api/) for even more detailed information on the REST API.
...
For scheduling ad breaks through the REST API, please refer to the [API definitions](/ads/v1/api/signaling/create-monetized-stream-break/) and the example below.
...
For more in depth information on scheduling ad breaks we refer to our [How-to guide: Scheduling breaks](/ads/v1/how-to-guides/scheduling-breaks/)
