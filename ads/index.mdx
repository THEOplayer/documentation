...
OptiView Ads is an ad-insertion service for LIVE content (VoD support coming soon), utilizing Server-Guided Ad-Insertion (SGAI). On these pages, you'll learn how to get started with OptiView Ads, how to use the configure the player, and integrate the signaling service APIs.
