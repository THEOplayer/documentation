...
| ---------------------------------- | --------------------------------------------------------------------------------------- |
| [Web](./web.mdx)                   | HLS.js, Shaka Player, THEOplayer, native `<video>` (Safari), or a custom player adapter |
| [Android](./android.mdx)           | Media3 / ExoPlayer, or a custom player adapter                                          |
| [iOS](./ios.mdx)                   | AVPlayer, or a custom player adapter                                                    |
| [React Native](./react-native.mdx) | `react-native-theoplayer`, `react-native-video` (v6)                                    |
