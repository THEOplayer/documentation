...
Any other player can be integrated by implementing the SDK's [`PlayerAdapter`](pathname:///ads/v2/api-reference/ios/OptiViewAdsCore/documentation/optiviewadscore/playeradapter/) protocol, which exposes playback position, timing information, and basic playback controls.
