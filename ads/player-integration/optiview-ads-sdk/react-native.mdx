...
Attach the SDK to your host player once it is ready, then start a session with the channel's Break Manifest URL:

```tsx
import { THEOplayerView } from 'react-native-theoplayer';
import { createOptiViewAds } from '@optiview-ads/react-native';
