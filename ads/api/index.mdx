...
The OptiView Ads SDK emits events for the ad lifecycle — breaks, individual ads, quartiles, errors, and buffering — so your application can build custom UI and analytics on top of them. See the [SDK events reference](/ads/api/sdk-events).
