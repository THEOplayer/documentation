...
Detection history is the audit trail of what automatic detection decided for each marker. Every processed marker is recorded with one of three outcomes:
