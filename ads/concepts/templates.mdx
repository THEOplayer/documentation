...
```bash
curl -X POST 'https://us.ads.optiview.dolby.com/api/v1/templates' \
      ...
      "assets": [
        {
          "type": "vast",
          "mediaType": "video",
          "uri": "https://adserver.example.com/vast/midroll.xml"
        }
      ]
    }
  }'
...
```bash
curl 'https://us.ads.optiview.dolby.com/api/v1/templates/midroll-30s' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
```bash
curl -X PATCH 'https://us.ads.optiview.dolby.com/api/v1/templates/midroll-30s' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'Content-Type: application/json' \
  -H 'X-Org-ID: org_123' \
  -d '{
...
```bash
curl 'https://us.ads.optiview.dolby.com/api/v1/templates?page=1&pageSize=20&sort=-createdAt' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
curl 'https://us.ads.optiview.dolby.com/api/v1/templates?filter=format==overlay' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
curl 'https://us.ads.optiview.dolby.com/api/v1/templates?filter=duration=le=30;assetType==vast&sort=duration' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
curl 'https://us.ads.optiview.dolby.com/api/v1/templates?filter=vendor==gam' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
```bash
curl -X DELETE 'https://us.ads.optiview.dolby.com/api/v1/templates/midroll-30s' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
```bash
curl -X DELETE 'https://us.ads.optiview.dolby.com/api/v1/templates' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'Content-Type: application/json' \
  -H 'X-Org-ID: org_123' \
...
```bash
curl -X POST 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/breaks' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'Content-Type: application/json' \
  -H 'X-Org-ID: org_123' \
  -d '{
