...
```bash
curl -X POST 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/events' \
...
```bash
curl 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/events/finals-2026' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
```bash
curl -X PATCH 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/events/finals-2026' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'Content-Type: application/json' \
  -H 'X-Org-ID: org_123' \
  -d '{
...
```bash
curl 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/events?page=1&pageSize=20&sort=-createdAt' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
```bash
curl 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/events/finals-2026/breaks?pageSize=50' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
```bash
curl -X DELETE 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/events/finals-2026' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
...
```bash
curl -X DELETE 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/events' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'Content-Type: application/json' \
  -H 'X-Org-ID: org_123' \
...
```bash
curl -X POST 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/breaks/halftime-1/punch' \
  -u "$ADS_API_KEY:$ADS_API_SECRET" \
  -H 'X-Org-ID: org_123'
```
