...
| Integrations                       | Channel-level delivery integrations, including Server-Side Ad Insertion with Google DAI. |
...
- Integrations and Google DAI — vendor pod decisioning and delivery.
