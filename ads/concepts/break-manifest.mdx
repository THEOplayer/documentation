...
```json
{
  ...
  "breaks": [
    {
      "id": "9c1e2b34-5d6f-4a78-9b0c-1d2e3f4a5b6c",
...
```json
{
  ...
  "breaks": [
    {
      "id": "4d5e6f70-8a9b-4c1d-a2b3-c4d5e6f70819",
      "start": 5400000, // numeric PTS start on the channel media clock
      "duration": 30, // seconds
      "variant": [
        {
          "format": "single", // default full-screen experience
          "assets": [{ "id": "a1", "type": "vast", "mediaType": "video", "uri": "https://adserver.example.com/vast.xml" }]
        },
        {
