...
```bash
curl -X POST 'https://us.ads.optiview.dolby.com/api/v1/channels/sports-main/integrations' \
...
| [Breaks](../concepts/breaks.mdx)                 | Carry the vendor asset that Google decisions.                              |
