...
An integration connects OptiView Ads to an ad decisioning or serving vendor that breaks are signaled to. Google Ad Manager 360 is the first supported integration.
