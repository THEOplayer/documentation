...
| [Getting started on Web](../../player-integration/optiview-player/web.mdx)         | Set up an OptiView player with pod serving on web.                       |
| [Getting started on iOS](../../player-integration/optiview-player/ios.mdx)         | Set up an OptiView player with pod serving on iOS.                       |
| [Getting started on Android](../../player-integration/optiview-player/android.mdx) | Set up an OptiView player with pod serving on Android.                   |
