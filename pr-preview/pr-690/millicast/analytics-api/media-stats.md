...
* **Cluster**: The data center being used for the broadcast origin. See [Cluster Regions](/documentation/pr-preview/pr-690/millicast/distribution/multi-region-support.md) for more details on this data.

Active Broadcast

The Media Stats are only available during an active broadcast. You may also be interested in other means of gathering [Client Analytics](/documentation/pr-preview/pr-690/millicast/playback/client-analytics.md) and monitoring the playback experience.
...
![](/documentation/pr-preview/pr-690/assets/images/dolbyio-broadcaster-media-stats-e6489d7ea9e73c9cf6983cb32a09adef.png)
