...
Ingesting raw video and audio frames can be useful for creating and managing unique WebRTC encoding workflows. Whilst [traditional encoders](/documentation/pr-preview/pr-690/millicast/hardware-encoders.md) provide general-purpose encoding solutions, there are some use cases such as [real-time streaming from drones](/documentation/pr-preview/pr-690/millicast/capture/live-streaming-from-drones.md) where traditional encoding solutions are too heavy, power consumptive, or expensive to suffice.
...
## Using the Core API[​](#using-the-core-api "Direct link to Using the Core API")

### Creating custom audio and video frame classes[​](#creating-custom-audio-and-video-frame-classes "Direct link to Creating custom audio and video frame classes")
...
### Creating and publishing a custom source[​](#creating-and-publishing-a-custom-source "Direct link to Creating and publishing a custom source")
...
With the audio and video source instantiated, the frames can now be passed as inputs to the `Publisher` object. To learn more about publishing a stream from the native SDKs explore the [Native SDK guides](/documentation/pr-preview/pr-690/millicast/playback/players-sdks.md) in the Client SDKs section of the documentation.

## Using the iOS API[​](#using-the-ios-api "Direct link to Using the iOS API")

### Creating custom audio and video frame classes[​](#creating-custom-audio-and-video-frame-classes-1 "Direct link to Creating custom audio and video frame classes")
...
### Creating and publishing a custom source[​](#creating-and-publishing-a-custom-source-1 "Direct link to Creating and publishing a custom source")
...
## Using the Android API[​](#using-the-android-api "Direct link to Using the Android API")

### Creating custom audio and video frame classes[​](#creating-custom-audio-and-video-frame-classes-2 "Direct link to Creating custom audio and video frame classes")
...
### Creating and publishing a custom source[​](#creating-and-publishing-a-custom-source-2 "Direct link to Creating and publishing a custom source")
