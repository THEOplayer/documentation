...
* Am I planning to broadcast with [RTMP, RTMPs](/documentation/pr-preview/pr-690/millicast/broadcast/rtmp-and-rtmps.md), [SRT](/documentation/pr-preview/pr-690/millicast/broadcast/srt.md), or [WebRTC](/documentation/pr-preview/pr-690/millicast/hardware-encoders/osprey.md)?
...
Since RTMP, RTMPs, and SRT streams are transmuxed into WebRTC via the OptiView Real-time CDN they each have different audio and video codec support. Learn more in the [broadcast section](/documentation/pr-preview/pr-690/millicast/broadcast.md) of the streaming guides.

Once you have calibrated the camera for the appropriate video resolution and audio resolution for your use case, you will then need to connect the camera to an encoder or calibrate the built-in encoder. OptiView Real-time Streaming supports broadcasting [RTMP and RTMPs streams](/documentation/pr-preview/pr-690/millicast/broadcast/rtmp-and-rtmps.md), [SRT streams](/documentation/pr-preview/pr-690/millicast/broadcast/srt.md), and [WebRTC streams](/documentation/pr-preview/pr-690/millicast/hardware-encoders/osprey.md). To start streaming with OptiView Real-time Streaming, proceed to the [Broadcast section](/documentation/pr-preview/pr-690/millicast/broadcast.md) to learn about hardware and software encoder support.

## Preparing to broadcast with the SalrayWorks raySHOT camera[​](#preparing-to-broadcast-with-the-salrayworks-rayshot-camera "Direct link to Preparing to broadcast with the SalrayWorks raySHOT camera")
...
* **Does my camera have a built-in encoder, or will I need to connect to one?** The camera does not have a built-in encoder, so we'll use a [Videon EdgeCaster](/documentation/pr-preview/pr-690/millicast/videon.md).
* **Am I planning to broadcast with [RTMP, RTMPs](/documentation/pr-preview/pr-690/millicast/broadcast/rtmp-and-rtmps.md), [SRT](/documentation/pr-preview/pr-690/millicast/broadcast/srt.md), or [WebRTC](/documentation/pr-preview/pr-690/millicast/hardware-encoders/osprey.md)?** Videon supports RTMP output, so we'll use that.

With our capture profile defined, we can look at our physical setup:

<!-- -->

![](/documentation/pr-preview/pr-690/assets/images/Salrayworks-setup-e9756e352c6dc27067b0240a77eedb83.jpg)
...
![](/documentation/pr-preview/pr-690/assets/images/Salrayworks-ready-to-stream-fed6b3494c185b7c278d9d85c0b9f435.jpg)

With everything connected, the SalrayWorks camera is now ready to capture broadcast-ready video and transport it to the encoder. At this stage, everything is set up and ready for capture. To learn about the next steps required for broadcasting, check out the [Videon guide](/documentation/pr-preview/pr-690/millicast/videon.md) in the broadcasting section of the documentation.
