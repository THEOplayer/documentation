...
**Please refer to [List Media Assets](/documentation/pr-preview/pr-690/millicast/api/media-assets-list-media-assets.md) and query using the `streamName`parameter**
