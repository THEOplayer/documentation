# Update to Project and TrackIds

This is part of our [Multi-view](/documentation/pr-preview/pr-690/millicast/playback/multiview.md) feature and only impacts users who where using the multiview feature and their own player SDK implementation. If you are using the hosted video player, there is no update to apply.
...
## Prior to the January release[​](#prior-to-the-january-release "Direct link to Prior to the January release")
...
## After the release[​](#after-the-release "Direct link to After the release")

After the 2025-02-12 media server release, this value will be dynamic when returned int he [`active` Broadcast Event](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/viewer-events.md)
...
## Calling the `project()` command[​](#calling-the-project-command "Direct link to calling-the-project-command")
...
## What happens if I don't make a change?[​](#what-happens-if-i-dont-make-a-change "Direct link to What happens if I don't make a change?")
