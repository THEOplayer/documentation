...
## Videon EdgeCaster[​](#videon-edgecaster "Direct link to Videon EdgeCaster")

### How-to use multi-bitrate on Videon EdgeCaster[​](#how-to-use-multi-bitrate-on-videon-edgecaster "Direct link to How-to use multi-bitrate on Videon EdgeCaster")
...
![](/documentation/pr-preview/pr-690/assets/images/videon_audio_profiles-06e99437cd8f80a4019624dbb332ea3e.png)

#### Using RTMP[​](#using-rtmp "Direct link to Using RTMP")

Open your OptiView Real-time Streaming Dashboard and copy the [**RTMP publishing paths**](/documentation/pr-preview/pr-690/millicast/broadcast/rtmp-and-rtmps.md). Additionally, enable the\*\* RTMP multi-bitrate\*\* toggle. You can also use the [Multi-Source builder](/documentation/pr-preview/pr-690/millicast/multi-source-builder.md) to generate those URLs.

Under **Outputs**, for each **RTMP**, select **Video Source** corresponding to the RTMP profile (1080p for the highest profile and 360p for the lowest profile). Make sure to set **Streaming Providers** to *Generic RTMP* and paste the **Stream URL** from the OptiView RTMP dashboard.

<!-- -->

![](/documentation/pr-preview/pr-690/assets/images/videon_outputs-016e7edacd98aac7d98e75214394e3b7.png)
...
![](/documentation/pr-preview/pr-690/assets/images/videon-rtmp-e570fdf896c1f90bba703af194bdbe64.png)

#### Using SRT[​](#using-srt "Direct link to Using SRT")

Under **Outputs**, for each **SRT**, select **Video Source** corresponding to the SRT profile (1080p for the highest profile and 360p for the lowest profile). For the **URL**, select the *srt://* protocol, enter the URL of the **SRT publish path** from the OptiView Real-time Streaming Dashboard, and enter port 10000. For the **Stream ID**, use the **SRT stream ID** from the dashboard and append **\&simulcastId** for the first layer, **\&sourceId=1\&simulcastId\&videoOnly** for the second layer, and **\&sourceId=2\&simulcastId\&videoOnly** for the third layer. You can also use the [Multi-Source builder](/documentation/pr-preview/pr-690/millicast/multi-source-builder.md) to generate those URLs.
...
![](/documentation/pr-preview/pr-690/assets/images/videon-srt-9d90553f6038dcc545c375d16855e838.png)

### How-to apply a multi-viewer with Videon EdgeCaster[​](#how-to-apply-a-multi-viewer-with-videon-edgecaster "Direct link to How-to apply a multi-viewer with Videon EdgeCaster")

You can also use the [Multi-Source builder](/documentation/pr-preview/pr-690/millicast/multi-source-builder.md) to generate the URLs. For information on Simulcast, refer to [the documentation](/documentation/pr-preview/pr-690/millicast/distribution/using-webrtc-simulcast.md) to understand its usage.

#### Using RTMP[​](#using-rtmp-1 "Direct link to Using RTMP")
...
#### Using SRT[​](#using-srt-1 "Direct link to Using SRT")
