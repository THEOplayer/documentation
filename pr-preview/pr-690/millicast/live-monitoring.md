...
![](/documentation/pr-preview/pr-690/assets/images/live_monitor_assets_v2_Grid_view-644071a5202604fa1a35caa2b01b13f2.png)
...
1. **Duration**: The amount of time the stream has been live, displayed in days, hours, minutes, and seconds (DD:HH:MM
   <!-- -->
   :SS
   <!-- -->
   ).
...
9. **Redundant status**: Indicates whether the stream has a redundant option associated with it for failover. For example, if the stream has multiple quality layer feeds, and the highest quality layer has [redundant ingest](/documentation/pr-preview/pr-690/millicast/broadcast/redundant-ingest.md) enabled, the stream will be tagged as redundant.
...
![](/documentation/pr-preview/pr-690/assets/images/live_monitor_assets_MVP_list_view-f1bce777c41a641405cefb8cafb61a79.jpg)

## Detailed View[​](#detailed-view "Direct link to Detailed View")

<!-- -->

![](/documentation/pr-preview/pr-690/assets/images/live_monitor_assets_MVP_detailed_view_-_not_live-8068fef86412cec5fff33b43857ff183.jpg)

### Ingest Statistics[​](#ingest-statistics "Direct link to Ingest Statistics")
...
* **B Frames**: Indicates the presence of b-frames in the feed. For best results, we recommend disabling b-frames in your feed. For more information, see [Configuring Simulcast](/documentation/pr-preview/pr-690/millicast/distribution/using-webrtc-simulcast.md#configuring-simulcast).
...
* **Cluster region**: Indicates what [regions](/documentation/pr-preview/pr-690/millicast/distribution/multi-region-support.md) the stream is ingesting to.
...
### Redundant Ingest Statistics[​](#redundant-ingest-statistics "Direct link to Redundant Ingest Statistics")

<!-- -->

![](/documentation/pr-preview/pr-690/assets/images/live-monitoring-detail-redudnant-ingest-af31f74e24a6606ae5e46260c3a3cbc5.png)

The details page for each stream also displays redundant ingest statistics if redundant ingests are detected.

### Ingest Telemetry[​](#ingest-telemetry "Direct link to Ingest Telemetry")

<!-- -->

![](/documentation/pr-preview/pr-690/assets/images/live-monitoring-detail-telemetry-a0e4ddd048be46f7573061e9e603fe5d.png)
...
![](/documentation/pr-preview/pr-690/assets/images/live-monitoring-detail-events-12f6593b7c0bf3751d35350521fac357.png)
...
## Offline Streams[​](#offline-streams "Direct link to Offline Streams")
