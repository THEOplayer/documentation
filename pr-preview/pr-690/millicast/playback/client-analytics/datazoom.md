...
This page guides you on some of the metrics that are collected and steps to integrate the [Millicast SDK](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/web/sdk.md) as a collector and connect to observability tools such as Splunk, Datadog, New Relic, Amazon Kinesis Firehose, etc.

## Client Analytics[​](#client-analytics "Direct link to Client Analytics")

To monitor the health of your application, [client analytics](/documentation/pr-preview/pr-690/millicast/playback/client-analytics.md) for monitoring and troubleshooting are critical. You can choose among many observability tools for creating a dashboard with collected data such as:
...
When combined with our [Live Monitoring](/documentation/pr-preview/pr-690/millicast/live-monitoring.md) and [Stream Syndication](/documentation/pr-preview/pr-690/millicast/distribution/syndication.md) capabilities you can effectively monitor playback issues and track viewer characteristics.

## Setting Up Datazoom with the Web SDK[​](#setting-up-datazoom-with-the-web-sdk "Direct link to Setting Up Datazoom with the Web SDK")

This section outlines the steps required to initialize client-side data collection with the Millicast [Web SDK](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/web/sdk.md). There are also [collectors](https://help.datazoom.io/hc/en-us/sections/360000455512-Collectors) available that will work similarly with Android and iOS.

### 1. Include Datazoom Beacon[​](#1-include-datazoom-beacon "Direct link to 1. Include Datazoom Beacon")
...
### 2. Track Player Engagement[​](#2-track-player-engagement "Direct link to 2. Track Player Engagement")
...
### 3. Collect Custom WebRTC Stats[​](#3-collect-custom-webrtc-stats "Direct link to 3. Collect Custom WebRTC Stats")

See the [Client Analytics](/documentation/pr-preview/pr-690/millicast/playback/client-analytics.md) guide to learn more about what media statistics and metrics are captured for the WebRTC connection.
...
### 4. Monitor with a Datazoom Connector[​](#4-monitor-with-a-datazoom-connector "Direct link to 4. Monitor with a Datazoom Connector")
...
#### Splunk[​](#splunk "Direct link to Splunk")

Here is a preview of what a dashboard might look like in Splunk:

<!-- -->

![](/documentation/pr-preview/pr-690/assets/images/datazoom-splunk-dashboard-04ddbc7ea3f5caaab837d78c265258b5.png)
...
![](/documentation/pr-preview/pr-690/assets/images/datazoom-and-datadog-27a6b9274261f834af0550933ef18661.png)
