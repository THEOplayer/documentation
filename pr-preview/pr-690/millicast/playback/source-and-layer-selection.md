...
OptiView Real-time Streaming supports ingesting [Multi-source Streams](/documentation/pr-preview/pr-690/millicast/broadcast/multi-source-broadcasting.md) and rendering multiple audio and video streams for building [Multi-view](/documentation/pr-preview/pr-690/millicast/playback/multiview.md) and [Audio Multiplexing](/documentation/pr-preview/pr-690/millicast/playback/audio-multiplexing.md) experiences.
...
## Managing source selection[​](#managing-source-selection "Direct link to Managing source selection")

Multi-source broadcasting

To manage multiple sources, you first must have a [Multi-source Stream](/documentation/pr-preview/pr-690/millicast/broadcast/multi-source-broadcasting.md) broadcasting.
...
* **Publisher nodes**: These nodes manage [the ingest of multiple sources](/documentation/pr-preview/pr-690/millicast/broadcast/multi-source-broadcasting.md) during the broadcast. They can then forward these feeds to the CDN for the Viewer node to manage.
...
When the publisher node has a feed ready to be passed to a viewer node, it triggers a [broadcastEvent](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/viewer-events.md). This event can be listened to by taking the [millicast.View](https://millicast.github.io/millicast-sdk/View.html) object and [adding an event listener](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/viewer-events.md#using-events) to it:
...
## Projecting feeds[​](#projecting-feeds "Direct link to Projecting feeds")
...
## Media layer forwarding[​](#media-layer-forwarding "Direct link to Media layer forwarding")
...
Projecting with layer selection using select
...
To force layer selection, [listen to the incoming layers in the layer broadcast event](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/web/sdk.md#broadcast-events) and then select the active layer using the following command:
...
### Managing layers[​](#managing-layers "Direct link to Managing layers")
...
### Promoting feeds[​](#promoting-feeds "Direct link to Promoting feeds")
...
## Dynamic viewer track[​](#dynamic-viewer-track "Direct link to Dynamic viewer track")
...
Dynamically adding a remote track on the viewer
