...
### Metadata Source Identification[​](#metadata-source-identification "Direct link to Metadata Source Identification")
...
### Timecode Metadata[​](#timecode-metadata "Direct link to Timecode Metadata")
...
2. Send RTMP with onFi (part of OnMetaData in AMF metadata). The service will read this value from the RTMP stream and insert it into the SEI metadata of the timecode (See [Metadata Source Identification](#metadata-source-identification))
...
### How-to View Frame Metadata[​](#how-to-view-frame-metadata "Direct link to How-to View Frame Metadata")
...
### Supporting Non-SEI Metadata for Web[​](#supporting-non-sei-metadata-for-web "Direct link to Supporting Non-SEI Metadata for Web")
...
#### Publishing metadata[​](#publishing-metadata "Direct link to Publishing metadata")
...
#### Viewing metadata[​](#viewing-metadata "Direct link to Viewing metadata")
...
### Supporting Non-SEI Metadata for Native Platforms[​](#supporting-non-sei-metadata-for-native-platforms "Direct link to Supporting Non-SEI Metadata for Native Platforms")

Using the [Native SDK](/documentation/pr-preview/pr-690/millicast/playback/players-sdks.md) you can embed metadata with the frame. The way this metadata is embedded allows playback video players to be backward compatible even if they are unable to read and display the metadata.
...
#### Enable frame transformer[​](#enable-frame-transformer "Direct link to Enable frame transformer")
...
#### Listen for transformable frame callback[​](#listen-for-transformable-frame-callback "Direct link to Listen for transformable frame callback")
...
### Missing Metadata in Chrome[​](#missing-metadata-in-chrome "Direct link to Missing Metadata in Chrome")
