...
## 1.8.x to 2.x[​](#18x-to-2x "Direct link to 1.8.x to 2.x")

Below you'll find examples for migrating your applications from [v1.8.9](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.9) to [v2.0.0](https://github.com/millicast/millicast-native-sdk/releases/tag/v2.0.0) of the [iOS](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/ios/sdk.md) SDK.

> ***NOTE:*** Publisher classes remain unchanged and do not require any migration.

## Subscribing Single Source Streams[​](#subscribing-single-source-streams "Direct link to Subscribing Single Source Streams")
...
## Subscribing Multi-View Streams[​](#subscribing-multi-view-streams "Direct link to Subscribing Multi-View Streams")
...
### Some key differences in track management[​](#some-key-differences-in-track-management "Direct link to Some key differences in track management")
...
## Initialising Video Views[​](#initialising-video-views "Direct link to Initialising Video Views")
...
## Querying Video Size and Notifying Video Size changes[​](#querying-video-size-and-notifying-video-size-changes "Direct link to Querying Video Size and Notifying Video Size changes")
...
## Changelog Overview[​](#changelog-overview "Direct link to Changelog Overview")
