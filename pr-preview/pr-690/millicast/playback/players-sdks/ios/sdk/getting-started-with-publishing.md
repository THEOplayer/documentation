...
## 1. Capture audio and video[​](#1-capture-audio-and-video "Direct link to 1. Capture audio and video")
...
## 2. Publish a stream[​](#2-publish-a-stream "Direct link to 2. Publish a stream")

### 2.1 Instantiate a publisher[​](#21-instantiate-a-publisher "Direct link to 2.1 Instantiate a publisher")
...
### 2.2 Set publisher credentials[​](#22-set-publisher-credentials "Direct link to 2.2 Set publisher credentials")
...
### 2.3 Add video and audio tracks to the publisher[​](#23-add-video-and-audio-tracks-to-the-publisher "Direct link to 2.3 Add video and audio tracks to the publisher")
...
### 2.4 Configure publishing options[​](#24-configure-publishing-options "Direct link to 2.4 Configure publishing options")
...
### 2.5 Publish your stream[​](#25-publish-your-stream "Direct link to 2.5 Publish your stream")
...
## 3. Observe state changes[​](#3-observe-state-changes "Direct link to 3. Observe state changes")
...
### 3.1 Connection state to the Millicast service[​](#31-connection-state-to-the-millicast-service "Direct link to 3.1 Connection state to the Millicast service")
...
### 3.2 Publishing state[​](#32-publishing-state "Direct link to 3.2 Publishing state")
...
### 3.3 Viewers of your stream[​](#33-viewers-of-your-stream "Direct link to 3.3 Viewers of your stream")

Listen to the viewer activity events of your stream using [activity()](https://millicast.github.io/doc/latest/apple/documentation/millicastsdk/mcpublisher/activity) or the combine publisher [activityPublisher](https://millicast.github.io/doc/latest/apple/documentation/millicastsdk/mcpublisher/activitypublisher). This event can also be listen from the [publisherDidReceiveFirstViewerActive(\_:)](https://millicast.github.io/doc/latest/apple/documentation/millicastsdk/mcpublisherdelegate/publisherdidreceivefirstvieweractive\(_:\)) and [publisherDidReceiveLastViewerInactive(\_:)](https://millicast.github.io/doc/latest/apple/documentation/millicastsdk/mcpublisherdelegate/publisherdidreceivelastviewerinactive\(_:\)) delegate methods defined in [MCPublisherDelegate](https://millicast.github.io/doc/latest/apple/documentation/millicastsdk/mcpublisherdelegate)
...
## 4. Collect WebRTC statistics[​](#4-collect-webrtc-statistics "Direct link to 4. Collect WebRTC statistics")
...
## 5. Disable automatic reconnection[​](#5-disable-automatic-reconnection "Direct link to 5. Disable automatic reconnection")
...
## 6. Error handling[​](#6-error-handling "Direct link to 6. Error handling")
...
## 7. Stop publishing[​](#7-stop-publishing "Direct link to 7. Stop publishing")
