...
OptiView Real-time Streaming APIs support using the [Web SDK](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/web/sdk.md) with React Native WebRTC to support creating iOS, Android, AndroidTV, and tvOS applications.

<!-- -->

## [![](/documentation/pr-preview/pr-690/img/github.svg)![](/documentation/pr-preview/pr-690/img/github_dark.svg)GitHub](https://github.com/millicast/millicast-sdk/releases)

[Access the Web SDK releases](https://github.com/millicast/millicast-sdk/releases)

## [📖Reference](https://millicast.github.io/millicast-sdk/)

[Class and object reference](https://millicast.github.io/millicast-sdk/)

## [📱Sample app](https://github.com/millicast/streaming-sdk-react-native-getting-started)

[Test features and capabilities](https://github.com/millicast/streaming-sdk-react-native-getting-started)

## React Native SDK[​](#react-native-sdk "Direct link to React Native SDK")
...
Before we start, you can find more information in the [Web SDK Documentation](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/web/sdk.md), which contains more examples and descriptions of the available modules.

### Initializing your project[​](#initializing-your-project "Direct link to Initializing your project")
...
```bash
npm install react-native-webrtc @millicast/sdk
...
```bash
yarn add react-native-webrtc @millicast/sdk
...
### Application setup[​](#application-setup "Direct link to Application setup")
...
#### iOS permissions[​](#ios-permissions "Direct link to iOS permissions")
...
#### Android permissions[​](#android-permissions "Direct link to Android permissions")
...
### Gradle v3.5[​](#gradle-v35 "Direct link to Gradle v3.5")
...
Prior to using the viewer and publisher examples, you have to get your tokens. Use the [this guide](/documentation/pr-preview/pr-690/millicast/managing-your-tokens.md) to manage your OptiView Real-time Streaming tokens.

In your App.js file, decide whether you want to test a viewer or publisher based on your needs.

#### Viewer example[​](#viewer-example "Direct link to Viewer example")
...
class MillicastWidget extends React.Component {
  ...
  async subscribe(streamName, accountID) {
    ...
    const millicastView = new MillicastView(undefined, tokenGenerator, null);
...
#### Publisher example[​](#publisher-example "Direct link to Publisher example")
  ...
  constructor(props) {
    ...
    start = async () => {
        ...
        if (!this.state.mediaStream) {
            try {
                let s = await mediaDevices.getUserMedia({ video: true, audio: true });
                this.setState({
                    mediaStream: s
                });
    ...
    async publish(streamName, token) {
        ...
        // Create a new instance
        this.millicastPublish = new Publish(undefined, tokenGenerator);
...
### Build and run the application[​](#build-and-run-the-application "Direct link to Build and run the application")
...
### Windows troubleshooting[​](#windows-troubleshooting "Direct link to Windows troubleshooting")
