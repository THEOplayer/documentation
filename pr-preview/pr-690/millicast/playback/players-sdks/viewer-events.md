...
## List of events[​](#list-of-events "Direct link to List of events")
...
* `layers`: When streaming with [Simulcast](/documentation/pr-preview/pr-690/millicast/distribution/using-webrtc-simulcast.md), this event fires when there is an update of the state of the layers in the live stream.
* `vad`: Fires when the live stream is mixing and layering audio with [Audio Multiplexing](/documentation/pr-preview/pr-690/millicast/playback/audio-multiplexing.md).
...
Not familiar with our SDKs?

Learn more about the OptiView Real-time streaming SDKs by following the [Getting Started](/documentation/pr-preview/pr-690/millicast/getting-started/creating-real-time-streaming-web-app.md) guide or by learning about our [Client SDKs](/documentation/pr-preview/pr-690/millicast/playback/players-sdks.md).

To use or "listen" for these events, you first must authenticate and connect to the OptiView Real-time CDN using one of our [Client SDKs](/documentation/pr-preview/pr-690/millicast/playback/players-sdks.md). When calling the `connect` function you can include a list of all events to listen for:
