...
## 1. Add SDK as Gradle Dependency[​](#1-add-sdk-as-gradle-dependency "Direct link to 1. Add SDK as Gradle Dependency")
...
## 3. Capture audio and video[​](#3-capture-audio-and-video "Direct link to 3. Capture audio and video")
...
## 4. Publish a stream[​](#4-publish-a-stream "Direct link to 4. Publish a stream")

### 4.1 Instantiate a publisher[​](#41-instantiate-a-publisher "Direct link to 4.1 Instantiate a publisher")
...
### 4.2 Set publisher credentials[​](#42-set-publisher-credentials "Direct link to 4.2 Set publisher credentials")
...
### 4.3 Add video and audio tracks to the publisher[​](#43-add-video-and-audio-tracks-to-the-publisher "Direct link to 4.3 Add video and audio tracks to the publisher")
...
### 4.4 Configure publishing options[​](#44-configure-publishing-options "Direct link to 4.4 Configure publishing options")
...
### 4.5 Publish your stream[​](#45-publish-your-stream "Direct link to 4.5 Publish your stream")
...
## 5. Observe state changes[​](#5-observe-state-changes "Direct link to 5. Observe state changes")
...
### 5.1 Connection state to the Millicast service[​](#51-connection-state-to-the-millicast-service "Direct link to 5.1 Connection state to the Millicast service")
...
### 5.2 Viewers of your stream[​](#52-viewers-of-your-stream "Direct link to 5.2 Viewers of your stream")
...
## 7. Disable automatic reconnection[​](#7-disable-automatic-reconnection "Direct link to 7. Disable automatic reconnection")
...
## 8. Error handling[​](#8-error-handling "Direct link to 8. Error handling")
...
## 9. Close the stream[​](#9-close-the-stream "Direct link to 9. Close the stream")
