...
## 1. Add a Centralized PipViewModel[​](#1-add-a-centralized-pipviewmodel "Direct link to 1. Add a Centralized PipViewModel")
...
### 2. Enable/Disable PiP mode from different screens[​](#2-enabledisable-pip-mode-from-different-screens "Direct link to 2. Enable/Disable PiP mode from different screens")
...
### 3. Add a utility function to enable PiP mode[​](#3-add-a-utility-function-to-enable-pip-mode "Direct link to 3. Add a utility function to enable PiP mode")
...
### 4. Add a utility function to check if the app is in PiP mode[​](#4-add-a-utility-function-to-check-if-the-app-is-in-pip-mode "Direct link to 4. Add a utility function to check if the app is in PiP mode")
...
### 5. Setup your Activity to use PiP[​](#5-setup-your-activity-to-use-pip "Direct link to 5. Setup your Activity to use PiP")
...
### 6. Use the utility functions in your root composable[​](#6-use-the-utility-functions-in-your-root-composable "Direct link to 6. Use the utility functions in your root composable")
