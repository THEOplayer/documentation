...
## Codecs[​](#codecs "Direct link to Codecs")

See the [Broadcast](/documentation/pr-preview/pr-690/millicast/broadcast.md) streaming guide for additional details about supported audio and video codecs.

## Network Ports[​](#network-ports "Direct link to Network Ports")
...
### IP Addresses with Standard Publishing[​](#ip-addresses-with-standard-publishing "Direct link to IP Addresses with Standard Publishing")
...
You can access a programmatic list of our regions and their abilities with the [Get Clusters](/documentation/pr-preview/pr-690/millicast/api/cluster-get-clusters-info.md) API.
...
### IP Addresses for STUN/TURN[​](#ip-addresses-for-stunturn "Direct link to IP Addresses for STUN/TURN")

See our documentation page for [STUN and TURN](/documentation/pr-preview/pr-690/millicast/platform-requirements/stun-and-turn-service.md) for IP address ranges.

### IP Addresses with Cloud Transcoders[​](#ip-addresses-with-cloud-transcoders "Direct link to IP Addresses with Cloud Transcoders")

For customers using our real-time cloud transcoder, a static IP address is provisioned for the duration that the machine is provisioned and in use. The IP address can be found in the Transcoding section of the dashboard or with the [Cloud Transcoder](/documentation/pr-preview/pr-690/millicast/distribution/cloud-transcoder.md). If the instance is restarted it is possible it will use a new IP address. A DNS name is also provided for these instances.

## Restricted Territories[​](#restricted-territories "Direct link to Restricted Territories")
