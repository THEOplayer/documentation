...
## 2024-08-21 | Native SDK [2.0.0](https://github.com/millicast/millicast-native-sdk/releases/tag/v2.0.0)[​](#2024-08-21--native-sdk-200 "Direct link to 2024-08-21--native-sdk-200")
...
* [Migration Guide for Android SDK](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/android/sdk/sdk-migration-guide.md)

### 🆕<!-- --> Viewer and Track Management[​](#new-viewer-and-track-management "Direct link to new-viewer-and-track-management")

Changing the APIs related to projecting sources on the subscriber. Now, subscribers<br /><!-- -->do not need to manage WebRTC remote tracks, project sources and manage their state.<br /><!-- -->Subscribers now receive a notion of a remote track, which can either be audio/video<br /><!-- -->and manage their own state. These tracks can be enabled with a renderer/view, query<br /><!-- -->the source they belong to, receive events such as Activity status (Inactive/Active),<br /><!-- -->layers (for video), etc.
...
### 🆕<!-- --> Asynchronous Model[​](#new-asynchronous-model "Direct link to new-asynchronous-model")
...
* [Getting Started with Subscribing](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/android/sdk/getting-started-with-subscribing.md)
* [Getting Started with Publishing](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/android/sdk/getting-started-with-publishing.md)
...
* [Getting Started with Subscribing](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/desktop/getting-started-with-subscribing.md)
* [Getting Started with Publishing](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/desktop/getting-started-with-publishing.md)

### 🆕<!-- --> Playout Delay[​](#new-playout-delay "Direct link to new-playout-delay")
...
### 🆒 Logging and Stats[​](#-logging-and-stats "Direct link to 🆒 Logging and Stats")

Improve logger so that when applications provide their own logging callback when using the set\_logger function default logging to stderr will be disabled (unless force enabled by app):
...
* Exposed stats information for: [freeze\_count](https://www.w3.org/TR/webrtc-stats/#dom-rtcinboundrtpstreamstats-freezecount) , [pause\_count](https://www.w3.org/TR/webrtc-stats/#dom-rtcinboundrtpstreamstats-pausecount), [total\_freezes\_duration](https://www.w3.org/TR/webrtc-stats/#dom-rtcinboundrtpstreamstats-totalfreezesduration) , and [total\_pauses\_duration](https://www.w3.org/TR/webrtc-stats/#dom-rtcinboundrtpstreamstats-totalpausesduration).
...
### Additional Updates[​](#additional-updates "Direct link to Additional Updates")
...
* Obj-C enums are changed to utilise NS\_ENUM rather than being global C based
  <br />
  <!-- -->
  enums
...
* MCIosVideoRenderer has been renamed to MCAcceleratedVideoRenderer and the corresponding
  <br />
  <!-- -->
  header files ios\_renderer.h to accelerated\_video\_renderer.h

## 2024-04-25 | Native SDK [1.8.4](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.4)[​](#2024-04-25--native-sdk-184 "Direct link to 2024-04-25--native-sdk-184")
...
## 2024-04-18 - [1.7.5](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.7.5) and [1.8.3](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.3)[​](#2024-04-18---175-and-183 "Direct link to 2024-04-18---175-and-183")
...
## 2024-04-12 - [1.8.2](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.2)[​](#2024-04-12---182 "Direct link to 2024-04-12---182")
...
## 2024-04-04 - [1.8.1](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.1)[​](#2024-04-04---181 "Direct link to 2024-04-04---181")
...
## 2024-03-20 - [1.8.0](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.0)[​](#2024-03-20---180 "Direct link to 2024-03-20---180")

#### Features[​](#features-1 "Direct link to Features")

* Introduced a new asynchronous API for all Apple platforms, such as iOS, tvOS, and macOS. This change impacts the way of publishing streams. For more information, see the updated [Getting Started](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/ios/sdk.md) document.
...
##### Apple platforms[​](#apple-platforms "Direct link to Apple platforms")

The new asynchronous API replaced the previous synchronous one, which impacts the way of publishing streams. For more information, see the updated [Getting Started](/documentation/pr-preview/pr-690/millicast/playback/players-sdks/ios/sdk.md) document.

***

## 2024-03-18 - [1.8.0-beta.1](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.0-beta.1)[​](#2024-03-18---180-beta1 "Direct link to 2024-03-18---180-beta1")
...
##### Apple platforms[​](#apple-platforms-1 "Direct link to Apple platforms")

The new asynchronous API replaced the previous synchronous one.

***

## 2024-03-15 - [1.8.0-alpha.2](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.0-alpha.2)[​](#2024-03-15---180-alpha2 "Direct link to 2024-03-15---180-alpha2")
...
##### Objective C/Swift SDK[​](#objective-cswift-sdk "Direct link to Objective C/Swift SDK")

The new asynchronous API replaced the previous synchronous one.

***

## 2024-03-14 - [1.8.0-alpha.1](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.8.0-alpha.1)[​](#2024-03-14---180-alpha1 "Direct link to 2024-03-14---180-alpha1")
...
## 2024-03-14 - [1.7.4](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.7.4)[​](#2024-03-14---174 "Direct link to 2024-03-14---174")
...
## 2024-02-28 - [1.7.3](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.7.3)[​](#2024-02-28---173 "Direct link to 2024-02-28---173")
...
## 2024-02-14 - [1.7.2](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.7.2)[​](#2024-02-14---172 "Direct link to 2024-02-14---172")
...
## 2024-02-09 - [1.7.1](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.7.1)[​](#2024-02-09---171 "Direct link to 2024-02-09---171")
...
## 2024-02-08 - [1.7.0](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.7.0)[​](#2024-02-08---170 "Direct link to 2024-02-08---170")
...
* Improved the [on\_layers](https://millicast.github.io/doc/latest/cpp/structmillicast_1_1_viewer_listener.html#ada345cbb1f379fc37b1a5bbbf13e33e4) event and the respective [ViewerLayerData](https://millicast.github.io/doc/latest/cpp/structmillicast_1_1_viewer_layer_data.html) structure to include fields for the `resolution` of the layer.
...
##### New signature of the on\_layers event[​](#new-signature-of-the-on_layers-event "Direct link to New signature of the on_layers event")

The [on\_layers](https://millicast.github.io/doc/latest/cpp/structmillicast_1_1_viewer_listener.html#ada345cbb1f379fc37b1a5bbbf13e33e4) event has a new signature to accept an array of strings for the inactive layers. The following code presents the current signature of the callback:
...
##### Modified values of the ViewerLayerData structure[​](#modified-values-of-the-viewerlayerdata-structure "Direct link to Modified values of the ViewerLayerData structure")
...
##### Modified Kotlin implementation[​](#modified-kotlin-implementation "Direct link to Modified Kotlin implementation")
...
##### The auto reconnect property removal[​](#the-auto-reconnect-property-removal "Direct link to The auto reconnect property removal")
...
## 2024-02-04 - [1.7.0-beta.1](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.7.0-beta.1)[​](#2024-02-04---170-beta1 "Direct link to 2024-02-04---170-beta1")
...
##### New signature of the on\_layers event[​](#new-signature-of-the-on_layers-event-1 "Direct link to New signature of the on_layers event")
...
##### Modified values of the ViewerLayerData structure[​](#modified-values-of-the-viewerlayerdata-structure-1 "Direct link to Modified values of the ViewerLayerData structure")
...
##### Modified Kotlin implementation[​](#modified-kotlin-implementation-1 "Direct link to Modified Kotlin implementation")
...
##### Setting automatic reconnection[​](#setting-automatic-reconnection "Direct link to Setting automatic reconnection")
...
## 2023-12-15 - [1.6.0](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.6.0)[​](#2023-12-15---160 "Direct link to 2023-12-15---160")
...
## 2023-09-28 - [1.5.2](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.5.2)[​](#2023-09-28---152 "Direct link to 2023-09-28---152")
...
## 2023-07-04 - [1.5.1](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.5.1)[​](#2023-07-04---151 "Direct link to 2023-07-04---151")
...
* The client auto\_reconnect option can now be set to false to disable automatic reconnection.
...
## 2023-03-16 - [1.5.0](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.5.0)[​](#2023-03-16---150 "Direct link to 2023-03-16---150")
...
## 2022-12-09 - [1.4.2](https://github.com/millicast/millicast-native-sdk/releases/tag/v1.4.2)[​](#2022-12-09---142 "Direct link to 2022-12-09---142")
