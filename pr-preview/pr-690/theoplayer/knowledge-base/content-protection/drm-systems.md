...
The major advantage of DRM systems over standard AES-128 Encryption as it is available in HLS streaming is the ability to pass encrypted content to the browser. For more information on AES-128 Encryption in HLS, you can read our article [here](/documentation/pr-preview/pr-690/theoplayer/knowledge-base/content-protection/aes-128-encryption.md).

## MPEG-DASH vs. HLS[​](#mpeg-dash-vs-hls "Direct link to MPEG-DASH vs. HLS")
...
## Common Encryption[​](#common-encryption "Direct link to Common Encryption")
...
## Licensing Servers[​](#licensing-servers "Direct link to Licensing Servers")
...
## Multi-DRM Solutions[​](#multi-drm-solutions "Direct link to Multi-DRM Solutions")
