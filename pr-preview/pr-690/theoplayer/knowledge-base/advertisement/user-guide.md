...
### An overview of THEOplayer's Advertisement tools[​](#overview-advertisement-tools "Direct link to An overview of THEOplayer's Advertisement tools")
...
#### Digital Video Ad Serving Template (VAST)[​](#digital-video-ad-serving-template-vast "Direct link to Digital Video Ad Serving Template (VAST)")
...
#### Digital Video Multiple Ad Playlist (VMAP)[​](#digital-video-multiple-ad-playlist-vmap "Direct link to Digital Video Multiple Ad Playlist (VMAP)")
...
#### Digital Video Player-Ad Interface Definition (VPAID)[​](#digital-video-player-ad-interface-definition-vpaid "Direct link to Digital Video Player-Ad Interface Definition (VPAID)")
...
#### Adblock detection[​](#adblock-detection "Direct link to Adblock detection")
...
### An overview of THEOplayer's different ad types[​](#an-overview-of-theoplayers-different-ad-types "Direct link to An overview of THEOplayer's different ad types")
...
#### Linear Ads[​](#linear-ads "Direct link to Linear Ads")
...
#### Non-linear Ads (overlays)[​](#non-linear-ads-overlays "Direct link to Non-linear Ads (overlays)")
...
#### Companion Ads[​](#companion-ads "Direct link to Companion Ads")
...
## Ad Integrations[​](#ad-integrations "Direct link to Ad Integrations")
...
### Client-Side Ad Insertion (CSAI)[​](#client-side-ad-insertion-csai "Direct link to Client-Side Ad Insertion (CSAI)")
...
#### THEOplayer[​](#theoplayer "Direct link to THEOplayer")
...
* [Ads Reference API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Ad.html)

* [How to set up VAST and VMAP ads](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/how-to-set-up-vast-and-vmap.md): this how-to guide contains information regarding this integration, including how to use this integration, requirements (if any) and code samples.

#### Google IMA[​](#google-ima "Direct link to Google IMA")

Set the `integration` property to `'google-ima'` to use the Google IMA integration. More information can be found at:

* [Reference API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/IMAAdDescription.html)
* [Google IMA](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/google-ima.md): this how-to guide contains information regarding this integration, including how to use this integration, requirements (if any) and code samples.

#### SpotX[​](#spotx "Direct link to SpotX")

Set the `integration property` to `'spotx'` to configure SpotX ads. More information can be found at:

* [Reference API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/SpotXAdDescription.html)
* [SpotX](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/spotx.md): this how-to guide contains more information regarding this integration, including how to use this integration, requirements (if any) and code samples.

#### FreeWheel[​](#freewheel "Direct link to FreeWheel")
...
* [Reference API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/FreeWheelAdDescription.html)
* [FreeWheel](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/freewheel.md): this how-to guide contains more information regarding this integration, including how to use this integration, requirements (if any) and code samples.

### Server Side Ad Insertion (SSAI)[​](#server-side-ad-insertion-ssai "Direct link to Server Side Ad Insertion (SSAI)")
...
#### Google Dynamic Ad Insertion (DAI)[​](#google-dynamic-ad-insertion-dai "Direct link to Google Dynamic Ad Insertion (DAI)")

To use the Google DAI integration you have to set the `integration` key to `'google-dai'`.

* [Reference API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/GoogleDAIConfiguration.html)

#### Yospace[​](#yospace "Direct link to Yospace")

To use the Yospace integration you have to set the `integration` key to `'yospace'`.

* [Reference API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Yospace.html)
* [Yospace](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/yospace.md): this how-to guide contains more information regarding this integration, including how to use this integration, requirements (if any) and code samples.

#### Verizon Media[​](#verizon-media "Direct link to Verizon Media")

To use the Verizon Media integration you have to set the `integration` key to `'verizon-media'`.

You can refer to [our section on Verizon Media](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/web/uplynk/ads.md) to learn more about SSAI with Verizon Media.

#### MediaTailor[​](#mediatailor "Direct link to MediaTailor")

To use the MediaTailor integration you have to set the `integration` key to `'mediatailor'`.

You can refer to [our MediaTailor guide](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/mediatailor.md) to learn more about SSAI with MediaTailor.

## Ad Configuration[​](#ad-configuration "Direct link to Ad Configuration")

### Basic Ad Configuration[​](#basic-ad-config "Direct link to Basic Ad Configuration")
...
#### Adding and configuring VAST ads[​](#adding-configuring-vast-ads "Direct link to Adding and configuring VAST ads")
...
#### Control the ads shown alongside your content with VMAP[​](#control-the-ads-shown-alongside-your-content-with-vmap "Direct link to Control the ads shown alongside your content with VMAP")
...
#### Adding and configuring interactive VPAID ads[​](#adding-and-configuring-interactive-vpaid-ads "Direct link to Adding and configuring interactive VPAID ads")
...
### Advanced Ad Configuration[​](#advanced-ad-configuration "Direct link to Advanced Ad Configuration")

#### Dynamic Ad Scheduling[​](#dynamic-ad-scheduling "Direct link to Dynamic Ad Scheduling")
...
To dynamically add advertisements, you should use the [`player.ads.schedule(AdDescription)`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Ads.html#schedule) function which will add the given ad file as if it were specified in the initial configuration. The AdDescription - which you will pass as a parameter to the function - is the same object as previously discussed in [Basic Ad Configuration](#basic-ad-config).
...
THEOplayer offers the option to block the player when an adblocker is detected. This can be achieved by setting blockOnAdBlock in the configuration.ads object to true. The player will display a message saying it has detected an ad blocker and that the user will need to turn it off in order to watch the video. A more in-depth code-example can be found at <https://demo.theoplayer.com/adblock-detection>.

The default message that is shown when ad-block is detected is depicted below.

![Adblock detection](/documentation/pr-preview/pr-690/assets/images/adblock-detected-8348d073be3013c7944848c140c8a7ef.png)

## Demos and sample applications[​](#demos-and-sample-applications "Direct link to Demos and sample applications")
