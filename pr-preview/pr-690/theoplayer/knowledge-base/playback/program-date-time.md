...
## API and usage[​](#api-and-usage "Direct link to API and usage")

Once the `EXT-X-PROGRAM-DATE-TIME` information is set in the HLS manifest, reading and setting the current program date time information on a THEOplayer instance is fairly straight forward. Start by [obtaining a reference to the THEOplayer instance](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md):
