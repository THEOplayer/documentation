...
## Getting started with THEOplayer[​](#getting-started-with-theoplayer "Direct link to Getting started with THEOplayer")

The first thing you need is a valid THEOplayer set-up. If you have no experience with setting up our player, we have an excellent [getting started guide](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md). In the following sections, we will assume that you have just created a THEOplayer instance and bound it to the variable 'player'.

## A very basic Web Audio graph[​](#a-very-basic-web-audio-graph "Direct link to A very basic Web Audio graph")
...
## Playing with the audio gain[​](#playing-with-the-audio-gain "Direct link to Playing with the audio gain")
...
## Double audio trouble[​](#double-audio-trouble "Direct link to Double audio trouble")
