...
## Embedded WebVTTs in the HLS playlist[​](#embedded-webvtts-in-the-hls-playlist "Direct link to Embedded WebVTTs in the HLS playlist")
...
### Sideloading WebVTT[​](#sideloading-webvtt "Direct link to Sideloading WebVTT")

[This page](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/texttrack/how-to-insert-subtitles.md) explains how you can insert WebVTT files.

### HTTP Live Streaming Manifest with embedded WebVTT subtitles[​](#http-live-streaming-manifest-with-embedded-webvtt-subtitles "Direct link to HTTP Live Streaming Manifest with embedded WebVTT subtitles")
...
A demo on closed captions and subtitles can be found at <https://demo.theoplayer.com/closed-captions-subtitles>.
