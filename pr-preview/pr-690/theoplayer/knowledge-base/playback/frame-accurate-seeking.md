...
## Calculate current frame[​](#calculate-current-frame "Direct link to Calculate current frame")
...
## Seek to specific frame[​](#seek-to-specific-frame "Direct link to Seek to specific frame")
