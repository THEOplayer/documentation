...
The start and end of the clipping window can be controlled through the [Clip API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Clip.html):
