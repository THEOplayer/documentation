...
## Content Delivery Network Support[​](#content-delivery-network-support "Direct link to Content Delivery Network Support")
...
## Enabling CORS on Wowza Media Server[​](#enabling-cors-on-wowza-media-server "Direct link to Enabling CORS on Wowza Media Server")

Open the relevant (VOD, Live, ...) Wowza Application.xml configuration files.<br /><!-- -->Go to the `HTTPStreamer / Properties` container.<br /><!-- -->Add or make sure it contains:
...
## Enabling CORS on Adobe Flash Media Server[​](#enabling-cors-on-adobe-flash-media-server "Direct link to Enabling CORS on Adobe Flash Media Server")
