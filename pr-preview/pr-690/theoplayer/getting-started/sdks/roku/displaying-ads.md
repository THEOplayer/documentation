...
* Include the RAF advertising library in your application's manifest file by adding this line: `bs_libs_required=roku_ads_lib`
* To support Google DAI, include the Google IMA library as well by adding `googleima3` after the RAF ads library: `bs_libs_required=roku_ads_lib,googleima3`

## Client-side Ad Insertion[​](#client-side-ad-insertion "Direct link to Client-side Ad Insertion")
...
### Create your ad descriptions[​](#create-your-ad-descriptions "Direct link to Create your ad descriptions")
...
#### Mixing VAST and VMAP Ads[​](#mixing-vast-and-vmap-ads "Direct link to Mixing VAST and VMAP Ads")
...
### Listen for ad events[​](#listen-for-ad-events "Direct link to Listen for ad events")

To detect events emitted for the ads, you can call the `addEventListener` method on the Ads API. You can see the list of ad events on [the API reference page](/documentation/pr-preview/pr-690/theoplayer/api-reference/roku.md#ads-api). Note that the method used for the listener needs to be exposed through the interface of the node that owns the listener function.
...
Also, if you just want to see whether ads are playing or not, observe the `playing` field on the Ads API. You can see the other fields available on [the API reference page](/documentation/pr-preview/pr-690/theoplayer/api-reference/roku.md#ads-api).
...
### Monitoring RAF[​](#monitoring-raf "Direct link to Monitoring RAF")
...
### Scheduling Ads at Runtime[​](#scheduling-ads-at-runtime "Direct link to Scheduling Ads at Runtime")
...
## Server-side Ad Insertion[​](#server-side-ad-insertion "Direct link to Server-side Ad Insertion")
...
### Google IMA Streams[​](#google-ima-streams "Direct link to Google IMA Streams")
...
### THEOlive and THEOads[​](#theolive-and-theoads "Direct link to THEOlive and THEOads")
...
### Listening for Ad Events[​](#listening-for-ad-events "Direct link to Listening for Ad Events")
