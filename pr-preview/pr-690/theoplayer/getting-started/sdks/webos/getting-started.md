...
You may also find the [Getting Started on Web](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md) guide useful.
...
## Setting up the physical device[​](#setting-up-the-physical-device "Direct link to Setting up the physical device")
...
### Make a connection[​](#make-a-connection "Direct link to Make a connection")
...
Default name for the created package is *webos.theo\_1.0.0\_all.ipk*, *tv* is the device name that was given when setting up the device in the previous step.
