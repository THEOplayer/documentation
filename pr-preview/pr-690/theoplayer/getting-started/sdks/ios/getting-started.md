...
### THEOplayer license[​](#theoplayer-license "Direct link to THEOplayer license")

THEOplayer requires a valid THEOplayer license to be configured in order to access the SDK APIs (with the exception of some whitelisted sources hosted by our CDN). Request your license via <https://portal.theoplayer.com>.
...
It's considered good practice to run `pod repo update` before adding new pods to your Podfile. This will help find newly added pods by updating the list of references to the public spec repos. If you just installed Cocoapods or are already up-to-date, then this step can be skipped.
...
![](/documentation/pr-preview/pr-690/assets/images/ios-getting-started-1-892e63410e915e1e73824a33fa3038de.png)
...
![](/documentation/pr-preview/pr-690/assets/images/ios-getting-started-3-af7cd19fa611660e32ef5dc2b71957b1.png)
...
### Adding the THEOplayer license[​](#adding-the-theoplayer-license "Direct link to Adding the THEOplayer license")
...
![](/documentation/pr-preview/pr-690/assets/images/ios-getting-started-2-773df42c859c8472dbeda2b02ef975c1.png)

### Importing the framework[​](#importing-the-framework "Direct link to Importing the framework")
...
### Setting up the player[​](#setting-up-the-player "Direct link to Setting up the player")
...
### Displaying the player[​](#displaying-the-player "Direct link to Displaying the player")
...
### Adding a source for playback[​](#adding-a-source-for-playback "Direct link to Adding a source for playback")
...
### Basic playback controls[​](#basic-playback-controls "Direct link to Basic playback controls")

#### Starting playback[​](#starting-playback "Direct link to Starting playback")
...
#### Pausing or stopping playback[​](#pausing-or-stopping-playback "Direct link to Pausing or stopping playback")
...
#### Seeking forward or backward in time[​](#seeking-forward-or-backward-in-time "Direct link to Seeking forward or backward in time")
...
#### Seeking forward relatively to current time[​](#seeking-forward-relatively-to-current-time "Direct link to Seeking forward relatively to current time")
...
### Attaching player event listeners[​](#attaching-player-event-listeners "Direct link to Attaching player event listeners")
...
* [THEOplayer iOS SDK API reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/index.html)
