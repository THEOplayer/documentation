...
This article will guide you through updating to THEOplayer iOS/tvOS SDK version 11 (from version 10), and the changes needed in your code.
...
We also recommend adding [our public self-hosted CocoaPods spec repo](https://github.com/THEOplayer/cocoapods-specs) as a source, instead of using the default CocoaPods spec repo. [See below for details.](#self-hosted-spec-repo-for-cocoapods)
...
If you're using one of [our connectors](/documentation/pr-preview/pr-690/theoplayer/connectors/ios.md), make sure to update them to the latest version too to ensure proper support for THEOplayer version 11.

## Update deployment target to 15.0 or higher[​](#update-deployment-target-to-150-or-higher "Direct link to Update deployment target to 15.0 or higher")
...
![Screenshot of Xcode project settings](/documentation/pr-preview/pr-690/assets/images/xcode-deployment-target-25c3050c19e8c7180e197d8d66e51d89.png)

## Builds generated with Xcode 26[​](#builds-generated-with-xcode-26 "Direct link to Builds generated with Xcode 26")
...
## Self-hosted spec repo for CocoaPods[​](#self-hosted-spec-repo-for-cocoapods "Direct link to Self-hosted spec repo for CocoaPods")

Starting with version 11, the THEOplayer iOS SDK will be released in a public self-hosted spec repo at <https://github.com/THEOplayer/cocoapods-specs>. This decision comes as a solution to [the planned read-only change to the CocoaPods public spec repo at the end of 2026](https://blog.cocoapods.org/CocoaPods-Specs-Repo/).
...
## New Chromecast pipeline[​](#new-chromecast-pipeline "Direct link to New Chromecast pipeline")
...
In version 11, the old pipeline is still enabled by default. However, we highly recommend customers switch to the new pipeline by setting `enableExperimentalPipeline` to `true` in [`CastConfiguration`](theoplayer/v11/api-reference/ios/Classes/CastConfiguration.html).
