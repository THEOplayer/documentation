...
For more information on how to fetch the dependencies to your Xcode project, [please check the getting started guide.](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/ios/getting-started.md)
