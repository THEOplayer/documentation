...
Starting from version 2.79.0, you can make use of License as a Configuration with Web SDK. This allows you to reuse the same library when changing your license. It also allows you to make use of our NPM modules instead of using the THEOplayer zip-file. In order to use this functionality, there is a change needed in your THEOplayer integration. You can read more about this [here](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/license/introduction.md).

We highly recommend using this new license system due to all the advantages it brings.

## Update Web SDK[​](#update-web-sdk "Direct link to Update Web SDK")

Typically, next to using [NPM](https://www.npmjs.com/package/theoplayer), you grab a CDN URL or a downloadable ZIP file through <https://portal.theoplayer.com>, which gives you access to URLs like those below:
...
![Update SDK](/documentation/pr-preview/pr-690/assets/images/update-sdk-5f00e7ff6ef3854952cf07f2562b3d08.png)

### 1. Cloud-hosted[​](#1-cloud-hosted "Direct link to 1. Cloud-hosted")
...
![Save \&amp; Publish](/documentation/pr-preview/pr-690/assets/images/republish-7d7f211f07d91032ae93414a82528d26.png)

### 2. Self-hosted[​](#2-self-hosted "Direct link to 2. Self-hosted")
...
## Other SDKs[​](#other-sdks "Direct link to Other SDKs")
