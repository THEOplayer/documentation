...
## List of Hotkeys[​](#list-of-hotkeys "Direct link to List of Hotkeys")
...
### 1. THEOplayer-wrapper[​](#1-theoplayer-wrapper "Direct link to 1. THEOplayer-wrapper")
...
1. Disable default browser hotkeys and overwrite them with our custom player hotkeys.
...
### 2. JavaScript[​](#2-javascript "Direct link to 2. JavaScript")
...
### 2.1 Disabling Default browser hotkeys[​](#21-disabling-default-browser-hotkeys "Direct link to 2.1 Disabling Default browser hotkeys")

#### preventStandardHotKeyActions()[​](#preventstandardhotkeyactions "Direct link to preventStandardHotKeyActions()")
...
### 2.2 Pause and Play[​](#22-pause-and-play "Direct link to 2.2 Pause and Play")

#### togglePlay()[​](#toggleplay "Direct link to togglePlay()")
...
### 2.3 Rewinding and Skipping[​](#23-rewinding-and-skipping "Direct link to 2.3 Rewinding and Skipping")
...
### 2.4 Volume Settings[​](#24-volume-settings "Direct link to 2.4 Volume Settings")

#### increaseVolume()[​](#increasevolume "Direct link to increaseVolume()")
...
#### decreaseVolume():[​](#decreasevolume "Direct link to decreaseVolume():")
...
### 2.5 Toggle Fullscreen[​](#25-toggle-fullscreen "Direct link to 2.5 Toggle Fullscreen")

#### toggleFullScreen()[​](#togglefullscreen "Direct link to toggleFullScreen()")
...
### 2.6 Toggle Mute[​](#26-toggle-mute "Direct link to 2.6 Toggle Mute")

#### toggleMute()[​](#togglemute "Direct link to toggleMute()")
...
### 2.7 KeyPressed Event[​](#27-keypressed-event "Direct link to 2.7 KeyPressed Event")

#### getPressedKey()[​](#getpressedkey "Direct link to getPressedKey()")
...
### 2.8 Enable hotkeys with focus[​](#28-enable-hotkeys-with-focus "Direct link to 2.8 Enable hotkeys with focus")

#### playerFocused():[​](#playerfocused "Direct link to playerFocused():")
...
### 2.9 Enable Hotkeys on mouseEnter[​](#29-enable-hotkeys-on-mouseenter "Direct link to 2.9 Enable Hotkeys on mouseEnter")
...
#### mouseInPlayer()[​](#mouseinplayer "Direct link to mouseInPlayer()")
...
#### mouseOutPlayer()[​](#mouseoutplayer "Direct link to mouseOutPlayer()")
...
### 3.0 Enabling the Hotkeys[​](#30-enabling-the-hotkeys "Direct link to 3.0 Enabling the Hotkeys")

#### enableShortcuts()[​](#enableshortcuts "Direct link to enableShortcuts()")
...
## Full JavaScript Code Example[​](#full-javascript-code-example "Direct link to Full JavaScript Code Example")
