...
## Customizing the quality selector and labels[​](#customizing-the-quality-selector-and-labels "Direct link to Customizing the quality selector and labels")

This example explains how to customize quality selection & labels for MP4 assets.

##### Web SDK[​](#web-sdk "Direct link to Web SDK")

First of all, we need to [set up the player](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md). Then, the different MP4 qualities of the same asset need to be stated, along with the corresponding resolutions:
...
Android SDK does not have a built-in UI. It also does not support JavaScript injection. However, you can implement a similar custom quality selection menu using [Open Video UI for Android](/documentation/pr-preview/pr-690/open-video-ui/android.md) and following the same logic for Web SDK.
...
![Customize quality selection](/documentation/pr-preview/pr-690/assets/images/customize-quality-selection-e65dfce41a9308baad45748bb40589d8.png "Customize quality selection")
