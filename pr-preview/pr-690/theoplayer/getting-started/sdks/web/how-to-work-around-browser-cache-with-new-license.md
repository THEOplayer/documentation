...
## Ways to force the browser to update[​](#ways-to-force-the-browser-to-update "Direct link to Ways to force the browser to update")

### Change the file path[​](#change-the-file-path "Direct link to Change the file path")
...
### Add a variable at the end of the file[​](#add-a-variable-at-the-end-of-the-file "Direct link to Add a variable at the end of the file")
...
* [License](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/license/introduction.md)
* [How to reduce data usage on mobile devices on mobile web](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/mediatrack/how-to-reduce-data-usage-on-mobile-devices.md)
