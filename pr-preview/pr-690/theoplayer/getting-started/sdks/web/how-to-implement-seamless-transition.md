...
The result on your page can also be improved implementing [cache](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Cache.html) for your videos.
