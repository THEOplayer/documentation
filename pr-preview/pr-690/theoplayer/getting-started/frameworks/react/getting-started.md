...
## Creating and using a component[​](#creating-and-using-a-component "Direct link to Creating and using a component")

### `src/THEOplayerWrapper.js`[​](#srctheoplayerwrapperjs "Direct link to srctheoplayerwrapperjs")
...
### `src/App.js`[​](#srcappjs "Direct link to srcappjs")
...
### Getting a license[​](#getting-a-license "Direct link to Getting a license")
