...
## Breaking API changes[​](#breaking-api-changes "Direct link to Breaking API changes")
...
The breaking changes for the native Web SDK are listed in the v11 [changelog](https://optiview.dolby.com/docs/theoplayer/changelog/#-breaking-changes), none of which impact the React Native SDK on Web.
