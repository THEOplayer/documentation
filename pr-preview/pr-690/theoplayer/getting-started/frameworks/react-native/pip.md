...
### Transitioning to PiP automatically[​](#transitioning-to-pip-automatically "Direct link to Transitioning to PiP automatically")
...
### Using presentationMode[​](#using-presentationmode "Direct link to Using presentationMode")
...
### Listening for presentationMode changes[​](#listening-for-presentationmode-changes "Direct link to Listening for presentationMode changes")
...
### Enabling PiP support[​](#enabling-pip-support "Direct link to Enabling PiP support")
...
### Enabling early transitioning to PiP event[​](#enabling-early-transitioning-to-pip-event "Direct link to Enabling early transitioning to PiP event")

You might want to enable [transitioning to PiP](https://developer.android.com/reference/android/app/PictureInPictureUiState#isTransitioningToPip\(\)) event for Android 15+ (API 35+). To enable it make sure that the compile SDK version is set to 35 in your build.gradle `compileSdkVersion = 35`. Also the appropriate intent should be sent from the `MainActivity` to let react-native know when the app starts the PiP animation:
...
### PiP controls[​](#pip-controls "Direct link to PiP controls")
...
| ![pip1](/documentation/pr-preview/pr-690/assets/images/pip_android_1-c2cde1b49f69cfe79a441bbaf8cb47ee.png) | ![pip2](/documentation/pr-preview/pr-690/assets/images/pip_android_2-a34aebe9117fe159534751493076b242.png) | ![pip3](/documentation/pr-preview/pr-690/assets/images/pip_android_3-715cef9dba8c741424f9b0f8247bc56d.png) |
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
...
On web platforms, only the "out-of-app" PiP presentation mode is supported, allowing the PiP window to float independently from the browser window on the desktop. The THEOplayer Web SDK refers to this as [native-picture-in-picture](https://www.theoplayer.com/docs/theoplayer/v10/api-reference/web/types/PresentationMode.html) , distinguishing it from the "in-app" floating player window used in picture-in-picture mode. Note that except for the native PiP controls, any user interface defined in React Native will not be shown in the PiP window.
