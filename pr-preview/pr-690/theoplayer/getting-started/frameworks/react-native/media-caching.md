...
### Caching Workflow[​](#caching-workflow "Direct link to Caching Workflow")
...
## Creating a CachingTask[​](#creating-a-cachingtask "Direct link to Creating a CachingTask")
...
## Controlling the CachingTask[​](#controlling-the-cachingtask "Direct link to Controlling the CachingTask")
...
## Listening for Cache events[​](#listening-for-cache-events "Direct link to Listening for Cache events")

Both `MediaCache` and `CachingTask` instances dispatch events to notify about changes and status updates.

### MediaCache events[​](#mediacache-events "Direct link to MediaCache events")
...
### CachingTask events[​](#cachingtask-events "Direct link to CachingTask events")
...
### useCachingTaskList[​](#usecachingtasklist "Direct link to useCachingTaskList")
...
### useCachingTaskProgress and useCachingTaskStatus[​](#usecachingtaskprogress-and-usecachingtaskstatus "Direct link to useCachingTaskProgress and useCachingTaskStatus")
...
## The Example App[​](#the-example-app "Direct link to The Example App")
...
| ![main](/documentation/pr-preview/pr-690/assets/images/media_caching_1-291dc509ba26ee47cc721f8bd89e0e30.png) | ![main](/documentation/pr-preview/pr-690/assets/images/media_caching_2-980927a546367feead24e464ea8aaa0e.png) |
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
