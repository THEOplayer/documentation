...
## 10.12.3[​](#10123 "Direct link to 10.12.3")

* Updated THEOplayer to 10.12.3.

## 10.12.2[​](#10122 "Direct link to 10.12.2")

* Fixed an issue when playing OptiView Live streams (THEOlive) the player did not jump to the live point after a fallback.

## 10.12.1[​](#10121 "Direct link to 10.12.1")

* Updated THEOplayer to 10.12.1.
  <!-- -->
  * For underlying native SDK changes please consult with the [THEOplayer SDK 10.12.1 changelog](https://optiview.dolby.com/docs/theoplayer/changelog/#-10121-20260317)).

## 10.12.0[​](#10120 "Direct link to 10.12.0")
...
## 10.6.1[​](#1061 "Direct link to 10.6.1")
...
## 10.3.0[​](#1030 "Direct link to 10.3.0")

* Updated THEOplayer to 10.3.0.

## 10.0.0[​](#1000 "Direct link to 10.0.0")
...
## 9.11.0[​](#9110 "Direct link to 9.11.0")

* Updated THEOplayer to 9.11.0.

## 9.7.1[​](#971 "Direct link to 9.7.1")
...
## 9.7.0[​](#970 "Direct link to 9.7.0")
...
## 9.3.1[​](#931 "Direct link to 9.3.1")

* Updated THEOplayer to 9.3.1.

## 9.3.0[​](#930 "Direct link to 9.3.0")
...
## 9.2.0[​](#920 "Direct link to 9.2.0")
...
## 9.0.0[​](#900 "Direct link to 9.0.0")
...
## 8.14.0[​](#8140 "Direct link to 8.14.0")

* Updated THEOplayer to 8.14.0.

## 8.13.2[​](#8132 "Direct link to 8.13.2")
...
## 8.11.0[​](#8110 "Direct link to 8.11.0")

* Updated THEOplayer to 8.11.0.
* Added support for Flutter 3.29.0.

## 8.4.0[​](#840 "Direct link to 8.4.0")

* Updated THEOplayer to 8.4.0.

## 8.3.0[​](#830 "Direct link to 8.3.0")
...
## 8.2.0[​](#820 "Direct link to 8.2.0")
...
## 8.0.0[​](#800 "Direct link to 8.0.0")
...
## 7.12.0[​](#7120 "Direct link to 7.12.0")

* Updated THEOplayer to 7.12.0.

## 7.3.1[​](#731 "Direct link to 7.3.1")

* Fixed an issue where playback failed with license error when using Texture-based (SURFACE\_TEXTURE, SURFACE\_PRODUCER) rendering.
* Fixed an issue where player lifecycle callbacks were triggered multiple times when using Texture-based (SURFACE\_TEXTURE, SURFACE\_PRODUCER) rendering.

## 7.3.0[​](#730 "Direct link to 7.3.0")
...
## 7.0.0[​](#700 "Direct link to 7.0.0")

* Updated THEOplayer to 7.0.0.

### Versioning changes[​](#versioning-changes "Direct link to Versioning changes")
