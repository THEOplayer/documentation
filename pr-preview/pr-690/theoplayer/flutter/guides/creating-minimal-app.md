...
### Getting a new project ready[​](#getting-a-new-project-ready "Direct link to Getting a new project ready")
...
### Adding THEOplayer Flutter SDK[​](#adding-theoplayer-flutter-sdk "Direct link to Adding THEOplayer Flutter SDK")

#### Option 1: Adding THEOplayer Flutter SDK as dependency (Recommended)[​](#option-1-adding-theoplayer-flutter-sdk-as-dependency-recommended "Direct link to Option 1: Adding THEOplayer Flutter SDK as dependency (Recommended)")
...
##### Option 1/b (optional) Referencing a custom branch from the official THEOplayer Flutter SDK repository[​](#option-1b-optional-referencing-a-custom-branch-from-the-official-theoplayer-flutter-sdk-repository "Direct link to Option 1/b (optional) Referencing a custom branch from the official THEOplayer Flutter SDK repository")
...
#### Option 2: Adding THEOplayer Flutter SDK as submodule[​](#option-2-adding-theoplayer-flutter-sdk-as-submodule "Direct link to Option 2: Adding THEOplayer Flutter SDK as submodule")

As an alternative, you can add the SDK as a submodule in your git project. This can be useful if you are trying to fork the project to [contribute](https://github.com/THEOplayer/flutter-theoplayer-sdk/blob/main/CONTRIBUTING.md) with us.
...
```bash
$ flutter pub add 'theoplayer:{"path":"./flutter-theoplayer-sdk/flutter_theoplayer_sdk/flutter_theoplayer_sdk"}' --directory .
...
+ theoplayer_sdk_android 1.0.0 from path ../flutter-theoplayer-sdk/flutter_theoplayer_sdk/flutter_theoplayer_sdk_android
+ theoplayer_sdk_ios 1.0.0 from path ../flutter-theoplayer-sdk/flutter_theoplayer_sdk/flutter_theoplayer_sdk_ios
+ theoplayer_sdk_platform_interface 1.0.0 from path ../flutter-theoplayer-sdk/flutter_theoplayer_sdk/flutter_theoplayer_sdk_platform_interface
+ theoplayer_sdk_web 1.0.0 from path ../flutter-theoplayer-sdk/flutter_theoplayer_sdk/flutter_theoplayer_sdk_web
...
+ theoplayer 1.0.0 from path ../flutter-theoplayer-sdk/flutter_theoplayer_sdk/flutter_theoplayer_sdk
...
### Adding THEOplayer to your view hierarchy[​](#adding-theoplayer-to-your-view-hierarchy "Direct link to Adding THEOplayer to your view hierarchy")
...
As noted in the [limitations](/documentation/pr-preview/pr-690/theoplayer/flutter/guides/limitations.md), THEOplayer on Android supports Android 5 (API level 21) and above, so defining this in the `android/app/build.gradle` is necessary:
...
## Getting started on iOS[​](#getting-started-on-ios "Direct link to Getting started on iOS")
...
**The current iteration of the THEOplayer Flutter SDK is not able to automatically pull THEOplayer HTML5 SDK from NPM, so this is now a manual procedure.**

If you have all the files at your hand (`THEOplayer.chromeless.js`, `common` and `transmux` files) copy them into the root of your Web project. (Next to the `index.html`, which is the entry point of your Flutter Web application)
...
### Custom path for THEOplayer WEB SDK[​](#custom-path-for-theoplayer-web-sdk "Direct link to Custom path for THEOplayer WEB SDK")
