...
### 1. State Enum Renamed[​](#1-state-enum-renamed "Direct link to 1. State Enum Renamed")
...
### 2. State Property Renamed[​](#2-state-property-renamed "Direct link to 2. State Property Renamed")
...
### 3. Event Types Updated[​](#3-event-types-updated "Direct link to 3. Event Types Updated")
...
### 4. Event Class Renamed[​](#4-event-class-renamed "Direct link to 4. Event Class Renamed")
...
### 5. Android Source Configuration Simplified[​](#5-android-source-configuration-simplified "Direct link to 5. Android Source Configuration Simplified")
...
### Step 1: Update Import Statements[​](#step-1-update-import-statements "Direct link to Step 1: Update Import Statements")

No changes needed - all imports remain the same.

### Step 2: Update State References[​](#step-2-update-state-references "Direct link to Step 2: Update State References")
...
### Step 3: Update Event Listeners[​](#step-3-update-event-listeners "Direct link to Step 3: Update Event Listeners")
...
### Step 4: Update Event Class References[​](#step-4-update-event-class-references "Direct link to Step 4: Update Event Class References")
...
### Step 5: Update Integration Tests[​](#step-5-update-integration-tests "Direct link to Step 5: Update Integration Tests")
...
### Step 6: Update Android Source Configuration[​](#step-6-update-android-source-configuration "Direct link to Step 6: Update Android Source Configuration")
...
### Step 7: Update Event Parameter Access[​](#step-7-update-event-parameter-access "Direct link to Step 7: Update Event Parameter Access")
...
## Automated Migration[​](#automated-migration "Direct link to Automated Migration")
...
## What Remains Unchanged[​](#what-remains-unchanged "Direct link to What Remains Unchanged")
