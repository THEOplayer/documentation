...
## Flutter Compatibility[​](#flutter-compatibility "Direct link to Flutter Compatibility")
...
## Run or build your app[​](#run-or-build-your-app "Direct link to Run or build your app")
...
## Changes required in your app[​](#changes-required-in-your-app "Direct link to Changes required in your app")

### Bootstrapping[​](#bootstrapping "Direct link to Bootstrapping")
...
### Include THEOplayer WEB SDK as asset[​](#include-theoplayer-web-sdk-as-asset "Direct link to Include THEOplayer WEB SDK as asset")
...
Not all browsers support the Flutter WASM renderer. Please always check the status of the compatibility [here](https://docs.flutter.dev/platform-integration/web/wasm#learn-more-about-browser-compatibility).

## Host it on a compatible server[​](#host-it-on-a-compatible-server "Direct link to Host it on a compatible server")
