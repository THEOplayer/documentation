...
## Available custom branches[​](#available-custom-branches "Direct link to Available custom branches")

| Branch                              | Description                                              |
| ----------------------------------- | -------------------------------------------------------- |
| `poc/in-sdk-chromecast-support-7.x` | Exposing Chromecast capabilities on Android, iOS and Web |
| `poc/in-sdk-google-ima-support-7.x` | Exposing Google IMA capabilities on Android and iOS      |

## How to make and use your own custom fork?[​](#how-to-make-and-use-your-own-custom-fork "Direct link to How to make and use your own custom fork?")
