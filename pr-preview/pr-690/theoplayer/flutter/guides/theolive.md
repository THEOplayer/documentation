...
## THEOlive playback[​](#theolive-playback "Direct link to THEOlive playback")
...
### Setting a THEOlive source[​](#setting-a-theolive-source "Direct link to Setting a THEOlive source")
...
#### Additional configuration options on `THEOPlayerConfig`[​](#additional-configuration-options-on-theoplayerconfig "Direct link to additional-configuration-options-on-theoplayerconfig")
...
### Listening for THEOlive-specific events[​](#listening-for-theolive-specific-events "Direct link to Listening for THEOlive-specific events")
...
## Migration from THEOlive Flutter SDK to THEOplayer Flutter SDK[​](#migration-from-theolive-flutter-sdk-to-theoplayer-flutter-sdk "Direct link to Migration from THEOlive Flutter SDK to THEOplayer Flutter SDK")

### setStateListener[​](#setstatelistener "Direct link to setStateListener")
...
### loadChannel[​](#loadchannel "Direct link to loadChannel")
...
### Playback-related actions[​](#playback-related-actions "Direct link to Playback-related actions")
...
### Anything missing?[​](#anything-missing "Direct link to Anything missing?")
