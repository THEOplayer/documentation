...
THEOplayer exposes internal debug flags that control verbose logging for various subsystems of the player. These flags can be toggled at runtime through the `player.debugFlags` API, making it easy to enable detailed logging for specific areas without recompiling.
...
### Listing Available Flags[​](#listing-available-flags "Direct link to Listing Available Flags")
...
### Toggling Individual Flags[​](#toggling-individual-flags "Direct link to Toggling Individual Flags")
...
### File Logging (iOS only)[​](#file-logging-ios-only "Direct link to File Logging (iOS only)")
...
## Built-in Debug Panel[​](#built-in-debug-panel "Direct link to Built-in Debug Panel")
...
### Showing the Panel[​](#showing-the-panel "Direct link to Showing the Panel")
...
### Panel Features[​](#panel-features "Direct link to Panel Features")
