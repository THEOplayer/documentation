...
## Setting up the React Native THEOplayer SDK for OptiView Live[​](#setting-up-the-react-native-theoplayer-sdk-for-optiview-live "Direct link to Setting up the React Native THEOplayer SDK for OptiView Live")

Refer to the [getting started guide](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/react-native/theolive/getting-started.md) for the prerequisite steps in getting the React Native SDK up and running for OptiView Live playback.

## Configuring THEOplayer to pass the token[​](#configuring-theoplayer-to-pass-the-token "Direct link to Configuring THEOplayer to pass the token")
...
## Enabling Token Based Security for Safari browsers on iOS <17[​](#enabling-token-based-security-for-safari-browsers-on-ios-17 "Direct link to Enabling Token Based Security for Safari browsers on iOS <17")
