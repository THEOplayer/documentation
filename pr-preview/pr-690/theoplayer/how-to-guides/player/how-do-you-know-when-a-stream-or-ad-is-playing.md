...
## How to detect an ad playing[​](#how-to-detect-an-ad-playing "Direct link to How to detect an ad playing")
...
You can use the `playing` event to know when content (or an ad) starts playing. Its event handler is the correct scope to check whether an advertisement is playing through the [`player.ads.playing`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Ads.html#playing) property.
...
* Please refer to [How can we track the first play(ing) event?](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/player/how-can-we-track-the-first-playing-event.md) to read more about capturing the first `playing` event.

## Resources[​](#resources "Direct link to Resources")

* [Reference API - Ads.playing property](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Ads.html#playing)
* [Reference API - playing property](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/PlayerEventMap.html#playing)
