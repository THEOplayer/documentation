...
The question above is commonly asked to assist with the use-cases where the first [`play`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/PlayerEventMap.html#play) event thrown by THEOplayer for a specific stream needs to be detected. Similar questions are:
...
* [Reference API - play event](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/PlayerEventMap.html#play):
