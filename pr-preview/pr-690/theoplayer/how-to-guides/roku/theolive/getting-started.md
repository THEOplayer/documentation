...
1. Follow [our Getting Started guide](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/roku/getting-started.md) to set up THEOplayer in your Roku app.
...
### Configure OptiView Live[​](#configure-optiview-live "Direct link to Configure OptiView Live")
...
* [API references](/documentation/pr-preview/pr-690/theoplayer/api-reference/roku.md)
* [Migrating to OptiView Live v2](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/roku/theolive/migrating-to-v2.md)
