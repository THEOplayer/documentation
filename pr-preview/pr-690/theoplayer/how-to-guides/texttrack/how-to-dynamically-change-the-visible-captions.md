...
This method assumes that you are using text-tracks that are loaded with the manifest. If you add the text-track separately, you can just use this API: [TextTrackDescription](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/TextTrackDescription.html)

## Step-by-step guide[​](#step-by-step-guide "Direct link to Step-by-step guide")

### 1. Create a new function inside the browser[​](#1-create-a-new-function-inside-the-browser "Direct link to 1. Create a new function inside the browser")
...
### 2. Call the function using the language label (or 3-letter-language code if you change x.label to x.language)[​](#2-call-the-function-using-the-language-label-or-3-letter-language-code-if-you-change-xlabel-to-xlanguage "Direct link to 2. Call the function using the language label (or 3-letter-language code if you change x.label to x.language)")
...
* [Web SDK](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md)
* [Android Legacy (4.12.x) SDK](/documentation/pr-preview/pr-690/theoplayer/v4/getting-started/sdks/android/getting-started/)
* [Chromecast Receiver SDK](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/chromecast/getting-started.md)
