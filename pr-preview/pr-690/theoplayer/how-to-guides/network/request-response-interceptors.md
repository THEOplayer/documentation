...
The first thing you need is a valid THEOplayer set-up. If you have no experience with setting up our player, we have an excellent [getting started guide](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md).
...
## Adding and removing Request Interceptors[​](#adding-and-removing-request-interceptors "Direct link to Adding and removing Request Interceptors")
...
A request interceptor can modify the request with the [`redirect`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/InterceptableRequest.html#redirect) or [`respondWith`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/InterceptableRequest.html#respondWith) method.
...
## Adding and removing Response Interceptors[​](#adding-and-removing-response-interceptors "Direct link to Adding and removing Response Interceptors")
...
A ResponseInterceptor can modify the response with the [`respondWith`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/InterceptableResponse.html#respondWith) method.
...
The code sample above intercepts manifest responses received by the player and responds with a manifest containing a single segment. The `respondWith` method accepts a [`ResponseInit`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/ResponseInit.html) object as its argument.
...
## Adding a waitUntil in Request and Response Interceptors[​](#adding-a-waituntil-in-request-and-response-interceptors "Direct link to Adding a waitUntil in Request and Response Interceptors")
...
#### Done callback[​](#done-callback "Direct link to Done callback")
...
#### Function returns a promise[​](#function-returns-a-promise "Direct link to Function returns a promise")
...
#### PromiseLike[​](#promiselike "Direct link to PromiseLike")
...
## HTTP Errors[​](#http-errors "Direct link to HTTP Errors")
...
## Adding and Removing Event Listeners[​](#adding-and-removing-event-listeners "Direct link to Adding and Removing Event Listeners")
