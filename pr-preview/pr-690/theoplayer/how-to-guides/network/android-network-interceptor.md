...
## Set up THEOplayer in your app[​](#set-up-theoplayer-in-your-app "Direct link to Set up THEOplayer in your app")

To set up THEOplayer Android SDK in your app follow the steps in our [Getting started on Android](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/android/getting-started.md) guide.

## Adding and removing an interceptor[​](#adding-and-removing-an-interceptor "Direct link to Adding and removing an interceptor")
...
## Intercepting a request[​](#intercepting-a-request "Direct link to Intercepting a request")
...
## Intercepting a response[​](#intercepting-a-response "Direct link to Intercepting a response")
