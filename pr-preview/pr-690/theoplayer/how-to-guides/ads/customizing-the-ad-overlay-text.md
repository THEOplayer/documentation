...
## CSAI integration[​](#csai-integration "Direct link to CSAI integration")

The `csai` [ad integration kind](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/types/AdIntegrationKind.html) is only available on Web SDK and allows customization.

To customize the text here we will be leveraging the language localization mechanism. You can find the API we will be using [here](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/UIConfiguration.html#language).

The second step is to customize the styling of texts. This can be done via CSS.

### Changing or localizing the text[​](#changing-or-localizing-the-text "Direct link to Changing or localizing the text")
...
### Changing the styling[​](#changing-the-styling "Direct link to Changing the styling")
...
## Google IMA/DAI[​](#google-imadai "Direct link to Google IMA/DAI")
...
### Changing or localizing the text[​](#changing-or-localizing-the-text-1 "Direct link to Changing or localizing the text")
...
### Changing the styling[​](#changing-the-styling-1 "Direct link to Changing the styling")
...
##### iOS SDK[​](#ios-sdk-1 "Direct link to iOS SDK")
