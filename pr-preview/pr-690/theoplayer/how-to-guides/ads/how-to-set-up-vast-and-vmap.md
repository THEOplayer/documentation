...
1. CSAI
2. [Google IMA](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/google-ima.md)
3. [SpotX](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/spotx.md)
4. [FreeWheel](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/freewheel.md)
...
### Scheduling a single pre-roll[​](#scheduling-a-single-pre-roll "Direct link to Scheduling a single pre-roll")

The following snippets demonstrate how to schedule a single pre-roll.

#### Web SDK[​](#web-sdk "Direct link to Web SDK")

You configure an [AdDescription](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/AdDescription.html) in the `ads` property of your [SourceConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/SourceConfiguration.html).
...
You configure a [GoogleImaAdDescription](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/source/addescription/GoogleImaAdDescription.Builder.html) in the `ads` property of your [`SourceDescription`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/source/SourceDescription.Builder.html#ads-com.theoplayer.android.api.source.addescription.AdDescription...-).

In this `GoogleImaAdDescription`,

* You set an ad tag URL.
* You set the value of [`timeOffset`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/source/addescription/GoogleImaAdDescription.Builder.html#timeOffset-java.lang.String-) to `"start"` (or `00:00:00` or `0%`) to indicate that it's a pre-roll.
...
You configure a [GoogleImaAdDescription](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Classes/GoogleImaAdDescription.html) in the `ads` property of your [`SourceDescription`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Classes/SourceDescription.html#/s:13THEOplayerSDK17SourceDescriptionC3adsSayAA02AdD0_pGSgvp).

In this `GoogleImaAdDescription`,

* You set an ad tag URL.
* You set the value of [`timeOffset`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Classes/THEOAdDescription.html#/c:@M@THEOplayerSDK@objc\(cs\)THEOAdDescription\(py\)timeOffset) to `"start"` (or `00:00:00` or `0%`) to indicate that it's a pre-roll.
...
### Scheduling two pre-rolls, two mid-rolls and one post-roll[​](#scheduling-two-pre-rolls-two-mid-rolls-and-one-post-roll "Direct link to Scheduling two pre-rolls, two mid-rolls and one post-roll")
...
### Scheduling a skippable mid-roll[​](#scheduling-a-skippable-mid-roll "Direct link to Scheduling a skippable mid-roll")

When using the `csai` ad integration, you can define when an VAST ad can be skipped through the `skipOffset` property.

However, it is recommended to leverage the `skipOffset` property in your VAST (or VMAP) file instead, and adhere to the [VAST standard](https://iabtechlab.com/standards/vast/), because this offers the widest support across ad integrations and platforms.
...
## Dynamic scheduling[​](#dynamic-scheduling "Direct link to Dynamic scheduling")

If you've read our [Advertising User Guide](/documentation/pr-preview/pr-690/theoplayer/knowledge-base/advertisement/user-guide.md#dynamic-ad-scheduling), you might have picked up that you can also dynamically schedule VAST advertisements in THEOplayer. All previous samples in this article use static, pre-defined scheduling; you schedule the ads whenever you schedule the stream. With dynamic scheduling, you schedule ads at runtime.
...
#### Web SDK[​](#web-sdk-4 "Direct link to Web SDK")
...
#### Android SDK[​](#android-sdk-3 "Direct link to Android SDK")
...
#### iOS/tvOS SDK[​](#iostvos-sdk-3 "Direct link to iOS/tvOS SDK")
