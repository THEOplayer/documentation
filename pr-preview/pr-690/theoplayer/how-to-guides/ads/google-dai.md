...
### Starting Template[​](#starting-template "Direct link to Starting Template")

The first thing you need is a valid THEOplayer setup. If you have no experience with setting up our player, we have an excellent [getting started guide](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md).
...
3. Create your player through JavaScript using our [API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/classes/Player.html).
...
### Integrating Google DAI[​](#integrating-google-dai "Direct link to Integrating Google DAI")
...
### Importing Google DAI feature module[​](#importing-google-dai-feature-module "Direct link to Importing Google DAI feature module")
...
### Creating an instance of Google DAI Integration[​](#creating-an-instance-of-google-dai-integration "Direct link to Creating an instance of Google DAI Integration")
...
### Using a Google DAI Source[​](#using-a-google-dai-source "Direct link to Using a Google DAI Source")

Use a [GoogleDaiVodConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/source/ssai/dai/GoogleDaiVodConfiguration.html) or [GoogleDaiLiveConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/source/ssai/dai/GoogleDaiLiveConfiguration.html) to create a `GoogleDaiTypedSource` to request stream, as demonstrated below:
...
The Google DAI integration exposes events through the Ads API. More information is available at ["How to subscribe to ad events"](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/how-to-subscribe-to-ad-events.md#android-sdk).

The integration exposes a number of additional methods. These are available directly on the [`GoogleDaiIntegration`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/ads/dai/GoogleDaiIntegration.html) object, or indirectly through `player.ads.dai` (only for Kotlin). For example:

* [requestStream(StreamRequest, AdsRenderingSettings)](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/ads/dai/GoogleDaiIntegration.html#requestStream\(StreamRequest,AdsRenderingSettings\)) can be used to request stream through the native Google DAI API.
* [contentTimeForStreamTime(double)](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/ads/dai/GoogleDaiIntegration.html#contentTimeForStreamTime\(double\)) / [streamTimeForContentTime(double)](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/ads/dai/GoogleDaiIntegration.html#streamTimeForContentTime\(double\)) can be used to convert content time to stream time and vice versa.

## iOS SDK[​](#ios-sdk "Direct link to iOS SDK")

To use Google DAI with the THEOplayer iOS SDK, the **THEOplayer GoogleIMA Integration** should be integrated. For instructions on installation, importing and adding the integration, [please refer to this guide](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/google-ima.md#ios-sdk).
...
1. [Google DAI Pre-Integration API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/GoogleDAIConfiguration.html)
