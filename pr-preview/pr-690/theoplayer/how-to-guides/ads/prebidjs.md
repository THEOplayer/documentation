...
## Connecting Prebid.js and THEOplayer[​](#connecting-prebidjs-and-theoplayer "Direct link to Connecting Prebid.js and THEOplayer")
...
The example above schedules advertisements as pre-rolls (or mid-rolls or post-rolls). You can also dynamically schedule advertisements with the Ads API, as explained in [How to set up VAST and VMAP ads](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/how-to-set-up-vast-and-vmap.md).
