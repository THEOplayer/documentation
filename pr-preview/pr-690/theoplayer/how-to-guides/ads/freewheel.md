...
## How to integrate FreeWheel[​](#how-to-integrate-freewheel "Direct link to How to integrate FreeWheel")
...
Next, you add a [`FreeWheelAdDescription`](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/FreeWheelAdDescription.html) to your source that specifies the FreeWheel tokens. An example sourceDescription could look like this:
...
1. [THEOplayer Getting Started Guide](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md)

2. [FreeWheelAdDescription](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/FreeWheelAdDescription.html)
