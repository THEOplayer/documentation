...
![Ad block detection](/documentation/pr-preview/pr-690/assets/images/ad-blocker-detected-2021-8f2264848bf980c284f2e5744c2acd30.png "Adblock detection")
...
When you set the `blockContentIfAdError` to `true` in your stream configuration (i.e. [SourceConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/SourceConfiguration.html#blockContentIfAdError)), then playback will be stopped, and a default error message will be shown.
...
### Error event[​](#error-event "Direct link to Error event")
...
If you're using the [Google IMA](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ads/google-ima.md) ad integration, your callback event will have a `problemType` property that will equal `"adblock"`.
...
* API reference: [Ads API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Ads.html)
* Online demo: [Adblock Detection Demo](https://demo.theoplayer.com/adblock-detection)
* Advertisement guide: [Advertising User Guide](/documentation/pr-preview/pr-690/theoplayer/knowledge-base/advertisement/user-guide.md) (mentions adblock detection)
