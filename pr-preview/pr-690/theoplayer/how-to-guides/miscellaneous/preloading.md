...
## How to use preloading[​](#how-to-use-preloading "Direct link to How to use preloading")
...
### Preloading settings[​](#preloading-settings "Direct link to Preloading settings")
...
* [API reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/types/PreloadType.html)
* [HTML5 specification](https://www.w3.org/TR/html5/embedded-content-0.html#attr-media-preload)
* [API reference: Cache API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Cache.html)
