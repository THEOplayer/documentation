...
## How to use the Web Audio API[​](#how-to-use-the-web-audio-api "Direct link to How to use the Web Audio API")
...
* Demo: <https://demo.theoplayer.com/web-audio-api>
...
* [Basic Guide to Web Audio API](/documentation/pr-preview/pr-690/theoplayer/knowledge-base/playback/basic-guide-web-audio-api.md)
