...
## 360 / VR[​](#360--vr "Direct link to 360 / VR")
...
The Web SDK uses the [WebXR API](https://developer.mozilla.org/en-US/docs/Web/API/WebXR_Device_API) for virtual reality playback. For platforms that do not natively support WebXR, you can add the [WebXR polyfill](https://github.com/immersive-web/webxr-polyfill) to your web page.

Bug in official polyfill

The official polyfill has a bug in its rendering, see [issue 167](https://github.com/immersive-web/webxr-polyfill/issues/167). Our team has already [proposed and submitted a fix](https://github.com/immersive-web/webxr-polyfill/pull/168), but this fix has not yet been published in a new release of the polyfill.
...
For the full list of properties and events related to 360° video and VR, go to our [API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/VR.html) page.
...
### Manipulating the viewing direction within a 360 video[​](#manipulating-the-viewing-direction-within-a-360-video "Direct link to Manipulating the viewing direction within a 360 video")
...
### Setting stereoMode[​](#setting-stereomode "Direct link to Setting stereoMode")
...
### Listening to VR related events[​](#listening-to-vr-related-events "Direct link to Listening to VR related events")
...
## Request Permissions[​](#request-permissions "Direct link to Request Permissions")
