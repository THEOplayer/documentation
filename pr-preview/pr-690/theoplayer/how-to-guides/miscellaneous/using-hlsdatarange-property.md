...
## Using and interacting with date-range variables[​](#using-and-interacting-with-date-range-variables "Direct link to Using and interacting with date-range variables")
...
##### iOS/tvOS SDK and Legacy iOS/tvOS SDK (4.12.x) and Android[​](#iostvos-sdk-and-legacy-iostvos-sdk-412x-and-android "Direct link to iOS/tvOS SDK and Legacy iOS/tvOS SDK (4.12.x) and Android")

To be added

## Resources[​](#resources "Direct link to Resources")

HLS spec. : <https://tools.ietf.org/html/draft-pantos-hls-rfc8216bis-04#section-4.4.2.7>
