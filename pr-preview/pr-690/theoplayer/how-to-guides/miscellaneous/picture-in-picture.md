...
| --------------- | ------- | ----------- | -------------- | ------- | -------- | -------- | ----------- | -------------- |
| **in-app**1     | Yes     | No3         | No3            | Yes     | No       | No       | No3         | N/A            |
| **out-of-app**2 | No      | Yes         | Yes            | Yes     | Yes      | No       | Yes         | N/A            |
...
3 On Android/Fire TV SDK, there is no API to explicitly only allow in-app PiP. The existing [PiP API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/pip/package-summary.html) activates both in and out of app PiP.

## How to use Picture-in-Picture[​](#how-to-use-picture-in-picture "Direct link to How to use Picture-in-Picture")
...
### Enable Picture-In-Picture mode[​](#enable-picture-in-picture-mode "Direct link to Enable Picture-In-Picture mode")
...
![Picture-in-Picture](/documentation/pr-preview/pr-690/assets/images/picture-in-picture-778462f302e24a4b44a176d0fa345cd1.png "Picture-in-Picture")
...
* `visibility`: (optional, a number from 0 to 1)<br /><!-- -->The maximum percentage of the original player position that should be visible to enable PiP automatically. If not configured, PiP can only be turned on by setting [presentationMode](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/types/PresentationMode.html) to "picture-in-picture".

* `retainPresentationModeOnSourceChange`: (optional, possible values: true or false)<br /><!-- -->If set to true, the previous [presentationMode](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/types/PresentationMode.html) is retained even as the source changes. It is set to false by default.
...
##### Android / Fire TV SDK[​](#android--fire-tv-sdk "Direct link to Android / Fire TV SDK")

If you want to use Picture-In-Picture in your application you can instantiate the player with a PiPConfiguration, to be passed in the THEOplayerConfig. When passing a PipConfiguration, the Android SDK will **always** make use of out-of-app PiP.
...
If you want to use Picture-In-Picture in your application you can instantiate the player with a PiPConfiguration, to be passed in the THEOplayerConfiguration. Using this PiPConfiguration you can configure whether the player should retain its presentation mode upon source-change. You can also choose whether to make use of out-of-app PiP (=`nativePictureInPicture`). Note that to make use of out-of-app PiP the minimum required iOS version is 14.0.
...
### Observe events in Picture-In-Picture[​](#observe-events-in-picture-in-picture "Direct link to Observe events in Picture-In-Picture")
...
###### Returning from PiP Mode: Playback Behavior[​](#returning-from-pip-mode-playback-behavior "Direct link to Returning from PiP Mode: Playback Behavior")

###### 1. **ACTIVITY PiPType:**[​](#1-activity-piptype "Direct link to 1-activity-piptype")
...
###### 2. **DIALOG PiPType:**[​](#2-dialog-piptype "Direct link to 2-dialog-piptype")
...
###### 3. **CUSTOM PiPType:**[​](#3-custom-piptype "Direct link to 3-custom-piptype")
...
###### in-app Picture in Picture[​](#in-app-picture-in-picture "Direct link to in-app Picture in Picture")
...
* <https://demo.theoplayer.com/picture-in-picture>
...
* <https://github.com/THEOplayer/samples-android-sdk/tree/master/pip-handling>
...
* More details of the `PresentationMode` types can be found here: [Web PresentationMode API Reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/types/PresentationMode.html)
...
* [PipConfiguration API Reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/PiPConfiguration.html)
* [PlayerConfiguration API Reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/PlayerConfiguration.html)
...
* [PipConfiguration API Reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Classes/PiPConfiguration.html)
* [PictureInPicture API Reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Protocols/PictureInPicture.html)

##### Android SDK[​](#android-sdk-2 "Direct link to Android SDK")

* [PipConfiguration API Reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/pip/PipConfiguration.Builder.html)
* [PiPManager API Reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/pip/PiPManager.html)
