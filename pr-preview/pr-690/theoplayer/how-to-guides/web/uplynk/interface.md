...
## Using the Uplynk interface[​](#using-the-uplynk-interface "Direct link to Using the Uplynk interface")
...
If you're looking for more information on how to query the available advertisements and how to subscribe to ad events, then refer to [Uplynk Ads](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/web/uplynk/ads.md).

The examples below provide a basic demonstration of how to use the `Uplynk` interface. The GitHub projects linked at [Uplynk - Introduction](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/web/uplynk/introduction.md) provide more code samples.
...
Refer to the [Uplynk API reference](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Uplynk.html) for more information. Additionally, reviewing [the player configuration in the demo app](https://github.com/THEOplayer/samples-html5-sdk/blob/master/reference-apps/verizon-media-app/src/player.js) helps to understand the `Uplynk` interface.

## Related articles[​](#related-articles "Direct link to Related articles")

* [Uplynk - Introduction](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/web/uplynk/introduction.md): this article links to sample Git projects which query (and subscribe to) the various properties and events offered by the `Uplynk` interface.
* [Uplynk - Preplay](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/web/uplynk/preplay.md): this article explains how you can use the Uplynk interface to intercept Preplay responses.
* [Uplynk - Ads](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/web/uplynk/ads.md): this article offers more information on the `ads` parts of the Uplynk interface.
* [Uplynk - Ping](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/web/uplynk/ping.md): this article explains how you can use the Uplynk interface to intercept Ping responses.
