...
## Setting up the Android THEOplayer SDK for OptiView Live[​](#setting-up-the-android-theoplayer-sdk-for-optiview-live "Direct link to Setting up the Android THEOplayer SDK for OptiView Live")

Refer to the [getting started guide](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/android/theolive/getting-started.md) for the prerequisite steps in getting the web SDK up and running for OptiView Live playback.
