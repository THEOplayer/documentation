...
1. Review the [THEOplayer Flutter SDK limitations](/documentation/pr-preview/pr-690/theoplayer/flutter/guides/limitations.md) to ensure your use case needs are supported before starting development.
2. Follow along with the [THEOplayer Flutter SDK minimal setup guide](/documentation/pr-preview/pr-690/theoplayer/flutter/guides/creating-minimal-app.md) to setup a basic OptiView Live project.
3. Check the [THEOlive support guide](/documentation/pr-preview/pr-690/theoplayer/flutter/guides/theolive.md) for the latest OptiView Live Flutter updates.

For customers currently using the now deprecated OptiView Live SDK for playback, please migrate to using the THEOplayer SDK with the following [THEOlive migration guide](/documentation/pr-preview/pr-690/theoplayer/flutter/guides/theolive.md#migration-from-theolive-flutter-sdk-to-theoplayer-flutter-sdk) to always have the latest updates.

### Flutter project setup[​](#flutter-project-setup "Direct link to Flutter project setup")
...
### Initializing a THEOplayer instance[​](#initializing-a-theoplayer-instance "Direct link to Initializing a THEOplayer instance")
...
Use Flutter documentation along with our [basic playback guide](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/flutter/theolive/basic-playback-guide.md) for Flutter to develop your project.
