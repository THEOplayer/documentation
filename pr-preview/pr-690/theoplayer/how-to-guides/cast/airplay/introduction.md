...
[AirPlay](https://www.apple.com/airplay/) is a casting technology developed by Apple. AirPlay allows viewers to mirror their videos between AirPlay-enabled sender and receiver devices.
...
## How to enable AirPlay[​](#how-to-enable-airplay "Direct link to How to enable AirPlay")

AirPlay is a THEOplayer feature. Ensure that the `airplay` feature is enabled when you build a THEOplayer SDK through the [THEOplayer Developer Platform](https://portal.theoplayer.com/), as demonstrated by the screenshot below. Alternative, when someone shares the THEOplayer SDK with you, confirm that they enabled the `airplay` feature.

![Enable Airplay](/documentation/pr-preview/pr-690/assets/images/portal-airplay-enabled-1f34336e6078b5eff14cdbfcd3695480.png)
...
![AirPlay demo](/documentation/pr-preview/pr-690/assets/images/airplay-demo-theoplayer-b38aaa6ad2b2495f333a4316151d5ac4.png)

If you have a custom ([Chromeless](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ui/how-to-build-chromeless-ui.md)) THEOplayer UI, you need to build your own AirPlay UI and UX. You can use the THEOplayer AirPlay API to help achieve this, as discussed in the next section.
...
* Web SDK: [AirPlay](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/AirPlay.html), which inherits from [VendorCast](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/VendorCast.html)
* iOS SDK: [AirPlay](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Protocols/AirPlay.html)
...
* [Chromecast](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/cast/chromecast/introduction.md) and AirPlay are comparable technologies.
