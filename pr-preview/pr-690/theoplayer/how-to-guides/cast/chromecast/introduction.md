...
* Web SDK: [Chromecast](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Chromecast.html), which inherits from [VendorCast](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/VendorCast.html)
* Android SDK: [Chromecast](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/cast/chromecast/Chromecast.html)
* iOS SDK: [Chromecast](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Protocols/Chromecast.html)
...
You will also need the THEOplayer core SDK since the THEOplayer GoogleCast integration extends its functionality.<br />To import the THEOplayer core SDK framework add:
...
* [Debugging](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/cast/chromecast/debugging.md)
...
* [Sending messages from/to Sender to/from Receiver](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/cast/chromecast/sending-messages-from-to-sender-to-from-receiver.md)
...
## Sender Applications vs Receiver Applications[​](#sender-applications-vs-receiver-applications "Direct link to Sender Applications vs Receiver Applications")
...
If you have implemented THEOplayer in your sender application, you can [enable Chromecast](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/cast/chromecast/enable-chromecast-on-the-sender.md). Furthermore, you can also [specify the application ID](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/cast/chromecast/enable-chromecast-on-the-sender.md#custom-receiver-app) in your sender application.

![Casting approaches](/documentation/pr-preview/pr-690/assets/images/casting-approaches-45dc2983f20d11409d27d3248b57a6ef.png "Casting approaches")
...
| Custom THEOplayer Receiver Application  | Developer + THEOplayer | This is a custom receiver application you can build, and where you integrate the [THEOplayer Chromecast SDK](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/chromecast/getting-started.md). | You (i.e. the developer) can adjust the look and feel, and integrate custom logic.                                                                                                                            | You need to create a Chromecast receiver, register it, maintain it, ...                                                             |
...
## Whitelisting Receiver Applications[​](#whitelisting-receiver-applications "Direct link to Whitelisting Receiver Applications")
