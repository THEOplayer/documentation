...
## Import Chromecast Sender SDK[​](#import-chromecast-sender-sdk "Direct link to Import Chromecast Sender SDK")
...
Importing the Chromecast feature differs between the Android SDK and Legacy Android SDK (4.12.x) but the usage is similar. Therefore, the points 1 & 2 below are SDK specific meanwhile from point 3 and on they are similar.
...
## Connect with custom Chromecast Receiver application[​](#custom-receiver-app "Direct link to Connect with custom Chromecast Receiver application")

The THEOplayer SDK on your Sender application connects with THEO Chromecast Receiver application by default, but you can connect it to a custom Chromecast Receiver application instead.

### Web SDK[​](#web-sdk-1 "Direct link to Web SDK")

If you have your own Receiver app, then you adjust the [PlayerConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/CastConfiguration.html) to connect with a specific `appID` as demonstrated below.
