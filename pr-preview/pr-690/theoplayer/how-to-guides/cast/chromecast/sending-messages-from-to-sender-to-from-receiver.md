...
## Send data to the receiver[​](#send-data-to-the-receiver "Direct link to Send data to the receiver")
...
## Receive data from the receiver[​](#receive-data-from-the-receiver "Direct link to Receive data from the receiver")
...
* <https://developers.google.com/cast/docs/reference/chrome/cast.framework.CastSession#addMessageListener>
...
* <https://developers.google.com/android/reference/com/google/android/gms/cast/framework/CastSession.html#setMessageReceivedCallbacks(java.lang.String,%20com.google.android.gms.cast.Cast.MessageReceivedCallback)>
...
## Receive data on the receiver[​](#receive-data-on-the-receiver "Direct link to Receive data on the receiver")
...
## Send data from the receiver[​](#send-data-from-the-receiver "Direct link to Send data from the receiver")
