...
If you are already comfortable with the THEOplayer API, you can go straight over to [DRM Pre-Integration API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/DRMConfiguration.html).
...
2. Be a client of KeyOS's BuyDRM, and that you are integrated with their streaming infrastructure. Information on BuyDRM can be found at <https://buydrm.com/multikey-demo/>.

If you can place a checkmark next to these two fields, you are good to go.

You will also need a valid THEOplayer set-up. If you have no experience with setting up our player, we have an excellent [getting started guide](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md).

## Integrating KeyOS BuyDRM[​](#integrating-keyos-buydrm "Direct link to Integrating KeyOS BuyDRM")
...
## Extra resources:[​](#extra-resources "Direct link to Extra resources:")

1. [DRM Pre-Integration API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/DRMConfiguration.html)
