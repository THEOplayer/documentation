...
Agama requires you to have the `agama` feature enabled in your SDK build. Agama needs to be configured through the PlayerConfiguration and through the SourceConfiguration. The following section describes how this can be done. If you do not have this feature enabled in your SDK, or are unsure, please contact your CSM or Service Desk for confirmation.
...
The player configuration should include the [AgamaPlayerConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/AgamaPlayerConfiguration.html) object.
...
The player's source configuration should include the [AgamaSourceConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/AgamaSourceConfiguration.html) object.
...
##### Android (TV) SDK[​](#android-tv-sdk-1 "Direct link to Android (TV) SDK")
...
Once the player is configured, an Agama EMP client is created. The player source configuration should include the [AgamaSourceConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/AgamaSourceConfiguration.html) object in the analytics tag while configuring the [SourceDescription](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/SourceDescription.html):
...
##### iOS (/tvOS) SDK[​](#ios-tvos-sdk-1 "Direct link to iOS (/tvOS) SDK")
...
Once the player is configured, an Agama EMP client is created. The player source configuration should include the [AgamaSourceConfiguration](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/AgamaSourceConfiguration.html) object in the analytics tag:
...
* [Custom Analytics Integration](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/analytics/custom-analytics-integration.md)
