...
## Connecting Mux to THEOplayer[​](#connecting-mux-to-theoplayer "Direct link to Connecting Mux to THEOplayer")
...
* **Web SDK**: <https://docs.mux.com/guides/data/monitor-theoplayer-web>

* **Android (TV) SDK**: <https://docs.mux.com/guides/data/monitor-theoplayer-android>

* **iOS (/tvOS) SDK**: <https://docs.mux.com/guides/data/monitor-theoplayer-ios>
