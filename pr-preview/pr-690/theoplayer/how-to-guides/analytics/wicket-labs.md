...
## Connecting Wicket Labs with THEOplayer[​](#connecting-wicket-labs-with-theoplayer "Direct link to Connecting Wicket Labs with THEOplayer")
...
* Developers are free to do their custom integration of Wicket Labs and THEOplayer, or may modify the publicly available code samples.
  ...
  * THEOplayer's article on [Custom Analytics Integration](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/analytics/custom-analytics-integration.md) may help developers out.
...
* github.com/THEOplayer: <https://github.com/THEOplayer/samples-wicket-labs-html5-sdk>
