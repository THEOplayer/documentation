...
2. Follow the [Getting started on Web](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md) guide to include your player on a simple HTML page.
...
#### Setting asset name[​](#setting-asset-name "Direct link to Setting asset name")
