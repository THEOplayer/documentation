...
## How to set up THEOplayer with Wowza Streaming Engine For LL-HLS[​](#how-to-set-up-theoplayer-with-wowza-streaming-engine-for-ll-hls "Direct link to How to set up THEOplayer with Wowza Streaming Engine For LL-HLS")
...
### Configure a live application to deliver LL-HLS streams[​](#configure-a-live-application-to-deliver-ll-hls-streams "Direct link to Configure a live application to deliver LL-HLS streams")
...
#### Enable LL-HLS in Wowza Streaming Engine XML[​](#enable-ll-hls-in-wowza-streaming-engine-xml "Direct link to Enable LL-HLS in Wowza Streaming Engine XML")
...
#### Configure optional low latency partial segment properties and media playlist property[​](#configure-optional-low-latency-partial-segment-properties-and-media-playlist-property "Direct link to Configure optional low latency partial segment properties and media playlist property")
...
##### Low latency CMAF property reference[​](#low-latency-cmaf-property-reference "Direct link to Low latency CMAF property reference")
...
##### Advanced LL-HLS property reference[​](#advanced-ll-hls-property-reference "Direct link to Advanced LL-HLS property reference")
...
##### Transcoding considerations for LL-HLS[​](#transcoding-considerations-for-ll-hls "Direct link to Transcoding considerations for LL-HLS")
...
###### Encoding recommendations[​](#encoding-recommendations "Direct link to Encoding recommendations")
...
##### Scale LL-HLS with a CDN[​](#scale-ll-hls-with-a-cdn "Direct link to Scale LL-HLS with a CDN")
...
##### Test stream playback[​](#test-stream-playback "Direct link to Test stream playback")
...
**Single bitrate** https\://\[address]/\[application]/\[application-instance]/\[stream-name]/playlist\_sfm4s.m3u8
...
### Configure THEOplayer to play your LL-HLS stream[​](#configure-theoplayer-to-play-your-ll-hls-stream "Direct link to Configure THEOplayer to play your LL-HLS stream")

##### Web SDK[​](#web-sdk "Direct link to Web SDK")

1. Setup a basic HTML file and include the THEOplayer library. You can check: [How to get started with THEOplayer Web SDK](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md).
