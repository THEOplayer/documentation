...
For SDK version **3.6.1** and above, you can use the API described at [Player#setAspectRatio(AspectRatio)](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/player/Player.html#setAspectRatio\(AspectRatio\)) to set the [AspectRatio](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/android/com/theoplayer/android/api/player/AspectRatio.html) values.
...
The article at [How to add CSS or JavaScript files to an Android/iOS project](/documentation/pr-preview/pr-690/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios/) explains how you can add CSS and JavaScript files to your project. The sample project at [How to insert a button](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ui/how-to-insert-a-button.md) demonstrates this.

### iOS (tvOS) SDK[​](#ios-tvos-sdk "Direct link to iOS (tvOS) SDK")

You can use the API described at [THEOplayerFullscreen](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/ios/Protocols/Fullscreen_Objc.html#/c:@M@THEOplayerSDK@objc\(pl\)THEOplayerFullscreen\(im\)setAspectRatioWithAspectRatio:) to set the [video gravity](https://developer.apple.com/documentation/avfoundation/avplayerlayer/1388915-videogravity) values.
