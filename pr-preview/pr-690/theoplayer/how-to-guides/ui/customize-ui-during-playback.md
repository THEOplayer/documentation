...
## How to customize the ad playback UI[​](#how-to-customize-the-ad-playback-ui "Direct link to How to customize the ad playback UI")
...
### Detecting ad playback[​](#detecting-ad-playback "Direct link to Detecting ad playback")
...
The Web SDK code should be included in your Android (TV) project. The article at [How to add CSS or JavaScript files to an Android/iOS project](/documentation/pr-preview/pr-690/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios/) explains how you can add CSS and JavaScript files to your project. The sample project at [How to insert a button](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/ui/how-to-insert-a-button.md) demonstrates this.
...
The [Ads API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Ads.html) exposes, among others, the following events:
...
### Displaying an advertisement label[​](#displaying-an-advertisement-label "Direct link to Displaying an advertisement label")
...
### Adding a custom countdown[​](#adding-a-custom-countdown "Direct link to Adding a custom countdown")
...
##### Legacy iOS/tvOS SDK (4.12.x)[​](#legacy-iostvos-sdk-412x-3 "Direct link to Legacy iOS/tvOS SDK (4.12.x)")
