...
## Making the audio player from the video player[​](#making-the-audio-player-from-the-video-player "Direct link to Making the audio player from the video player")
...
### 1 - Add a new class to 2 HTML elements in the player[​](#1---add-a-new-class-to-2-html-elements-in-the-player "Direct link to 1 - Add a new class to 2 HTML elements in the player")
...
### 2 - Hide unnecessary buttons from the control bar[​](#2---hide-unnecessary-buttons-from-the-control-bar "Direct link to 2 - Hide unnecessary buttons from the control bar")
...
### 3 - Hide content that might appear above the control bar[​](#3---hide-content-that-might-appear-above-the-control-bar "Direct link to 3 - Hide content that might appear above the control bar")
...
### 4- Decrease the player's height[​](#4--decrease-the-players-height "Direct link to 4- Decrease the player's height")
...
### 5 Ensure the control bar is always visible[​](#5-ensure-the-control-bar-is-always-visible "Direct link to 5 Ensure the control bar is always visible")
...
### 6 - Rescale the loading spinner[​](#6---rescale-the-loading-spinner "Direct link to 6 - Rescale the loading spinner")
...
### 7 - Change appearance for when the stream is not yet loaded[​](#7---change-appearance-for-when-the-stream-is-not-yet-loaded "Direct link to 7 - Change appearance for when the stream is not yet loaded")
...
### 8 - (Optional) Add the audioOnly flag[​](#8---optional-add-the-audioonly-flag "Direct link to 8 - (Optional) Add the audioOnly flag")
...
The Web SDK code should be included in your Android (TV) project. The article at [How to add CSS or JavaScript files to an Android/iOS project](/documentation/pr-preview/pr-690/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios/)explains how you can add CSS and JavaScript files to your project.

##### Legacy iOS/tvOS SDK (4.12.x)[​](#legacy-iostvos-sdk-412x "Direct link to Legacy iOS/tvOS SDK (4.12.x)")

The Web SDK code should be included in your iOS project. The article at [How to add CSS or JavaScript files to an Android/iOS project](/documentation/pr-preview/pr-690/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios/) explains how you can add CSS and JavaScript files to your project.
...
* Demo: <http://cdn.theoplayer.com/demos/nus/audio-only.html>

## Resources[​](#resources "Direct link to Resources")

* [How to add CSS or JavaScript files to an Android/iOS project](/documentation/pr-preview/pr-690/theoplayer/v4/faq/how-to-add-css-or-javascript-files-to-android-ios/): How-to guide
