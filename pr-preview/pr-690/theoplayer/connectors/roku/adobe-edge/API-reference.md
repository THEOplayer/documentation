...
| MEDIA\_EVENTS | associativeArray | AEP Media Events | read              | Constant with the AEP media event enums. |
...
### AEP Connector Config[​](#aep-connector-config "Direct link to AEP Connector Config")
...
### Session Details and Config[​](#session-details-and-config "Direct link to Session Details and Config")
...
#### THEOAEPMediaSessionDetails[​](#theoaepmediasessiondetails "Direct link to THEOAEPMediaSessionDetails")
...
#### Session Config[​](#session-config "Direct link to Session Config")
...
### Getting the Experience Cloud ID[​](#getting-the-experience-cloud-id "Direct link to Getting the Experience Cloud ID")
...
### Reusing an existing AEP SDK library[​](#reusing-an-existing-aep-sdk-library "Direct link to Reusing an existing AEP SDK library")
...
### Supported media events[​](#supported-media-events "Direct link to Supported media events")
