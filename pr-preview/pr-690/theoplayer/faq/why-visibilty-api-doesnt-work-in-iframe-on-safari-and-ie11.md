...
The [Visibility API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Visibility.html) provides developers a way to observe how much of the player is visible.
