...
THEOplayer exposes different types of errors. Refer to "[How to do error handling](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/miscellaneous/error/how-to-do-error-handling.md)" for information on how to programmatically detect an `error` event through an event listener.
