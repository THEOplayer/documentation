...
When casting through [AirPlay](https://www.theoplayer.com/theoplayer-demo-airplay) your viewer is relying on the native Apple video player. This setup gives rise to a number of limitations, as a third-party video player (i.e. THEOplayer) cannot circumvent the limitations of this native Apple video player.
...
* AirPlay does not support UI customization. Instead, you could implement a [tvOS application](/documentation/pr-preview/pr-690/theoplayer/v4/getting-started/sdks/tvos/getting-started/) to offer a custom playback experience on an Apple TV.
* AirPlay does not support some closed captions and subtitle formats, including CEA-608 and [sideloaded (WebVTT) subtitles](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/texttrack/how-to-insert-subtitles.md). Instead, you must use subtitles that are supported natively.
