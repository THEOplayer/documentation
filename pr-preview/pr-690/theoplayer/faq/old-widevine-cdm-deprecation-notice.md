...
## What is the effect of this?[​](#what-is-the-effect-of-this "Direct link to What is the effect of this?")
...
## What should you do if a certain user has an issue with your DRM-protected streams?[​](#what-should-you-do-if-a-certain-user-has-an-issue-with-your-drm-protected-streams "Direct link to What should you do if a certain user has an issue with your DRM-protected streams?")
...
## Which platforms are affected?[​](#which-platforms-are-affected "Direct link to Which platforms are affected?")
...
## Should you update your THEOplayer SDK if you are on an older version?[​](#should-you-update-your-theoplayer-sdk-if-you-are-on-an-older-version "Direct link to Should you update your THEOplayer SDK if you are on an older version?")
...
* [How to update an SDK](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/how-to-update-a-sdk.md)
* [THEOplayer Platform Support](https://www.theoplayer.com/platform-support)
* [THEOplayer Changelog](/documentation/pr-preview/pr-690/theoplayer/changelog.md)
