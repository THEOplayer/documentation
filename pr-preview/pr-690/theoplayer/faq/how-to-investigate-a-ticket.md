...
* The ticket is well-described and/or [C.R.U.S.P.](/documentation/pr-preview/pr-690/theoplayer/faq/how-to-create-a-ticket.md#creating-a-great-ticket).
...
![THEOplayer Jira Service Desk](/documentation/pr-preview/pr-690/assets/images/ticket-4-stages-c1b32aaf31118677b8e12ea0a6f913ec.png)

### Reproduce the issue[​](#reproduce-the-issue "Direct link to Reproduce the issue")
...
![THEOplayer Jira Service Desk](/documentation/pr-preview/pr-690/assets/images/ticket-reproduce-4f68ae49865e31e6696b3dddb622e3ad.png)

### Check other versions[​](#check-other-versions "Direct link to Check other versions")
...
### Narrow the scope[​](#narrow-the-scope "Direct link to Narrow the scope")
...
![THEOplayer Jira Service Desk](/documentation/pr-preview/pr-690/assets/images/tickets-scope-1be0844416f48492be33a162c15ac16b.png)

#### Scope affected platforms[​](#scope-affected-platforms "Direct link to Scope affected platforms")

It's always useful to know which browsers, SDKs and operating systems are affected by the issue.

#### Scope affected THEOplayer versions[​](#scope-affected-theoplayer-versions "Direct link to Scope affected THEOplayer versions")
...
#### Scope affected video players[​](#scope-affected-video-players "Direct link to Scope affected video players")
...
### Investigation[​](#investigation "Direct link to Investigation")
...
4. Check whether the issue can be reproduced with other streams:
   ...
   * HLS: [https://cdn.theoplayer.com/video/star*wars\_episode\_vii-the\_force\_awakens\_official\_comic-con\_2015\_reel*(2015)/index.m3u8](https://cdn.theoplayer.com/video/star_wars_episode_vii-the_force_awakens_official_comic-con_2015_reel_\(2015\)/index.m3u8)
   * MPEG-DASH: <https://amssamples.streaming.mediaservices.windows.net/634cd01c-6822-4630-8444-8dd6279f94c6/CaminandesLlamaDrama4K.ism/manifest(format=mpd-time-csf)>
...
7. Check whether there are [CORS-issues](/documentation/pr-preview/pr-690/theoplayer/faq/how-to-remove-cors-restrictions.md).

8. In-case DRM is used, check whether the issue can also be reproduced if the asset is unprotected.

#### Advertisements[​](#advertisements "Direct link to Advertisements")
...
* The following resources might assist in your debugging efforts:
  ...
  * <https://optiview.dolby.com/resources/demos/test-stream/>: logs a number of events and states.
