...
### Autoplay policies[​](#autoplay-policies "Direct link to Autoplay policies")
...
### Chrome Media Engagement Index (MEI)[​](#chrome-media-engagement-index-mei "Direct link to Chrome Media Engagement Index (MEI)")
...
### iOS 11 and following[​](#ios-11-and-following "Direct link to iOS 11 and following")
...
* [How does Media Engagement Index (MEI) affect Autoplay on Chrome?](/documentation/pr-preview/pr-690/theoplayer/faq/how-does-mei-affect-autoplay-on-chrome.md)
* [API reference - mutedAutoplay](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/PlayerConfiguration.html#mutedAutoplay)
