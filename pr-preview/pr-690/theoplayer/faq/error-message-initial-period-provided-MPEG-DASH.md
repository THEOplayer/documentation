...
**How to check whether your segments are available at the right time** For the segments to be correctly played, they must be available at the time when the manifest is requested/served. In other words,

*“start of segment availability” < “manifest is requested/served” < “end of segment availability”*
