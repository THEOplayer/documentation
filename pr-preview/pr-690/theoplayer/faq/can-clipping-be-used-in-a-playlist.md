...
## The same start and end time can be used for all contents[​](#the-same-start-and-end-time-can-be-used-for-all-contents "Direct link to The same start and end time can be used for all contents")
...
## Each content has a different start and end time.[​](#each-content-has-a-different-start-and-end-time "Direct link to Each content has a different start and end time.")
...
API reference - [Clip API](/documentation/pr-preview/pr-690/theoplayer/v11/api-reference/web/interfaces/Clip.html)

Clipping - [How-to guide](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/miscellaneous/clipping.md)
