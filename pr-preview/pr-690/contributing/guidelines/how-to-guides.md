...
## Naming the article and directories[​](#naming-the-article-and-directories "Direct link to Naming the article and directories")
...
**Attention:** If you change a file or a directory name, you'll have to change this in every document too! Doing a right *find & replace all* will do the trick.

## Writing the Article[​](#writing-the-article "Direct link to Writing the Article")

### Title of the Article[​](#title-of-the-article "Direct link to Title of the Article")
...
* [Up Next](/documentation/pr-preview/pr-690/theoplayer/how-to-guides/miscellaneous/up-next.md)
...
### Body of the Article[​](#body-of-the-article "Direct link to Body of the Article")
...
3. Then you provide more information on what you’ll be explaining. This can be a pseudo-repeat of the first paragraph.
   ...
   * *The reason you sort of rephrase what you’re doing, is because in some tutorials, you’re explaining multiple (sub) use-cases.*
...
Markdown Template available [here](/documentation/pr-preview/pr-690/contributing/templates/how-to-guides.md).
