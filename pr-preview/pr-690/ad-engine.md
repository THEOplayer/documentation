...
![OptiView Ad Engine Architecture](/documentation/pr-preview/pr-690/assets/images/ad_engine_server_side_ad_insertion-75518bbaae7c191e8aeacc1781ee1568.svg)

### RASP[​](#rasp "Direct link to RASP")
...
### Galaxies[​](#galaxies "Direct link to Galaxies")
...
`https://api.galaxy.dolbyrasp.com`

In the API documentation, any reference to `galaxy` is a placeholder for the galaxy you have been assisgned.

### API-Less JIT Operation[​](#api-less-jit-operation "Direct link to API-Less JIT Operation")
...
`https://api.galaxy.dolbyrasp.com/ad_engine/conform?profile=my_ad_profile&url=https://ad_server.com/ad123.mp4&output_format=media`
...
### Conformance Operations[​](#conformance-operations "Direct link to Conformance Operations")
...
### Ad Profiles[​](#ad-profiles "Direct link to Ad Profiles")
...
### VAST Files[​](#vast-files "Direct link to VAST Files")
...
### OptiView Ecosystem[​](#optiview-ecosystem "Direct link to OptiView Ecosystem")
...
![OptiView Ad Engine Architecture](/documentation/pr-preview/pr-690/assets/images/ad-engine-sgai-ad-insertion-7a9a4ae16104c9ad69e24c122fa70638.svg)

### Cloud Preview Capabilities[​](#cloud-preview-capabilities "Direct link to Cloud Preview Capabilities")
