...
## Media Info Endpoint[​](#media-info-endpoint "Direct link to Media Info Endpoint")
...
## Media Info Response[​](#media-info-response "Direct link to Media Info Response")
...
* **bitrate\_kb** – Average bitrate of the asset
* **duration\_sec** – Duration of the file in seconds
* **video\_tracks / audio\_tracks / timecode\_tracks** – Track counts by type
