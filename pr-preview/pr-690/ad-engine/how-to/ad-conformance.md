...
### Media → MP4[​](#media--mp4 "Direct link to Media → MP4")
...
### Media → HLS[​](#media--hls "Direct link to Media → HLS")
...
### Media → VAST[​](#media--vast "Direct link to Media → VAST")
...
### VAST → HLS[​](#vast--hls "Direct link to VAST → HLS")
...
### VAST → VAST[​](#vast--vast "Direct link to VAST → VAST")
