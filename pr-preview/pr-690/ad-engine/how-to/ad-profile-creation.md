...
### Submitting a Profile[​](#submitting-a-profile "Direct link to Submitting a Profile")
...
### Encoding Parameters[​](#encoding-parameters "Direct link to Encoding Parameters")
...
* video codec parameters - profile, level, crf, bitrate\_mode, etc.
* color properties - chroma\_format, color\_primaries, color\_trc, color\_matrix, etc.
* audio properties - codec, bitrate, etc.
* rate control properties - vbv\_buffer\_size\_kb, vbv\_init\_occupancy\_kb, etc.
...
### Listing, Editing, and Deleting Profiles[​](#listing-editing-and-deleting-profiles "Direct link to Listing, Editing, and Deleting Profiles")
