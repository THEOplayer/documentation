...
## Setting up redundancy[​](#setting-up-redundancy "Direct link to Setting up redundancy")
...
## What the viewer experiences[​](#what-the-viewer-experiences "Direct link to What the viewer experiences")
...
### Example: geo-redundant setup with priorities[​](#example-geo-redundant-setup-with-priorities "Direct link to Example: geo-redundant setup with priorities")
