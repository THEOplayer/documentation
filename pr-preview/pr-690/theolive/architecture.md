...
An ingest is the entry point for your media into the platform. It defines where and how live content is received, supporting protocols such as [RTMP and SRT](/documentation/pr-preview/pr-690/theolive/contribution/ingest-protocols.md).
