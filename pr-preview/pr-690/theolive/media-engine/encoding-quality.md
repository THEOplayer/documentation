...
## How protocol choice affects quality[​](#how-protocol-choice-affects-quality "Direct link to How protocol choice affects quality")

### Low latency (HESP enabled)[​](#low-latency-hesp-enabled "Direct link to Low latency (HESP enabled)")
...
### Higher quality (HLS only)[​](#higher-quality-hls-only "Direct link to Higher quality (HLS only)")
...
## Choosing the right configuration[​](#choosing-the-right-configuration "Direct link to Choosing the right configuration")
...
Alternatively, combine both outputs in a single distribution and use a lower [max bitrate](/documentation/pr-preview/pr-690/theolive/distribution/max-bitrate.md) for your HLS viewers, since the higher encoding quality at the same bitrate means you can deliver a good experience with less bandwidth.
