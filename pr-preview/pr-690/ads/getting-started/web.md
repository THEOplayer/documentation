...
This guide assumes you know how to set up OptiView Player. For more information regarding this, check out the [OptiView Player getting started](/documentation/pr-preview/pr-690/theoplayer/getting-started/sdks/web/getting-started.md).

### Google DAI library[​](#google-dai-library "Direct link to Google DAI library")
...
OptiView Ads works seamlessly together with [Open Video UI for Web](/documentation/pr-preview/pr-690/open-video-ui/web.md). You can pass your OptiView Ads-enabled source directly to the UI's `source` property:
...
![Screenshot of Open Video UI playing an OptiView Ads stream](/documentation/pr-preview/pr-690/assets/images/web-ui-3acb223351d35b877fa419c80ef1782f.png)
