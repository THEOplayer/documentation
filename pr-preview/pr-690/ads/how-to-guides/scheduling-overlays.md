...
This can be done by a POST request to `{path}/overlay` where path is the usual url to interact with the OptiView Ads service for a specific monetized stream: `{optiview-ads-host}/ads-client/api/v1/monetized-streams/:monetizedStreamId`. Please see [CreateMonetizedStreamOverlay](/documentation/pr-preview/pr-690/ads/api/signaling/create-monetized-stream-overlay.md).
...
Please refer to [Custom GAM Creatives](/documentation/pr-preview/pr-690/ads/how-to-guides/gam-custom-creatives.md) for information on how to setup your own custom creatives in GAM.
