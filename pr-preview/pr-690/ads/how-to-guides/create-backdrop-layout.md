...
A backdrop is an companion image that is shown along with the player during an ad. This image is intended to provide either some additional information about an advertisement or a companion advertisement next to the main content.

## Backdrop Layout Options[​](#backdrop-layout-options "Direct link to Backdrop Layout Options")

There are two primary backdrop layout options, each serving a specific purpose in presenting ads effectively:

### 1. Double Box Layout[​](#1-double-box-layout "Direct link to 1. Double Box Layout")
...
#### Example Template[​](#example-template "Direct link to Example Template")

Below is a template for the Double Box layout tailored for 1080p resolution:

![Double box Template.png](/documentation/pr-preview/pr-690/assets/images/backdrop-doublebox-template-44839450ee24eb82ced2f055b9f6dead.png)

### 2. L-shape Layouts[​](#2-l-shape-layouts "Direct link to 2. L-shape Layouts")

The **L-shape** layout positions the video player in the top-left corner of the screen, scaling it down to create space for the backdrop image. This configuration allows viewers to see the content or an ad and the backdrop image simultaneously.
...
#### Example Template[​](#example-template-1 "Direct link to Example Template")

Below is a template for the L-shape layout:

![L-shape Template.png](/documentation/pr-preview/pr-690/assets/images/backdrop-lshape-template-44bfb24bfbcc9c2cd39c8354a4ce61dd.png)
