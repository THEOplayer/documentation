...
<IconGrid>
  <IconGridButton large>
    [![FFMPEG](../../assets/img/software-encoders/ffmpeg_logo.svg)](ffmpeg.md)
  </IconGridButton>
  ...
  <IconGridButton large>[![Wirecast](../../assets/img/software-encoders/wirecast_logo.svg)](wirecast.md)</IconGridButton>
</IconGrid>
...
**Wirecast** is a live video streaming production tool by Telestream that allows you to create and broadcast professional-quality live streams.

[How-to integrate with Wirecast](wirecast.md)
