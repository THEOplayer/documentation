...
Lastly, go to the _Video_ tab and set the frame rate to the same value you have set in your channel. See [Stream configuration](../../platform/stream-configuration.mdx) for more details.
