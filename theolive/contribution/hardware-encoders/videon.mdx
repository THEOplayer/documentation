...
- Match the "Video bitrate" value to the maximum value of the channel preset you are using. See [Stream configuration](../../stream-configuration/abr.mdx) for more details.
