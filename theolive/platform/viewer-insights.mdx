...
Viewer insights will only work if you are using THEOlive inside a THEOplayer. Please refer to [this guide](https://docs.optiview.dolby.com/theolive/playback/Web/getting-started/) for implementation details.
