...
Viewer insights will only work if you are using THEOlive inside a THEOplayer. Please refer to [this guide](../playback/web/index.mdx) for implementation details.
:::
