...
After following our [Getting Started on Web guide](/theolive/playback/Web/getting-started/) or the [Player Setup](#player-setup) section below, you will be ready to programmatically perform common playback actions. These include increasing/decreasing
