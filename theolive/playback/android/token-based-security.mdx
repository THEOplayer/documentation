...
THEOlive offers the option to enable JWT token security on a distribution alias level. This can be interesting if you only want valid users to access your stream. Read more about the feature and configuring it on your channels on the [token based security guide](/theolive/platform/security/token-based-security).
