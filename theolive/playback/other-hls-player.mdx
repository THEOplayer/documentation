...
Retrieve the license acquisition URLs for a channel with the [Get EZDRM content protection configuration](https://api.theo.live/v2/api-docs/#/Channels/get-channel-drm-config-ezdrm) endpoint:
