...
To use Flutter for THEOlive playback, you must use the [THEOplayer Flutter SDK](https://pub.dev/packages/theoplayer) which now supports Web, Android, and iOS devices.
...
Run the following script to generate a boilerplate code for your Flutter project:
...
Configure the THEOplayer by adding your THEOplayer license to the `license` property and optionally providing a `theolive` property for custom configuration:
...
Use Flutter documentation along with our [basic playback guide](./01-basic-playback-guide/) for Flutter to develop your project.
