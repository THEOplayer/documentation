...
After following our [Getting Started with Flutter guide](pathname:///theolive/playback/flutter/getting-started/) or the [Player Setup](#player-setup) section below, you will be ready to programmatically perform common playback actions. These include increasing/decreasing
the volume, playing/pausing the stream, enabling full screen, and selecting quality layers.

## Player Setup

To get started with THEOlive playback using Flutter THEOplayer SDK, you must first initialize your player with reference to your THEOlive channel as the source.
...
```dart
// print all available quality layers
...
- [THEOplayer Flutter SDK](pathname:///theoplayer/v9/api-reference/web/classes/Player.html)
