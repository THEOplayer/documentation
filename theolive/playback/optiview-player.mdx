...
- **Feature compatibility** — Not all features available in the OptiView Player have been tested or verified with HESP-based streams. Features not explicitly documented for OptiView Streaming are not officially supported. For guidance on compatibility, please reach out to the OptiView support team.
