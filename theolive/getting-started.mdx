...
![](assets/img/channel-overview.png 'Dashboard: Details page with the possibility to configure and start your channel.')
...
<div className="center-container">![](assets/img/create-ingest.png 'Create an ingest')</div>
...
<div className="center-container">![](assets/img/optiview-live-preview.png 'Live stream preview in the dashboard')</div>
