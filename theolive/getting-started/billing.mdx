...
![](https://files.readme.io/dcb32a2-billing-details.PNG)

You subsequently have to click _Add Billing Details_, and complete the form. 

![](https://files.readme.io/8e7abe9-2.Billing-details-fields-overview.PNG)
...
![](https://files.readme.io/76aaff1-3.Add-credit-or-debit-card.PNG)
