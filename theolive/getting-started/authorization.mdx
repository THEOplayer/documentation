...
![](https://files.readme.io/c0aca77-1.-THEOlive-console-generate-token.PNG)

This will give a pop-up which shows your token "key" and the corresponding secret. 

![](https://files.readme.io/bb9b4a6-2.-THEOlive-console-generated-token-and-secret.PNG)


Once you "Close" the pop-up window, the new token will be visible in your list of tokens.

![](https://files.readme.io/5361242-3.-THEOlive-console-token-list.PNG)
