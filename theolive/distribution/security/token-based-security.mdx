...
| `mc`     | `number[]` | Metro code(s), only supported for the United States (e.g. `501`, `803`). If present, the token can exclusively be used for a metro area in this list. If the viewer's metro area cannot be determined, the request is denied.                                                                                                                   |
