...
Alternatively, combine both outputs in a single distribution and use a lower [max bitrate](../distribution/max-bitrate.mdx) for your HLS viewers, since the higher encoding quality at the same bitrate means you can deliver a good experience with less bandwidth.
:::
