...
const sidebars: SidebarsConfig = {
  ...
  openVideoUi: [
    ...
    },
    {
      type: 'category',
      label: 'Android',
      link: { type: 'generated-index', slug: 'open-video-ui/android' },
      items: [
        { type: 'doc', id: 'open-video-ui/android/getting-started' },
        {
          type: 'category',
          label: 'Guides',
          link: { type: 'generated-index', slug: 'open-video-ui/android/guides' },
