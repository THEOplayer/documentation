...
THEOads is an ad-insertion service for LIVE content (VoD support coming soon), created by THEO Technologies, utilizing Server-Guided Ad-Insertion (SGAI). On these pages, you'll learn how to get started with THEOads, how to use the configure the player, and integrate the signaling service API's.
...
2. **THEOplayer**: THEOplayer fetches and replaces ads within the content, working closely with the Signaling Service to optimize the viewer experience across platforms.
