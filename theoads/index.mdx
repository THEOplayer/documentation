...
THEOads is an ad-insertion service for both VOD and LIVE content, created by THEO Technologies, utilizing Server-Guided Ad-Insertion (SGAI). On these pages, you'll learn how to get started with THEOads, how to use the configure the player, and integrate the signalling service API's.
