...
- `networkCode`: Google DAI Network-Code, see [Google DAI](https://support.google.com/admanager/topic/7062524?hl=en).
- `adSrc`: Optional Ad src which is to be used during ad breaks. If not set it will request an ad through Google Pod Serving.
...
```json
{
  ...
  "networkCode": "89053",
  "adSrc": "https://cdn.theoplayer.com/video/big_buck_bunny/big_buck_bunny.m3u8",
