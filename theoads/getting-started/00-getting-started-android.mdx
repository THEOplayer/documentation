...
2. Add the THEOplayer Android SDK to your project by following our [Getting started](/theoplayer/getting-started/sdks/android/getting-started) guide.
   ...
   in your app.
3. Add the THEOads integration as a dependency in your module-level `build.gradle` file:
