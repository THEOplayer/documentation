...
Setting up THEOads requires some small changes to your THEOplayer build, as well as setting up a signalling server.
  ...
  ads: [
      {
          ...
          backdropDoubleBox: 'PATH-TO-DOUBLE-BOX-BACKDROP-IMAGE',
          backdropLShape: 'PATH-TO-L-SHAPE-BACKDROP-IMAGE'
      }
  ]
};
```
