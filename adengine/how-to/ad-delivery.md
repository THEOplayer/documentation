...
You can tell the Ad Engine to put the files in a specific location with the `files` option. If you specify the`files` option, you also have to provide a `delivery_root_url` and a `delivery_credentials_key`.
