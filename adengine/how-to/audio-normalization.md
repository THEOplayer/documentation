...
In this example, we are using the EBU R128 audio normalization standard set to -23 LUFS (Loudness Units Relative to Full Scale). The Ad Engine analyzes the content first, and then modifies the audio to match the desired audio level.
