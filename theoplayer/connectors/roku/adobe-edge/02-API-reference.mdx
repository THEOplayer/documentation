...
| updateUserConsent      | consent: THEOAEPUserConsent or string                                        | Updates the user consent data for this user. Either "n" for denied, "y" for consented, or "p" for pending or unknown.                                                                     |
...
The THEO AEP Connector will automatically detect most media events and send them to AEP for you, including player commands such as play or pause and events like bitrate change. It will not send media events related to chapters or ads in this version:
