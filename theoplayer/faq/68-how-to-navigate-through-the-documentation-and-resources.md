...
- The central THEO documentation at https://docs.theoplayer.com contains
  ...
  - API references that document APIs per SDK (e.g. [Web](https://docs.theoplayer.com/api-reference/web/theoplayer.md), [iOS](https://docs.theoplayer.com/api-reference/ios/index.html), [Android](https://docs.theoplayer.com/api-reference/android/index.html))
