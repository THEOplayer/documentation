...
as explained in our customization articles for [Android Legacy (4.12.x)](<../../getting-started/01-sdks/02-android-legacy-(4.12.x)/01-android-sdk-customization.md>) and [iOS](<../../getting-started/01-sdks/03-ios-legacy-(4.12.x)/01-ios-sdk-customization.md>).
