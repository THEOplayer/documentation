...
1. [iOS SDK Customization](<../../getting-started/01-sdks/03-ios-legacy-(4.12.x)/01-ios-sdk-customization.md>) for the iOS SDK
2. [Android Legacy (4.12.x) SDK Customization](<../../getting-started/01-sdks/02-android-legacy-(4.12.x)/01-android-sdk-customization.md>) for the Android SDK
...
This flow is described at [iOS SDK Customization](<../../getting-started/01-sdks/03-ios-legacy-(4.12.x)/01-ios-sdk-customization.md>).
...
The communication between native Android and JavaScript is documented at [Android Legacy (4.12.x) SDK Customization](<../../getting-started/01-sdks/02-android-legacy-(4.12.x)/01-android-sdk-customization.md>).
