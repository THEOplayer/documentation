...
You can use the `playing` event to know when content (or an ad) starts playing. Its event handler is the correct scope to check whether an advertisement is playing through the [`player.ads.playing`](pathname:///theoplayer/v11/api-reference/web/interfaces/Ads.html#playing) property.
...
- [Reference API - Ads.playing property](pathname:///theoplayer/v11/api-reference/web/interfaces/Ads.html#playing)
- [Reference API - playing property](pathname:///theoplayer/v11/api-reference/web/interfaces/PlayerEventMap.html#playing)
