...
The `csai` [ad integration kind](pathname:///theoplayer/v9/api-reference/web/types/AdIntegrationKind.html) is only available on Web SDK and allows customization.

To customize the text here we will be leveraging the language localization mechanism. You can find the API we will be using [here](pathname:///theoplayer/v9/api-reference/web/interfaces/UIConfiguration.html#language).
