...
Please check also our related [API documentation](pathname:///theoplayer/v11/api-reference/android/com/theoplayer/android/api/source/drm/ClearkeyKeySystemConfiguration.html) on how to set these.
