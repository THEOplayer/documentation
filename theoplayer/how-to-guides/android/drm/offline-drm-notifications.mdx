---
sidebar_position: 21
sidebar_label: Customizing offline DRM notifications
---

# Customizing offline DRM notifications on Android

Head to our page on [offline DRM](./offline-drm.mdx) for more general information.
