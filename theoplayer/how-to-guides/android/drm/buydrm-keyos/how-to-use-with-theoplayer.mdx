...
You will also need a valid THEOplayer set-up. If you have no experience with setting up our player, we have an excellent [getting started guide](../../../../getting-started/01-sdks/02-android/00-getting-started.mdx).
