...
2. Once the Player is installed, continue following the guide for setting up the player. Please note that THEOplayer licenses can be found for streaming customers [here](/theolive/next/getting-started/) in the THEOlive dashboard.
