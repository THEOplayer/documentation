...
The Media3 integration is being built to improve stability and performance, so if your usecase is targeting performance restricted devices or you target broad coverage and have encountered playback issues on particular device segments we recommend trying out the Media3 integration.
