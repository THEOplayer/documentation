...
The Android SDK provides the `HTTPInterceptor` interface, which contains two methods that you can implement
...
The `request` parameter of `onRequest` allows you to read and write properties of the request,
...
The `response` parameter of `onResponse` allows you to read and write properties of the received response.
