...
The AudioTrack API, which is a sub-API of the [MediaTrack API](pathname:///theoplayer/v11/api-reference/web/interfaces/MediaTrack.html), can be used to implement this functionality.
...
- [MediaTrack API Reference](pathname:///theoplayer/v11/api-reference/web/interfaces/MediaTrack.html)
