...
The Web SDK leverages the [MediaTrack API](pathname:///theoplayer/v11/api-reference/web/interfaces/MediaTrack.html).
...
The Android SDK leverages the [MediaTrack API](pathname:///theoplayer/v11/api-reference/android/com/theoplayer/android/api/player/track/mediatrack/MediaTrackList.html).
...
The iOS SDK leverages the [MediaTrack API](pathname:///theoplayer/v11/api-reference/ios/Protocols/MediaTrackList.html).
