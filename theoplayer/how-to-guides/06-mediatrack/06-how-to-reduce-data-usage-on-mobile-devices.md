...
You can combat this by leveraging the [ABR API](pathname:///theoplayer/v9/api-reference/web/interfaces/ABRConfiguration.html) and the [MediaTrack API](pathname:///theoplayer/v9/api-reference/web/interfaces/MediaTrack.html).
...
- [Web SDK API reference: restrictToPlayerSize](pathname:///theoplayer/v9/api-reference/web/interfaces/SourceAbrConfiguration.html#restrictToPlayerSize)
