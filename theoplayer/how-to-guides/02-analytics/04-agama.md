...
Once the player is configured, an Agama EMP client is created.
The player source configuration should include the [AgamaSourceConfiguration](pathname:///theoplayer/v11/api-reference/web/interfaces/AgamaSourceConfiguration.html) object in the analytics tag:
