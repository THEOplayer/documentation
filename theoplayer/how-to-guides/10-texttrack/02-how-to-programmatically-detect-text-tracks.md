...
The Web SDK leverages the [TextTrack API](pathname:///theoplayer/v11/api-reference/web/interfaces/TextTrack.html).
...
The Android SDK leverages the [TextTrack API](pathname:///theoplayer/v11/api-reference/android/com/theoplayer/android/api/player/track/texttrack/TextTrackList.html).
