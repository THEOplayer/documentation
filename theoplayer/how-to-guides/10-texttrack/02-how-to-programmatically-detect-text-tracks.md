...
The Web SDK leverages the [TextTrack API](pathname:///theoplayer/v8/api-reference/web/interfaces/TextTrack.html).
...
The Android SDK leverages the [TextTrack API](pathname:///theoplayer/v8/api-reference/android/com/theoplayer/android/api/player/track/texttrack/TextTrackList.html).
