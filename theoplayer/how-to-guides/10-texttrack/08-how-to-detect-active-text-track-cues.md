...
3. You should set `hlsDateRange` to `true` if you want to detect EXT-X-DATERANGE tags in an HLS stream in your PlayerConfiguration or stream configuration. Refer to the [Web](https://docs.theoplayer.com/api-reference/web/theoplayer.playerconfiguration.md#a-idhlsdaterangeahlsdaterange), [Android](pathname:///theoplayer/v6/api-reference/android/com/theoplayer/android/api/THEOplayerConfig.Builder.html#hlsDateRange-boolean-) or [iOS](pathname:///theoplayer/v6/api-reference/ios/Classes/THEOplayerConfiguration.html) documentation for more info.
