...
3. You should set [`hlsDateRange`](pathname:///theoplayer/v11/api-reference/ios/Classes/THEOplayerConfiguration.html) to `true` in your player configuration or stream configuration,
