...
For more information, see the API reference of [`Chromecast`](pathname:///theoplayer/v11/api-reference/ios/Protocols/Chromecast.html), a sub-protocol of [`Cast`](pathname:///theoplayer/v11/api-reference/ios/Protocols/Cast.html).
