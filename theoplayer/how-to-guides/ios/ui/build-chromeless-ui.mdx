...
[API reference](<pathname:///theoplayer/v11/api-reference/ios/Classes/THEOplayer.html#/c:@M@THEOplayerSDK@objc(cs)THEOplayer(im)play>).
...
[API reference](<pathname:///theoplayer/v11/api-reference/ios/Classes/THEOplayer.html#/c:@M@THEOplayerSDK@objc(cs)THEOplayer(im)pause>).
...
The [THEOplayer Picture-in-Picture API](../../07-miscellaneous/07-picture-in-picture.md) is not available for chromeless players.
