...
[Open Video UI for React Native](/theoplayer/how-to-guides/react-native/ui/open-video-ui/),
...
and programming languages of the platform. The THEOplayer API exposes all the events and properties that you need to implement a custom design from scratch.
