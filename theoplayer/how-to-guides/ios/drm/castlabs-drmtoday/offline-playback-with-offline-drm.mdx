---
sidebar_position: 2
sidebar_label: Offline playback with DRMToday
---

# Offline playback with DRMToday on iOS

import Intro from '../../../shared/drm/_castlabs-drmtoday-offline-playback-with-offline-drm-intro.mdx';
...
DRMToday is integrated through a custom DRM integration. The `CastLabsDRMIntegration` in the
[Offline-Playback sample app](https://github.com/THEOplayer/samples-ios-sdk/tree/master/Offline-Playback) is a
ready-to-use implementation; register it as described in [Offline DRM](../offline-drm.mdx), and reference it from your
source through `customIntegrationId`.
