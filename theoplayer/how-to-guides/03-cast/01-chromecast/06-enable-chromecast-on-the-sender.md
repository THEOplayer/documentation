...
If you have your own Receiver app, then you adjust the [PlayerConfiguration](pathname:///theoplayer/v8/api-reference/web/interfaces/CastConfiguration.html) to connect with a specific `appID` as demonstrated below.
