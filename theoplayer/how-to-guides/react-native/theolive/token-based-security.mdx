...
Refer to the [getting started guide](./00-getting-started.mdx) for the prerequisite steps in getting the React Native SDK up and running for THEOlive playback.
