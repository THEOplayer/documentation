...
With THEOplayer you just set a [SourceDescription](pathname:///theoplayer/v11/api-reference/web/interfaces/TheoLiveSource.html).
...
Most of the old functionality is right there on THEOplayer and can be found in the [THEOplayer docs](pathname:///theoplayer/v11/api-reference/web/classes/ChromelessPlayer.html). For OptiView Live specific API, check out [player.theolive](pathname:///theoplayer/v11/api-reference/web/interfaces/TheoLiveApi.html).
