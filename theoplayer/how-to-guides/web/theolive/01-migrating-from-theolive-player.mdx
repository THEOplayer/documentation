...
Most of the old functionality is right there on THEOplayer and can be found in the [THEOplayer docs](pathname:///theoplayer/v9/api-reference/web/classes/ChromelessPlayer.html). For THEOlive specific
API, check out [player.theolive](pathname:///theoplayer/v9/api-reference/web/interfaces/TheoLiveApi.html).
