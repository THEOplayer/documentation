---
sidebar_position: 5
sidebar_label: Visual cues for mid-rolls on the timeline
---

# How to display visual cues on the timeline to mark mid-rolls on Web

import Intro from '../../shared/ads/_visual-cues-for-mid-rolls-intro.mdx';
