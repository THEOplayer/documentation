---
sidebar_position: 1
sidebar_label: Adblock detection
---

# Adblock detection on Web

import Intro from '../../shared/ads/_block-detection-intro.mdx';

<Intro />

## Usage

Adblock detection is typically a challenge in browsers, which is why this feature is only applicable to the Web SDK.
...
At the time of writing, the default error message is `Starting ads was not possible. Turn off your AdBlocker and try again.`.
...
If you're using the [Google IMA](./google-ima.mdx) ad integration, your callback event will have a `problemType` property that will equal `"adblock"`.
