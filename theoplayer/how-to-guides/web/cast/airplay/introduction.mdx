...
For more information, see the API reference of [`AirPlay`](pathname:///theoplayer/v11/api-reference/web/interfaces/AirPlay.html), which inherits from [`VendorCast`](pathname:///theoplayer/v11/api-reference/web/interfaces/VendorCast.html).
