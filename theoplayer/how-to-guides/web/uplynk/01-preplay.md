...
The snippet above gives a quick overview of the structure of an Uplynk-specific source, also known as an [UplynkSource](pathname:///theoplayer/v11/api-reference/web/interfaces/UplynkSource.html). More information on certain properties:
...
The examples below demonstrate how to configure a stream with server-side ads through an [UplynkSource](pathname:///theoplayer/v11/api-reference/web/interfaces/UplynkSource.html).
...
This set of parameters should also be passed along to the `preplayParameters` in an [UplynkSource](pathname:///theoplayer/v11/api-reference/web/interfaces/UplynkSource.html).
