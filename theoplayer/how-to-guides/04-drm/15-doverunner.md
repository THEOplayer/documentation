...
**Note**: The details in the guide apply for DoveRunner (formally known as "PallyCon").  While most details, API hostnames and variables have been updated to reflect DoveRunner, certain configurations such as the `pallycon-customdata-v2` HTTP request header will still apply.
