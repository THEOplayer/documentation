...
For all possible API calls, we refer you to the JavaDoc available [here](pathname:///theoplayer/v11/api-reference/android/com/theoplayer/android/api/cache/package-summary.html)
