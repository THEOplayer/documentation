...
If you are already comfortable with the THEOplayer API, you can go straight over to [DRM Pre-Integration API](pathname:///theoplayer/v9/api-reference/web/interfaces/DRMConfiguration.html).
...
1. [DRM Pre-Integration API](pathname:///theoplayer/v9/api-reference/web/interfaces/DRMConfiguration.html)
