...
- Reference API: [Related-Content API](pathname:///theoplayer/v11/api-reference/web/interfaces/RelatedContent.html)
...
- Reference API: [iOS Related Content API](pathname:///theoplayer/v11/api-reference/ios/Protocols/RelatedContent.html)
