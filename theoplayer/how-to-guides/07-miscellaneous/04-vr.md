...
To indicate that your stream contains 360° content. Create a [VRConfiguration](https://docs.theoplayer.com/api-reference/android/com/theoplayer/android/api/source/vr/VRConfiguration.html) variable and set it in the `SourceDescription`
...
To indicate that your stream contains 360° content, set the [VRConfiguration](<https://docs.theoplayer.com/api-reference/ios/Classes/SourceDescription.html#/c:@CM@THEOplayerSDK@objc(cs)THEOplayerSourceDescription(py)vr>) property when setting the `SourceDescription`.
...
Construct a [VRDirection](https://docs.theoplayer.com/api-reference/android/com/theoplayer/android/api/vr/VRDirection.html) object to set the direction
...
Construct a [VRDirection](https://docs.theoplayer.com/api-reference/ios/Classes/VRDirection.html) object to set to the `player.vr.direction` property:
