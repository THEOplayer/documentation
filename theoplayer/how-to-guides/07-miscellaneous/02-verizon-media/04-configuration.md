...
Refer to the documentation at pathname:///theoplayer/v6/api-reference/android/com/theoplayer/android/api/verizonmedia/VerizonMediaConfiguration.html for more information.
