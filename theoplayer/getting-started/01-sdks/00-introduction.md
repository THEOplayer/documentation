...
- Android/Android TV/Fire TV Legacy (4.12.x) SDK
  - [Android](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/android/getting-started) targets Android apps, and may be used for other Android-based platforms.
  - [Android TV](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/android-tv/getting-started) targets Android TV apps.
  - [Fire TV](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/fire-tv/getting-started) targets Fire TV apps.

- iOS/tvOS Legacy (4.12.x) SDK
  - [iOS](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/ios/getting-started) targets iOS and iPadOS apps.
  - [tvOS](https://optiview.dolby.com/docs/theoplayer/v4/getting-started/sdks/tvos/getting-started) targets tvOS (i.e. Apple TV) apps.
