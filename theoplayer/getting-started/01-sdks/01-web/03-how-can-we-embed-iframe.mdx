---
description: How to embed OptiView Player through an iframe on first-party and third-party domains.
---
...
You can easily allow embedding by setting the `isEmbeddable`-flag in the THEOplayer's [`PlayerConfiguration`](pathname:///theoplayer/v11/api-reference/web/interfaces/PlayerConfiguration.html) to `true`, as demonstrated by the code snippet below.
...
- [Picture-in-Picture does not work as expected](../../../how-to-guides/web/miscellaneous/picture-in-picture.mdx): you can address this by using native Picture-in-Picture instead, or by building a similar feature which creates a floating iframe component.
...
- [Player API - PlayerConfiguration](pathname:///theoplayer/v11/api-reference/web/interfaces/PlayerConfiguration.html)
