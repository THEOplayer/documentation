...
This article will show you how to display a frame-accurate currentTime on your THEOplayer instance UI control bar. For more information regarding the currentTime itself, please refer to the [reference API](pathname:///theoplayer/v11/api-reference/web/classes/ChromelessPlayer.html).
...
- [API reference - player properties](pathname:///theoplayer/v11/api-reference/web/classes/ChromelessPlayer.html)
