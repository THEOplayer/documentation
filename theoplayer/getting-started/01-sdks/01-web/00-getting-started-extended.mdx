...
![screenshot from the THEO portal SDK build page, highlighting the CDN link](../../../assets/img/getting-started-web-sdk/sdk-cdn.png)
...
![screenshot from the THEO portal SDK build page, highlighting various elements](../../../assets/img/getting-started-web-sdk/sdk-ready.png)
...
![screenshot demonstrating logs of the player version and features to confirm it has been loaded correctly](../../../assets/img/getting-started-web-sdk/js-fiddle-step-1.png)
...
Create a THEOplayer `"Player"` instance by using the [THEOplayer constructor API](https://docs.theoplayer.com/api-reference/web/theoplayer.player.md#constructor).
...
A quick reminder: your library location is the same as the [CDN value on your SDK page](#sdk-cdn.png).
...
You use the [`source`](https://docs.theoplayer.com/api-reference/web/theoplayer.chromelessplayer.md#source) property of your `player` instance to configure a video.
...
- [https://docs.theoplayer.com](https://docs.theoplayer.com): documentation portal — use this to find documentation
  - [https://docs.theoplayer.com/api-reference/web/theoplayer.md](https://docs.theoplayer.com/api-reference/web/theoplayer.md): API Reference
...
The API reference of the THEOplayer Web SDK is available at [https://docs.theoplayer.com/api-reference/web/theoplayer.md](https://docs.theoplayer.com/api-reference/web/theoplayer.md).
...
The top-level interface is the [Player API](https://docs.theoplayer.com/api-reference/web/theoplayer.chromelessplayer.md).
A [map of events](https://docs.theoplayer.com/api-reference/web/theoplayer.playereventmap.md) is available in the Player API,
...
You add support for autoplay by setting [`player.autoplay = true`](https://docs.theoplayer.com/api-reference/web/theoplayer.mutedautoplayconfiguration.md).
Additionally, we set [`mutedAutoplay: "all"`](https://docs.theoplayer.com/api-reference/web/theoplayer.mutedautoplayconfiguration.md) in the player configuration, to [combat autoplay policies](https://docs.theoplayer.com/faq/02-how-to-combat-autoplay-policies.md).
...
[Other valid preload values](https://docs.theoplayer.com/api-reference/web/theoplayer.preloadtype.md) are:
...
Other valid values for type are [`performance` and `bandwidth`](https://docs.theoplayer.com/api-reference/web/theoplayer.abrstrategytype.md#abrstrategytype-type).
...
- [Common UI-related inquiries](https://docs.theoplayer.com/how-to-guides/11-ui/00-introduction.md)

#### Create new skin

You are given the option to create a new skin through the Chromeless API.
The article on "[How to build a Chromeless UI](https://docs.theoplayer.com/how-to-guides/11-ui/06-how-to-build-chromeless-ui.md)" helps you understand how to approach this.
Some quick notes:
...
Check our [introduction on DRM](https://docs.portal.theoplayer.com/how-to-guides/04-drm/00-introduction.md) and our [Github repository on the DRM API](https://github.com/THEOplayer/samples-drm-integration) to learn more about setting up DRM.

### Advertising

THEOplayer adds support for client-side and server-side advertising.
Refer to our [advertisement guides](https://docs.theoplayer.com/how-to-guides/01-ads/00-introduction.md) to get started with concepts such as
[mid-rolls](https://docs.theoplayer.com/how-to-guides/01-ads/03-how-to-set-up-vast-and-vmap.md#vast), [Google IMA](https://docs.theoplayer.com/how-to-guides/01-ads/03-how-to-set-up-vast-and-vmap.md#google-ima),
[ad block detection](https://docs.theoplayer.com/how-to-guides/01-ads/01-block-detection.md), and others.
...
You add an `ads` key to the `player.source` object. This key holds a list of [ad descriptions](https://docs.theoplayer.com/api-reference/web/theoplayer.addescription.md). Each ad description is an advertisement.
...
2. Check whether a "pre-integration" exists at [https://docs.theoplayer.com/how-to-guides/02-analytics/00-introduction.md](https://docs.theoplayer.com/how-to-guides/02-analytics/00-introduction.md), and, if so, leverage it.
...
Check our [getting started guides](https://docs.theoplayer.com/getting-started/02-frameworks/01-angular/00-getting-started.md),
