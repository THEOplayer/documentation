...
Additionally, we set [`mutedAutoplay: "all"`](https://docs.theoplayer.com/api-reference/web/theoplayer.mutedautoplayconfiguration.md) in the player configuration, to [combat autoplay policies](../../../faq/02-how-to-combat-autoplay-policies.md).
