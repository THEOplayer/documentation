...
After you complete the third step, "Review and Publish", you will get your unique <span className={styles.borderGreen}>LICENSE</span>.
...
you can use the SDK <span className={styles.borderBlue}>library location URL</span>.
