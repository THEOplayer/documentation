...
[Get started with Open Video UI for Web.](/theoplayer/how-to-guides/web/ui/open-video-ui/getting-started/)
...
You can read more about configuring the `license` at the [License section](../../../how-to-guides/web/license/introduction.mdx).
