...
Acquiring a THEOplayer license takes three steps:
...
Similar to the JavaScript and CSS library, you must swap out `'/path/to/node_modules/theoplayer/'` and `'your_license_string'`.
