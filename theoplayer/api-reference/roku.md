...
| Property           | Type       | Access Permission | Description                                                               |
| ------------------ | ---------- | ----------------- | ------------------------------------------------------------------------- |
| bufferRenderUpdate | assocarray | read              | An associative array with the properties `adUrl`, `eventType`, and `ctx`. |
| libVersion         | string     | read              | The string indicating the version of the RAF library.                     |
| trackingUpdate     | assocarray | read              | An associative array with the properties `adUrl`, `eventType`, and `ctx`. |
